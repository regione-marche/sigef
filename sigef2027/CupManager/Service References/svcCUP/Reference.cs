...
namespace CupManager.svcCUP {
    ...
    public interface ElaborazioniCUP {
        ...
        // CODEGEN: Generating message contract since the wrapper namespace (http://serviziCUP.mef.it/types/) of message RichiestaRispostaSincrona_RichiestaDettaglioCUPRequest does not match the default value ( http://serviziCUP.mef.it)
        ...
        // CODEGEN: Generating message contract since the wrapper namespace (http://serviziCUP.mef.it/types/) of message RichiestaRispostaSincrona_ListaCUPRequest does not match the default value ( http://serviziCUP.mef.it)
        ...
        // CODEGEN: Generating message contract since the wrapper namespace (http://serviziCUP.mef.it/types/) of message RichiestaRispostaSincrona_RichiestaGenerazioneCUPRequest does not match the default value ( http://serviziCUP.mef.it)
