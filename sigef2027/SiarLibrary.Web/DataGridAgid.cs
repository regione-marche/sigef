...
{
    public class DataGridAgid : System.Web.UI.WebControls.DataGrid
    {
        public DataGridAgid()
            : base()
        {
        ...
        protected override void InitializePager(DataGridItem item, int columnSpan, PagedDataSource pagedDataSource)
        {
            ...
            for (num8 = num5; (num8 <= num6); num8 = (num8 + 1))
            {
                ...
                if (num8 == num2)
                {
                    ...
                    foreach (DataGridColumn dgc in this.Columns)
                        if (dgc is IValoriImpaginatiAgid)
                            ((IValoriImpaginatiAgid)dgc).AddHiddenValue(cell1);
                    #endregion
                }
                else
                {
            ...
            for (num8 = num5; (num8 <= num6); num8++)
            {
                ...
                if (num8 == num2)
                {
                    ...
                    cell1.Controls.Add(label3);
                    // per check
                    foreach (DataGridColumn dgc in this.Columns) if (dgc is IValoriImpaginatiAgid) ((IValoriImpaginatiAgid)dgc).AddHiddenValue(cell1);
                }
                else
                {
                    button3 = new Literal();
        ...
        protected override void Render(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            if (!string.IsNullOrEmpty(_titolo))
                writer.Write("<p class='dgTitolo'>" + _titolo + "</p>");
    ...
    public class ZoomDataGridAgid : DataGrid, IPostBackEventHandler
    {
        protected override void OnInit(EventArgs e)
        {
            if (this.AllowPaging)
    ...
    public class NumberColumnAgid : DataGridColumn
    {
        int n;
        public NumberColumnAgid()
            : base()
        {
#if(DEBUG)
            this.HeaderText = "Nr.";
    ...
    /// </summary>
    public class ColonnaLinkAgid : BoundColumn
    {
        string _linkFields;
        /// <summary>
    ...
    public class TextColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
        public TextColumnAgid() : base() { }
        ...
        #region IValoriImpaginatiAgid Members
    ...
    public class TextAreaColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
        public TextAreaColumnAgid() : base() { }
    ...
    public class NewTextAreaColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
        public NewTextAreaColumnAgid() : base() { }
    ...
    public class IntegerColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
        public IntegerColumnAgid() : base() { }
    ...
    public class DatetimeColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
        public DatetimeColumnAgid() : base() { }
    ...
    public class PercentualeColumnAgid : BoundColumn, IValoriImpaginatiAgid, ITotalFooterAgid
    {
        public PercentualeColumnAgid() : base() { }
        ...
        string ITotalFooterAgid.Valore { get { return Quota; } }
    ...
    public class ImportoColumnAgid : BoundColumn, IValoriImpaginatiAgid, ITotalFooterAgid
    {
        public ImportoColumnAgid() : base() { }
        ...
        string ITotalFooterAgid.Valore { get { return Importo; } }
    ...
    public class NewImportoColumnAgid : BoundColumn, IValoriImpaginatiAgid, ITotalFooterAgid
    {
        public NewImportoColumnAgid() : base() { }
    ...
    public class CheckColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
        ...
        public void AddHiddenValue(TableCell cell)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                if (!this._visibile[i])
                {
                    Literal check = new Literal();
                    check.EnableViewState = false;
                    check.Text = "<input type='checkbox' id='" + _name + "_" + _selected[i] + "' name='" + _name + "_" + _selected[i] + "' value=\"" + _selected[i] + "\" checked style='DISPLAY:NONE'>";
                    cell.Controls.Add(check);
                }
            }
        }
        ...
        public override void Initialize()
        {
            ...
            if (p.IsPostBack)
            {
                ...
                foreach (var key in p.Request.Form.AllKeys)
                {
                    if (key != null && key.StartsWith(_name + "_"))
                    {
                        var value = p.Request.Form[key];
                        formArray.Add(value);
                    }
                }
            ...
            if (itemType == ListItemType.Header)
            {
                ...
                if (_headerSelectAll)
                    testo_cella += (!string.IsNullOrEmpty(testo_cella) ? "<br />" : "")
                        + "<div class='form-check'><input id='" + _name + "HeaderCheck' runat='server' name='" + _name + "HeaderCheck' type='checkbox' onclick=\"dgCheckColumnAgidSelectAll(this,'" + _name + "'," + HeaderSelectAllFireClickEvent.ToString().ToLower() + " ); " + OnHeaderCheckClick + "\" /><label for='" + _name + "HeaderCheck' class='active'>Seleziona tutti</label></div>";
        ...
        {
            string val = base.FormatDataValue(dataValue);
            string testo = " <div class='form-check'><input type='checkbox' id='" + _name + "_" + val + "' name='" + _name + "_" + val + "' value=\"" + val + "\"";
            ...
            testo += "><label for='" + _name + "_" + val + "'>Seleziona</label></div>";
            return testo;
        }
    }

    public class ComboColumnAgid : BoundColumn, IValoriImpaginatiAgid
    {
    ...
    public enum JsButtonColumnTypeAgid { TextButton, ImageButton }
    public class JsButtonColumnAgid : BoundColumn
    {
        ...
        private JsButtonColumnTypeAgid _buttonType;
        public JsButtonColumnTypeAgid ButtonType
        {
        ...
        private void cell_DataBinding(object sender, EventArgs e)
        {
            ...
            // scrivo l'html
            string html = "";
            //if (_buttonType == JsButtonColumnTypeAgid.ImageButton) html = "<img src=\"" + Owner.Page.Request.ApplicationPath + "/images/" + _buttonImage
           //     + "\" style='width:20px;height:20px;cursor:pointer;' title=\"" + _buttonText + "\" onclick=\"" + fn + "\"/>";

            if (_buttonType == JsButtonColumnTypeAgid.ImageButton)
            {
                string img = Owner.Page.Request.ApplicationPath + "/bootstrap-italia/svg/sprites.svg#" + _buttonImage;
                html = "<svg class='icon pointer icon-breadcrumb icon-secondary me-1' onclick=\"" + fn + "\" aria-hidden='true'><use href='" + img + "'></use></svg>";
            }
            else 
                html = "<input type=button class='btn btn-secondary py-1' value='" + _buttonText + "' onclick=\"" + fn + "\" />";
    ...
    interface IValoriImpaginatiAgid
    {
    ...
    public interface ITotalFooterAgid
    {
        string Valore
        { get; }
