...
namespace SiarLibrary.Web
{
    ...
    public class ComboBase : System.Web.UI.WebControls.ListControl
    {
        ...
        public ComboBase(string cssClass ="")
        {
            base.CssClass = string.Join(" ", cssClass ,"rounded");
        ...
        //    tb.Attributes.Add("class", " rounded");
...
#endif
            writer.Write("<div class='select-wrapper'>\n");
            if (_obbligatorio)                
                writer.Write("<label for='" + this.ClientID + "'>" + _label + "</label>");
            else
                writer.Write("<label for='" + this.ClientID + "'>" + _label + "</label>");
            base.Render(writer);
            foreach (System.Web.UI.Control c in Controls)
