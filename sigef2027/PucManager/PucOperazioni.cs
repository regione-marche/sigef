...
namespace PucManager
{
    public partial class PucOperazioni
    {
            ...
            try
            {
                ...
                }))
                {
                    ...
                    if (dtable.Rows.Count > 0)
                    {
                        ...
                        //Test: scrivo il file per vedere se è correttamente formattato
                        //System.IO.File.WriteAllText(@"C:\VSSProjects\PUCSolution\WebPUCTest\Test_File_auto_" + Convert.ToString(invio.ID_INVIO) + ".txt", fileBuilder.ToString());
        ...
        public ResultInfo InviaMonitoraggio(DateTime? DataDa, DateTime? DataA, string[] Files, string CodiceFondo)
        {
            ...
            try
            {
                ...
                }))
                {
                    ...
                    //Test: scrivo il file per vedere se è correttamente formattato
                    //System.IO.File.WriteAllText(@"C:\VSSProjects\PUCSolution\WebPUCTest\igrue_XX_" + Convert.ToString(invio.ID_INVIO) + ".txt", fileBuilder.ToString());
        ...
        public ResultInfo GetLogErrori(string IdTicket, string CodiceFondo)
        {
            ...
            try
            {
                ...
                }))
                {
                    ...
                    if (file != null)
                    {
                        //test da directory: commentare in produzione e decommentare le righe precedenti
                        //var file = System.IO.File.ReadAllBytes(@"C:\VSSProjects\PUCSolution\WebPUCTest\test_log_errori_1.zip");
                        ...
                        //Test: verifica validità xml generato dal log degli errori, da commentare in produzione
                        //System.IO.File.WriteAllText(@"C:\VSSProjects\PUCSolution\WebPUCTest\test_xml_parse_" + IdTicket + ".xml", xml);
                        //System.IO.File.WriteAllBytes(@"C:\VSSProjects\PUCSolution\WebPUCTest\log_errori_" + IdTicket + ".zip", file);
                    }
        ...
        public void TestScritturaEstrazioneFileZip(string IdTicket)
        {
            ...
            System.IO.File.WriteAllText(@"C:\VSSProjects\PUCSolution\WebPUCTest\Test_FileFromZip_" + IdTicket + ".txt", result, Encoding.Default);
        }
        ...
        public void TestScritturaFilePA00(int IdInvio)
        {
            ...
            System.IO.File.WriteAllText(@"C:\VSSProjects\PUCSolution\WebPUCTest\Test_File_" + Convert.ToString(IdInvio) + ".txt", builder.ToString());
        }
        ...
        public bool TestScritturaFile(string NomeFile, string CodiceFondo)
        {
            ...
            System.IO.File.WriteAllText(@"C:\VSSProjects\PUCSolution\WebPUCTest\igrue_" + NomeFile + ".txt", result);
            return true;
        }
        ...
        public ResultInfo TestInvioFileGlobale(string CodiceFondo)
        {
            ...
            byte[] test = System.IO.File.ReadAllBytes(@"C:\VSSProjects\PUCSolution\WebPUCTest\igrue_global_1.zip");
            try
            {
            using (var ts = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions()
                {
