...
namespace SiarLibrary
{
    public class Protocollo //: IDisposable
    {
        ...
        SiarBLL.paleoWebService.TrasmissioneRuolo[] trasmissioneRuoli;
        ...
        public string ProtocolloIngresso(string oggetto, string codice_fascicolo)
        {
            ...
            if (trasmissioneUtenti != null || trasmissioneRuoli != null)
            ...
            if(trasmissioneRuoli != null)
                request.Trasmissione.TrasmissioniRuolo = trasmissioneRuoli;
        ...
        private void addTrasmissioneRuolo(TrasmissioneRuolo r)
        {
            TrasmissioneRuolo[] r_supp;
            r_supp = trasmissioneRuoli;
            if (r_supp == null) r_supp = new TrasmissioneRuolo[1];
            else
            {
                TrasmissioneRuolo[] r_supp2 = new TrasmissioneRuolo[r_supp.Length + 1];
                r_supp.CopyTo(r_supp2, 0);
                r_supp = r_supp2;
            }
            r_supp[r_supp.Length - 1] = r;
            trasmissioneRuoli = r_supp;

        }

        public void setTrasmissioneUtente(string cognome, string nome, string struttura, string cod_ruolo, string ragione)
        {
        ...
        public void SetTrasmissioneRuolo(string struttura, string cod_ruolo, string ragione)
        {
            var ruolo = new TrasmissioneRuolo();
            ruolo.CodiceRagione = ragione;
            ruolo.CodiceRuoloDestinatario = cod_ruolo;
            ruolo.CodiceUODestinataria = struttura;
            addTrasmissioneRuolo(ruolo);
        }
