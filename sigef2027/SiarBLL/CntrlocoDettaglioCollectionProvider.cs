...
((AzioneEqualThis == null) || ((CntrlocoDettaglioItem.Azione != null) && (CntrlocoDettaglioItem.Azione.Value == AzioneEqualThis.Value))) && ((InterventoEqualThis == null) || ((CntrlocoDettaglioItem.Intervento != null) && (CntrlocoDettaglioItem.Intervento.Value == InterventoEqualThis.Value))) && ((ObiettivoSpecificoEqualThis == null) || ((CntrlocoDettaglioItem.ObiettivoSpecifico != null) && (CntrlocoDettaglioItem.ObiettivoSpecifico.Value == ObiettivoSpecificoEqualThis.Value))))
				{
...
namespace SiarDAL
{
	...
	internal class CntrlocoDettaglioDAL
	{
		...
		protected internal static void CompileIUCmd(bool forUpdate, IDbCommand cmd, CntrlocoDettaglio CntrlocoDettaglioObj,string firstChar)
		{
			...
			DbProvider.SetCmdParam(cmd,firstChar + "ObiettivoSpecifico", CntrlocoDettaglioObj.ObiettivoSpecifico);
...
"ObiettivoSpecifico", "Azione", "Intervento", 
...
"string", "string", "string", 
		...
		public static CntrlocoDettaglio GetFromDatareader(DbProvider db)
		{
			...
			CntrlocoDettaglioObj.ObiettivoSpecifico = new SiarLibrary.NullTypes.StringNT(db.DataReader["Obiettivo_Specifico"]);
...
"Azioneequalthis", "Interventoequalthis", "ObiettivoSpecificoequalthis"}, new string[] {"int", "int", "int", 
"int", "string", "bool", 
"string", "DateTime", "decimal", 
"decimal", "decimal", "int", 
"string", "decimal", "decimal", 
