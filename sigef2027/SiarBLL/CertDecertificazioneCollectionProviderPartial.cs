...
namespace SiarBLL
{
    ...
    {
        public CertDecertificazioneCollection GetDecertificazioniPerCertificazioneSpesa(IntNT idCert, BoolNT definitivo, string codPsr)
        {
            ...
            cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("COD_PSR", codPsr));
    ...
    public partial class CertDecertificazioneCollectionProvider : ICertDecertificazioneProvider
    {
        public CertDecertificazioneCollection GetDecertificazioniPerCertificazioneConti(IntNT idCert, BoolNT definitivo, string codPsr)
        {
            CertDecertificazioneCollection dC = new CertDecertificazioneCollection();
            IDbCommand cmd = DbProviderObj.GetCommand();
            cmd.CommandType = CommandType.StoredProcedure;
