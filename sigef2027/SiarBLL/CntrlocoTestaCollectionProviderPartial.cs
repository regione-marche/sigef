...
namespace SiarBLL
{
	public partial class CntrlocoTestaCollectionProvider : ICntrlocoTestaProvider
    {
            ...
            try
            {
                ...
                strSql = @"INSERT INTO dbo.CntrLoco_Dettaglio(  IdLoco,
                       ...
                       WHERE Cod_Psr = @CodPsr
                         AND DATA_INIZIO_LOTTO >= @DataInizio
                         AND DATA_FINE_LOTTO <= @DataFine
                       ";
                cmd = dbPro.GetCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = strSql;
                ...
                /*
                // NON DOVREI PIU' AVER BISOGNO DI AGGIORNARE GLI IMPORTI PERCHE' CALCOLATI NELLE VERIFICHE AMMINISTRATIVE
                ...
                //CON LA NUOVA PROGRAMMAZIONE NON DEVO PIU' SOTTRARRE LE IRREGOLARITA
        ...
        public int CreaLocoConVerificheAmministrative(string codPsr, int idLottoVerificheAmministrative, DateTime dataFine, int operatore)
        {
            VerificaAmministrativaTesta tst = new VerificaAmministrativaTestaCollectionProvider().GetLastByCodPsr(codPsr);

            return CreaLocoConVerificheAmministrative(codPsr, idLottoVerificheAmministrative, tst.DataInizio, dataFine, operatore);

        }

        public int CreaLocoConVerificheAmministrative(string codPsr, int idLottoVerificheAmministrative, DateTime dataInizio, DateTime dataFine, int operatore)
        {
            DbProvider dbPro = new DbProvider();
            IDbCommand cmd;
            ...
            try
            {
                ...
                // Carico le nuove righe su CntrLoco_Dettaglio da verifiche amministrative dettaglio
                strSql = @"INSERT INTO dbo.CntrLoco_Dettaglio (IdLoco,
                    Id_Domanda_Pagamento,
                    Id_Progetto,
                    Asse,
                ...
                SELECT @IdLoco,
	                ...
	                IMPORTO_CONTRIBUTO_PUBBLICO_INCREMENTALE,
	                Esclusione,
	                dbo.fnCalcoloParametriDiRischioIr(ID_DOMANDA_PAGAMENTO),
	                dbo.fnCalcoloParametriDiRischioCr(ID_DOMANDA_PAGAMENTO),
	                dbo.fnCalcoloParametriDiRischioVerificheLocoComplessivo(ID_DOMANDA_PAGAMENTO),
	                @Operatore,
	                @DataInserimento,
	                @DataModifica 
                ...
                cmd.Parameters.Add(new SqlParameter("@CodPsr", codPsr));
                cmd.Parameters.Add(new SqlParameter("@IdLoco", _idLoco));
                cmd.Parameters.Add(new SqlParameter("@IdLotto", idLottoVerificheAmministrative));
                cmd.Parameters.Add(new SqlParameter("@DataInserimento", DateTime.Now));
                cmd.Parameters.Add(new SqlParameter("@DataModifica", DateTime.Now));
                cmd.Parameters.Add(new SqlParameter("@Operatore", operatore));
                cmd.Parameters.Add(new SqlParameter("@DataInizio", dataInizio));
