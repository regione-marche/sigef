...
namespace SiarBLL
{
    public partial class CertspDettaglioCollectionProvider : ICertspDettaglioProvider
    {
        ...
        public DateTime getDataUltimoFinale_ByDataLotto(DateTime dataLotto, string codPsr)
        {
            DateTime dataFinale;
            string apDataFinale;
            DbProvider dbPro = new DbProvider();
        ...
        public DateTime getDataInizioPrimoLottoDefinitivi(string codPsr)
        {
            DateTime dataFinale;
            string apDataFinale;
            DbProvider dbPro = new DbProvider();
        ...
        public CertspDettaglioCollection getPrjBy_DataFine(string codPsr, DateTime dataLotto, TipoDomande tpDom)
        {
            ...
            dataFinale = getDataUltimoFinale_ByDataLotto(dataLotto, codPsr);
...
//                                   vistaPer);
        ...
        public CertspDettaglio getPrjBy_IdProgetto(int idProgetto, DateTime dataLotto, string codPsr)
        {
            CertspDettaglio det = null;
            DateTime dataFinale = getDataUltimoFinale_ByDataLotto(dataLotto, codPsr);
        ...
        public CertspDettaglioCollection getBy_IdProgetto(int idProgetto, DateTime dataLotto, string codPsr)
        {
            CertspDettaglio det = null;
            CertspDettaglioCollection dets = new CertspDettaglioCollection();
            DateTime dataFinale = getDataUltimoFinale_ByDataLotto(dataLotto, codPsr);
        ...
        public List<RigaSpesa> GrigliaSpesa_Dati(string codPsr, DateTime dataLotto, bool soloDefinitivi, bool complessivi)
        {
            ...
            if (complessivi)
                DataFine = getDataInizioPrimoLottoDefinitivi(codPsr); //"01/01/2014";
            else
                DataFine = getDataUltimoFinale_ByDataLotto(dataLotto, codPsr);
        ...
        public List<RiepilogoPrevisioneProgettiCertificabili> GetRiepilogoPrevisioneProgettiCertificabili(string ente, string codPsr)
        {
            ...
            if (!string.IsNullOrEmpty(codPsr))
                cmd.Parameters.Add(new SqlParameter("@CodPsr", codPsr));
            dbPro.InitDatareader(cmd);
            while (dbPro.DataReader.Read())
            {
