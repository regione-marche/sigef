CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento111_15]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN
---  Verifica totale investimenti in domanda >= 20.000,00 €
...
-- 2. Totale spese ricognizione <= 20% totale domanda (codifica investimento = 11)
 ...
 IF ISNULL(@COSTO_INVESTIMENTI,0) < 20000  SET @RESULT=0 
