CREATE PROCEDURE [dbo].[calcoloStep112_311_3]
@IdProgetto int
AS
...
IF @ID_PROG_INTEG_311 IS NULL SET @RESULT=3
ELSE BEGIN
	...
	IF @NUMERO_INVESTIMENTI =0 SET @RESULT=3
	ELSE BEGIN
		SET @RESULT=(SELECT COUNT(*) FROM DICHIARAZIONI_X_PROGETTO WHERE ID_PROGETTO=@IdProgetto AND ID_DICHIARAZIONE IN (16,20,21))
	END
END
SELECT @RESULT
