create PROCEDURE [dbo].[calcoloRequisitoPagamento_B278_1]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN

-- SALDO
--=== Data inizio interventi programmati (entro 60gg. dalla data del ricevimento della comunicazione di finanzi abilità oltre eventuali proroghe) ===--
...
-- Data inizio interventi programmati (entro 60gg. dalla data del ricevimento della comunicazione di finanzi abilità oltre eventuali proroghe) 
SELECT @DIFFERENZA = DATEDIFF(DAY, DATEADD(DD,60, DATEADD(MM, ISNULL(@PROROGA_INIZIO,0),(select VAL_DATA from DOMANDA_PAGAMENTO_REQUISITI where 
