CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento_B209_1]
...
--326	Richiesta di saldo (entro 18 mesi dalla data di ricezione della comunicazione della finanziabilità oltre eventuali proroghe per la fine lavori)
--327	Data inizio interventi programmati (120 gg. dalla data del ricevimento della comunicazione di finanziabilità oltre eventuali proroghe)
