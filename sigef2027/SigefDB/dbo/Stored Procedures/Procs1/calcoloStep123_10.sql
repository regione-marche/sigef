CREATE  PROCEDURE [dbo].[calcoloStep123_10]
@IdProgetto int
AS
BEGIN
-- Materia prima di provenienza da contratti di Filiera >= 20% totale materia prima trasformata
...
BEGIN
	IF( @QUANTITA_FILIERA < ((@QUANTITA_TOT )*0.2) )	
