CREATE PROCEDURE [dbo].[calcoloStepVariante133_4]
@ID_VARIANTE int
AS
BEGIN
...
DECLARE @COSTO_INIZIATIVA DECIMAL(18,2),@NUM_INIZIATIVA INT, @SPESE_GENERALI DECIMAL(18,2), @SOGGETTO INT,@RESULT INT 
...
BEGIN
 SET @SOGGETTO=(SELECT TOP(1) ID_VALORE 
				FROM (SELECT PXI.ID_INVESTIMENTO 
					  ...
					  WHERE ID_VARIANTE =@ID_VARIANTE AND isnull(COD_VARIAZIONE,'x')!='A' ) AS INIZ  
