create PROCEDURE [dbo].[calcoloRequisitoPagamento_B273_2]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN

-- SALDO
--=== Data di completamento degli interventi programmati (12 mesi dal ricevimento della comunicazione di finanziabilità oltre eventuali proroghe) ===--
...
-- 289 - Data di completamento degli interventi programmati (12 mesi dal ricevimento della comunicazione di finanziabilità oltre eventuali proroghe)
...
SET @RESULT=(SELECT 'DIFF'= CASE WHEN DATEDIFF(DAY, DATEADD(MM,12 + ISNULL(@PROROGA,0) ,(@DATA_COM_FINAN)), @DATA_FINE_INT)<=0 THEN 1 ELSE 0 END)
