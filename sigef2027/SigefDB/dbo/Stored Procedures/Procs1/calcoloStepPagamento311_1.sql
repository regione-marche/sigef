CREATE  PROCEDURE [dbo].[calcoloStepPagamento311_1]
@IdProgetto int,
@IdDomandaPagamento int =NULL
AS
BEGIN

	-- verificato che la richiesta di SAL è SUPERIORE del 40% del contributo concesso  E MINORE DEL 70%

	DECLARE @ID_VARIANTE INT, @RESULT INT
    DECLARE @CONTRIBUTO_PROGETTO DECIMAL(10,2),
						@CONTRIBUTO_RICHIESTO_PAG DECIMAL(10,2)
...
IF(@CONTRIBUTO_RICHIESTO_PAG < (@CONTRIBUTO_PROGETTO * 0.40 ))
	SET @RESULT = 0
