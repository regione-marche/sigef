CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento4131a_GAL_F_2]
...
-- GAL FERMANO
-- SALDO
-- step : Data inizio interventi programmati (60 giorni dalla comunicazione di finanziabilità + eventuali proroghe)
-- 208	Data di ricezione della comunicazione di finanziabilità
-- 209	Data inizio interventi programmati
-- 532	Richiesta proroga di 60 giorni per l`avvio degli interventi
