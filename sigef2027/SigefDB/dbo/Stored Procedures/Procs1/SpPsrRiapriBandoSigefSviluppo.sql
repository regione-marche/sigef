CREATE PROCEDURE [dbo].[SpPsrRiapriBandoSigefSviluppo]
(
	@ID_BANDO INT, 
	@ID_UTENTE INT,
...
SET @DATA_ATTUALE=GETDATE()
	BEGIN TRY
		BEGIN TRAN NUOVO_BANDO
			...
			ID_PROGRAMMAZIONE, MULTIPROGETTO, MULTIMISURA, INTERESSE_FILIERA )
			...
			SELECT @ID_NUOVO_BANDO,COD_TP,DESCRIZIONE,AIUTO_MINIMO,CODICE,IS_MAX
			...
			SELECT C2.ID_CODIFICA_INVESTIMENTO, D.COD_DETTAGLIO, D.DESCRIZIONE,
					D.MOBILE, D.QUOTA_SPESE_GENERALI, D.RICHIEDI_PARTICELLA 
	...
	BEGIN CATCH
		...
		RAISERROR('Non è stato possibile riaprire il BANDO. Se il problema persiste contattare helpdesk.siar@regione.marche.it.',13,1)
	END CATCH		
END
