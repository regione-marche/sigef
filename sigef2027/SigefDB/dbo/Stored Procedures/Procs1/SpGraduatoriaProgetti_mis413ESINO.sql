/*************************************************************************************************************************************/
	 ...
	 CREATE PROCEDURE [dbo].[SpGraduatoriaProgetti_mis413ESINO]
(
	@ID_BANDO INT,
...
AS
	...
	*/
	...
	DECLARE PROGETTI CURSOR FOR SELECT P.ID_PROGETTO, VSP.COD_STATO  FROM @GRADUATORIA_PROGETTI_T P
	INNER JOIN VPROGETTO VSP ON VSP.ID_PROGETTO = P.ID_PROGETTO
	ORDER BY PUNTEGGIO DESC, COSTO_TOTALE DESC
	OPEN PROGETTI
	...
	WHILE @@FETCH_STATUS=0 BEGIN
		...
		ELSE SET @CONTRIBUTO_PROGETTO=dbo.calcoloContributoTotaleProgetto(@ID_PROGETTO,1,NULL)
		...
		IF @IMPORTO_TOTALE_BANDO>0 BEGIN
			IF @CONTRIBUTO_PROGETTO>@IMPORTO_TOTALE_BANDO BEGIN
				...
				SET @FINANZIABILITA=CASE WHEN @ID_BANDO=174 THEN 'P' ELSE 'N' END --- P parziale -- N non prevista finanziabilita parzialmente
			END
