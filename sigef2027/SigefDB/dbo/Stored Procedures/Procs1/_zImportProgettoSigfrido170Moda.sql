...
CREATE PROCEDURE [dbo].[_zImportProgettoSigfrido170Moda]
...
update _GraduatoriaSigfrido170 set ID_PROGETTO_SIGEF = @id_prog_sigef where ID_DOMANDA = @id_prog_sigfrido
...
inner join _vGrad170Moda gs on
--inner join _GraduatoriaSigfrido170 gs on
...
,COUNT(*) as NR_IMPRESE
from 
_GraduatoriaSigfrido170 g
where g.ID_DOMANDA in (
select distinct ID_DOMANDA from _GraduatoriaSigfrido170 g1 where 
...
_GraduatoriaSigfrido170 gs inner join @table_ute utx on
