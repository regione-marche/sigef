CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B279]
(
...
-- Costo dell`investimento ammissibile all`aiuto >= € 20.000 e <= € 100.000

IF (isnull(@COSTO_INVESTIMENTI,0) < 20000) or (isnull(@COSTO_INVESTIMENTI,0) > 100000) BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo dell`investimento ammissibile all`aiuto >= € 20.000 e <= € 100.000.'
END
