CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B277]
(
...
-- Costo totale investimento ammissibile <= 150.000 €
IF (isnull(@COSTO_INVESTIMENTI,0) > 150000) BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale investimento ammissibile maggiore di 150.000 Euro.'
END
---------------------------------------------------------------------------------------------------
