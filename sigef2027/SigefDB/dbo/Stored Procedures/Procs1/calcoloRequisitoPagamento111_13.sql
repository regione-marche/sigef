CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento111_13]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN
-- 111 b) c noleggio o costo di reintegrazione attrezzature <= 10%
...
---------------------------------------------------------------------------------------------------
SET @RESULT   = 1
 --   noleggio o costo di reintegrazione attrezzature <= 10%
...
IF @COSTO_INVESTIMENTI>0 BEGIN
	...
	IF @COSTO_INVESTIMENTI_NOLEGGIO>(@COSTO_INVESTIMENTI*0.10)  SET @RESULT=0 
