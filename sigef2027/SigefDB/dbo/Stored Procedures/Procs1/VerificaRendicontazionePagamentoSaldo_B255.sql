CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B255]
(
...
IF (isnull(@COSTO_INVESTIMENTI,0) > 150000)BEGIN
	...
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo investimento ammissibile <= € 150.000,00 al netto dell`IVA.'
END
---------------------------------------------------------------------------------------------------
