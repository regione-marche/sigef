CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento111_11]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN
-- 111b) - Costo totale del Personale <= 70% totale domanda 
...
IF @COSTO_INVESTIMENTI>0 BEGIN
	...
	WHERE DI.COD_DETTAGLIO IN( '1','6')
		IF @COSTO_INVESTIMENTI_PERSONALE>(@COSTO_INVESTIMENTI*0.70)  SET @RESULT=0 
