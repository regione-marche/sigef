CREATE  PROCEDURE [dbo].[calcoloStep123_FIL_1]
@IdProgetto int
AS
BEGIN
 

-- 123 a) certificazione difficoltà impresa con Bilanci chiusi PER FILIERA

DECLARE @Result int,@DATA  datetime , 
					@ID_Impresa int, @CAPITALE_1 decimal(10,2),  
					@CAPITALE_2 decimal(10,2), @CAPITALE_3 decimal(10,2)
...
DECLARE @ANNO INT, @CAPITALE decimal (10,2),@d decimal(10,2), @e decimal (10,2)

DECLARE BILANCIO_INDUSTRIALE CURSOR  FOR 
SELECT TOP(3) ISNULL(TP_PN_CAPITALE,0) AS TP_PN_CAPITALE, ANNO  
