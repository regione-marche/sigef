...
CREATE PROCEDURE [dbo].[_zImportProgettoSigfrido100]
...
I.RAGIONE_SOCIALE + '- Domanda id sigfrido' + CONVERT(VARCHAR(10), d.ID_PROGETTO) as Paragrafo, 
1 as Ordine
from _vGrad100 d 
...
,gs170m.CONTRIBUTO_RICHIESTO_2	--CONTRIBUTO_RICHIESTO
...
,gs170m.INV_AMMESSO_2				--COSTO_INVESTIMENTO
,0								--SPESE_GENERALI
--,gs170m.IMPORTO_LIQUIDATO_TOT	--CONTRIBUTO_RICHIESTO
,gs170m.CONTRIBUTO_CONCESSO_2	--CONTRIBUTO_RICHIESTO
,ci.AIUTO_MINIMO				--QUOTA_CONTRIBUTO_RICHIESTO
,null							--TASSO_ABBUONO
,null							--ID_SETTORE_PRODUTTIVO
,null							--ID_PRIORITA_SETTORIALE
...
UTENTI U on
PXI.ID_PERSONA = U.ID_PERSONA_FISICA
inner join _GraduatoriaSigfrido100 gs on
...
INSERT INTO [LOCALIZZAZIONE_PROGETTO]
    ...
    from 
    lp
    where lp.ID_IMPRESA_SIGEF is not null
...
,COUNT(*) as NR_IMPRESE
from 
_GraduatoriaSigfrido100 g
where g.ID_DOMANDA in (
select distinct ID_DOMANDA from _GraduatoriaSigfrido100 g1 where 
