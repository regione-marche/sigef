create PROCEDURE [dbo].[calcoloStepVariante111_9]
@ID_VARIANTE  int
AS
BEGIN
...
SET @SpeseIncontri = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
						FROM PIANO_INVESTIMENTI I 
						WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1 AND  
 						      I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
...
SET @SpeseConvegni = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
						FROM PIANO_INVESTIMENTI I 
						WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1    
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
															FROM CODIFICA_INVESTIMENTO
															WHERE ID_BANDO = @ID_BANDO
															AND CODICE = '2'))
...
SET @SpeseSeminari = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
						FROM PIANO_INVESTIMENTI I 
						WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
															FROM CODIFICA_INVESTIMENTO
...
SET @SpeseVisite =( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
					FROM PIANO_INVESTIMENTI I 
					WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
															FROM CODIFICA_INVESTIMENTO
...
SET @SpeseViaggi = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
						FROM PIANO_INVESTIMENTI I 
						WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
															FROM CODIFICA_INVESTIMENTO
...
IF (@SpeseViaggi >  (6000 * ISNULL(@NumeroViaggi,0))) SET @Result = 0
...
SET @SpeseWorkshop = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
						FROM PIANO_INVESTIMENTI I 
						WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
															FROM CODIFICA_INVESTIMENTO
...
SET @SpeseFiere = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
						FROM PIANO_INVESTIMENTI I 
						WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
														FROM CODIFICA_INVESTIMENTO
...
SET @Spese8a = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
				 FROM PIANO_INVESTIMENTI I 
				 WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1  
					AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
														FROM CODIFICA_INVESTIMENTO
...
SET @Spese8b = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
				 FROM PIANO_INVESTIMENTI I 
				 WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
																FROM CODIFICA_INVESTIMENTO
...
SET @Spese8c = (SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
				FROM PIANO_INVESTIMENTI I 
				WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
																FROM CODIFICA_INVESTIMENTO
...
SET @SpesePubblicazioni = ( SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
							FROM PIANO_INVESTIMENTI I 
							WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
								AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
																FROM CODIFICA_INVESTIMENTO
...
SET @SpeseWeb = (SELECT ISNULL(SUM(I.COSTO_INVESTIMENTO),0)
				 FROM PIANO_INVESTIMENTI I 
				 WHERE I.ID_VARIANTE =@ID_VARIANTE AND ISNULL(COD_VARIAZIONE,'x') != 'A' AND I.COD_TIPO_INVESTIMENTO = 1   
						AND I.ID_CODIFICA_INVESTIMENTO IN (SELECT ID_CODIFICA_INVESTIMENTO 
															FROM CODIFICA_INVESTIMENTO
															WHERE ID_BANDO =@ID_BANDO AND CODICE = '10'))
...
IF (@SpeseWeb > (2500 * ISNULL(@NumeroWeb,0))) SET @Result = 0 
