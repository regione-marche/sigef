create PROCEDURE [dbo].[SpCalcoloSanzioneVATardiva]
(
	@ID_SANZIONE INT,
...
ELSE BEGIN
	...
	ELSE BEGIN
		...
		ELSE BEGIN
			...
			IF(@QUOTA_ENTITA>40)SET @CLASSE_VIOLAZIONE_ENTITA=5
			ELSE IF(@QUOTA_ENTITA>20) SET @CLASSE_VIOLAZIONE_ENTITA=3
			...
			IF(@SOMMA_VIOLAZIONI<3) SET @QUOTA_RIDUZIONE=5
			ELSE IF(@SOMMA_VIOLAZIONI<4) SET @QUOTA_RIDUZIONE=10
			ELSE SET @QUOTA_RIDUZIONE=30	
