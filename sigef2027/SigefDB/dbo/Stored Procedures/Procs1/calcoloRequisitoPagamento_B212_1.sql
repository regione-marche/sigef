CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento_B212_1]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN

-- SALDO
--=== Data inizio interventi programmati (180 gg. dalla data del ricevimento della comunicazione di finanziabilità oltre eventuali proroghe) ===--

-- new
-- 205 - Data inizio inteventi programmati
-- 204 - Data di ricezione della comunicazione di finanziabilità
-- 296 - Data inizio interventi programmati (180 gg. dalla data del ricevimento della comunicazione di finanziabilità oltre eventuali proroghe)
...
-- Data inizio interventi programmati (180 gg. dalla data del ricevimento della comunicazione di finanziabilità oltre eventuali proroghe)
SELECT @DIFFERENZA = DATEDIFF(DAY, DATEADD(DD,180, DATEADD(MM, ISNULL(@PROROGA_INIZIO,0),(select VAL_DATA from DOMANDA_PAGAMENTO_REQUISITI where 
