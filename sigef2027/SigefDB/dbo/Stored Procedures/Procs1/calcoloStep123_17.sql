CREATE  PROCEDURE [dbo].[calcoloStep123_17]
	@IdProgetto int, 
	@FASE_ISTRUTTORIA INT = 0
AS
BEGIN
--  123 - Totale inivestimenti per interventi legati alla    commercializzazione > = 20.000,00 €
DECLARE @Count int, @COSTO DECIMAL (20,2),@RESULT INT
...
SET @Count = (SELECT COUNT(ID_INVESTIMENTO)
			  ...
			  AND (P.ID_PROGETTO=@IdProgetto ) AND (CODICE IN ('64','65')))
IF (ISNULL(@Count,0) > 0) 
BEGIN 
