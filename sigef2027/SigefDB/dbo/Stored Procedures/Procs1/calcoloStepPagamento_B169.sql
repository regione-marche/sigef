create  PROCEDURE [dbo].[calcoloStepPagamento_B169]
@IdProgetto int,
@IdDomandaPagamento int =NULL
AS
BEGIN

	--Verifica di un investimento rendicontato non inferiore al limite di € 10.000,00, conforme par.16. pag. 20 del Bando.
