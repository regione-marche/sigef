CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento111_10]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN
-- 111b) - Spese coordinamento <= 5% totale domanda (Codifica investimento = 12)
...
DECLARE @COSTO_INVESTIMENTI_COORD DECIMAL(18,2)
	...
	IF @COSTO_INVESTIMENTI>0 BEGIN
		...
		WHERE  CO.CODICE= '12'	
		IF @COSTO_INVESTIMENTI_COORD>(@COSTO_INVESTIMENTI*0.05)  SET @RESULT=0 
