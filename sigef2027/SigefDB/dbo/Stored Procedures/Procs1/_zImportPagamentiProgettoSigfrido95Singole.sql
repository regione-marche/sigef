...
CREATE PROCEDURE [dbo].[_zImportPagamentiProgettoSigfrido95Singole]
...
INSERT INTO [DOMANDA_DI_PAGAMENTO]
     ...
     --VALUES
     SELECT
       CASE WHEN gs.ID_DOMANDA in(15316, 15383) THEN 'SLD' ELSE  'SAL' END,		--(<COD_TIPO, char(3),>
...
INSERT INTO [GIUSTIFICATIVI]
     ...
     --VALUES
		...
		gs.IMPORTO_SPESA IMPONIBILE,								--,<IMPONIBILE, decimal(18,2),>
