CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_M4131A2_B188]
(
...
---------------------------------------------------------------------------------------------------
-- La spesa ammissibile deve essere MAGGIORE di euro 15.000
...
IF @COSTO_INVESTIMENTI<15000 BEGIN
	...
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - L`ammontare rendicontato sulla misura 4131a deve essere superiore a 15.000 €.'
END
