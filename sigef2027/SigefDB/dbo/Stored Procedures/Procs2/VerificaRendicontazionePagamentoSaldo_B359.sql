CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B359]
(
...
-- Costo dell`investimento ammissibile all`aiuto > = 15.000 €
IF (isnull(@COSTO_INVESTIMENTI,0) < 15000)BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo dell`investimento ammissibile all`aiuto > = 15.000 €.'
END
---------------------------------------------------------------------------------------------------
