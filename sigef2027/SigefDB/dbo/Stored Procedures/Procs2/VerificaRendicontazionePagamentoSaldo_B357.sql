CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B357]
(
...
--Costo investimento ammissibile <= € 60.000,00 al netto dell`IVA.
...
IF ((@COSTO_INVESTIMENTI > 60000))  BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> Costo investimento ammissibile <= € 60.000,00 al netto dell`IVA'
END
