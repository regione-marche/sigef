CREATE PROCEDURE [dbo].[ZBandoComunicazioniFindFind]
(
...
AS
	...
	if (@lensql<3000)
	exec sp_executesql @sql,N'@CodTipoequalthis VARCHAR(255), @IdBandoequalthis INT',@CodTipoequalthis , @IdBandoequalthis ;
	else
...
GO
EXECUTE sp_addextendedproperty @name = N'backup', @value = NULL, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'ZBandoComunicazioniFindFind';
