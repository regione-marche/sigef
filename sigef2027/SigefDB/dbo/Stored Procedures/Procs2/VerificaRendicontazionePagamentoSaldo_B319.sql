CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B319]
(
...
-- L'investimento massimo ammissibile è pari a € 50.000,00 di costo totale (escluso IVA)
----
---------------------------------------------------------------------------------------------------
...
-- Costo totale investimento < = 50.000€
IF (isnull(@COSTO_INVESTIMENTI,0) > 50000)BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - L’investimento massimo ammissibile è pari a € 50.000,00 di costo totale'
END
