CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B419]
(
...
--Costo investimento ammissibile <= € 20.000,00 al netto dell`IVA.
...
IF ((@COSTO_INVESTIMENTI > 20000))  BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> Costo investimento ammissibile <= € 20.000,00 al netto dell`IVA'
END
