CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_M4131B_B167]
(
...
---------------------------------------------------------------------------------------------------
-- rendicontare un investimento non inferiore al limite di € 15.000,00.
...
IF @COSTO_INVESTIMENTI<15000 BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - L`ammontare rendicontato sulla misura 4131b deve essere superiore a 15.000 €.'
END
