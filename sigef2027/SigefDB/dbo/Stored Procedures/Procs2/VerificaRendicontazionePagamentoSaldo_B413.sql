CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B413]
(
...
IF ((isnull(@COSTO_INVESTIMENTI,0) > 150000))BEGIN
	...
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale investimento ammissibile <= 150.000 €.'
END
