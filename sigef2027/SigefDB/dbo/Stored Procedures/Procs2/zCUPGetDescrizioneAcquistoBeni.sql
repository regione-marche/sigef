CREATE PROCEDURE [dbo].[zCUPGetDescrizioneAcquistoBeni]
(
	@IdProgetto INT 
)
AS
...
--ELSE LEFT(CAST(BRT.TESTO AS VARCHAR(MAX)),256) END AS bene,
LEFT('PROGETTO ID SIGEF ' + CONVERT(VARCHAR(10),P.ID_PROGETTO) + ' POR MARCHE FESR 2014-2020 - Azione ' + ZP.CODICE + ' ' + ZP.DESCRIZIONE, 100) AS bene, 
