CREATE PROCEDURE [dbo].[ZDomandaPagamentoLiquidazioneFindFindbydecreto]
(
...
AS
	...
	if (@lensql<3000)
	exec sp_executesql @sql,N'@IdDomandaPagamentoequalthis INT, @IdProgettoequalthis INT, @IdImpresaBeneficiariaequalthis INT, @Liquidatoequalthis BIT, @IdDecretoequalthis INT',@IdDomandaPagamentoequalthis , @IdProgettoequalthis , @IdImpresaBeneficiariaequalthis , @Liquidatoequalthis , @IdDecretoequalthis ;
	else
		...
		WHERE 
			...
			((@Liquidatoequalthis IS NULL) OR LIQUIDATO = @Liquidatoequalthis) AND 
			((@IdDecretoequalthis IS NULL) OR ID_DECRETO = @IdDecretoequalthis)
		ORDER BY ID


GO
EXECUTE sp_addextendedproperty @name = N'backup', @value = 'CREATE PROCEDURE [dbo].[ZDomandaPagamentoLiquidazioneFindFindbydecreto]
(
	@IdDomandaPagamentoequalthis INT, 
	@IdProgettoequalthis INT, 
	@IdImpresaBeneficiariaequalthis INT, 
...
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'ZDomandaPagamentoLiquidazioneFindFindbydecreto';
