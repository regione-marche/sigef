CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B336]
(
...
-- Costo totale investimento ammissibile <= 75.000 €,
IF (isnull(@COSTO_INVESTIMENTI,0) > 75000)BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale investimento ammissibile <= 75.000 €.'
END
---------------------------------------------------------------------------------------------------
