CREATE VIEW vRNA_ESITO_CONCESSIONE AS
SELECT 
	P.ID_BANDO,
	P.ID_PROGETTO,
	P.COD_STATO,
...
DATI_MONITORAGGIO_FESR FSR ON P.ID_PROGETTO = FSR.ID_PROGETTO INNER JOIN
...
ON PNS.ID_AGGREGAZIONE = IA.ID_AGGREGAZIONE) IMP
...
(SELECT *
	...
	( SELECT COUNT(*)
		...
		AND t2.DATA_INSERIMENTO > t1.DATA_INSERIMENTO
		) = 0) LOG_CONC
...
WHERE P.COD_STATO NOT IN ('P','L') AND
FSR.CUP_NATURA IN ('06','07','08')
