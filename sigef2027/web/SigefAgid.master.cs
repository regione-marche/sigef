...
public partial class SigefAgid : SiarLibrary.Web.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        buttonAccedi.HRef = VirtualPathUtility.ToAbsolute("~/Private/") + "welcome.aspx";
        useAccedi.Attributes["href"] = VirtualPathUtility.ToAbsolute("~/bootstrap-italia/svg/sprites.svg#it-user");
        useAccedi.Attributes["xlink:href"] = VirtualPathUtility.ToAbsolute("~/bootstrap-italia/svg/sprites.svg#it-user");
        ...
        foreach (SiarLibrary.News n in news.FiltroInterruzioneDiSistema(true, null, DateTime.Now))
        {
            ...
            {
                if (n.DataInizio <= DateTime.Now) {
                    Response.Redirect("~/manutenzione.aspx"); break;
                }
