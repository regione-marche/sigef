    ...
    public partial class ImpresaControl : UserControl
    {
        ...
        public void loadData()
        {
            ...
            else
            {
                ...
                if (_impresa.DataInizioAttivita != null)
                    txtDataInizioAttivita.Text = _impresa.DataInizioAttivita.ToStringAgid();
                ...
                if (_impresa.IdRapprlegaleUltimo != null)
                {
                    ...
                    else
                    {
                        ...
                        if (rlegale.DataNascita != null)
                            txtRLDataNascita.Text = rlegale.DataNascita.ToStringAgid();
