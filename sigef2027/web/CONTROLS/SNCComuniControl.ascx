...
<div class="row">
    <div class="col-sm-4">
        <Siar:TextBox  Label=" Comune" ID="txtSNCZCDenominazione" runat="server" />
    </div>
    <div class="col-sm-4">
        <Siar:TextBox  Label="Provincia" ID="txtSNCZCProvincia" runat="server" MaxLength="2" ReadOnly="True" />
    </div>
    <div class="col-sm-4">
        <Siar:TextBox  ID="txtSNCZCCap" Label="Cap" runat="server" MaxLength="5" ReadOnly="True"
            TextAlign="right" />
    </div>
</div>
        ...
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr class='TESTA1'>
                        <td style="border: 0">SELEZIONA IL COMUNE:
                        </td>
                        <td align="right" style="border: 0">cerca nelle Marche
