        ...
        private byte[] getDocumentoFromServer(params string[] parametri)
        {
            ...
            switch (_tipoDocumento)
            {
                ...
                case "COMUNICAZIONE_CERTIFICAZIONE_NEW":
                    report = rt.getReportByName("rptComunicazioneCertificazioneNew", new string[] { "dataFine=" + parametri[0], "dataLotto=" + parametri[1], "codPsr=" + parametri[2], "idLotto=" + parametri[3] });
                    break;
                case "RICHIESTA_PROF":
