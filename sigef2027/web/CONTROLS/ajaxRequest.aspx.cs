        ...
        public void getDatiDomanda()
        {
            try
            {
                ...
                if (int.TryParse(Request.Form["iddom"], out iddomanda))
                {
                    ...
                    if (progetti.Count > 0)
                    {
                        return_object.Html = "<div class='modal-dialog' role='document'><div class='modal-content'><div class='modal-header'><h2 class='modal-title h5 ' id='modal1Title'>Dettaglio della domanda:</h2></div><div class='modal-body'><div class='col-sm-12'>Numero: <b>" + progetti[0].IdProgetto + "</b></div><div class='col-sm-12'>Partita iva/Codice fiscale: <b>" + progetti[0].AdditionalAttributes["CUAA"] + @"</b></div><div class='col-sm-12'>Ragione sociale: " + progetti[0].AdditionalAttributes["RAGIONE_SOCIALE"] + @"</div><div class='col-sm-12'>Sede: " + progetti[0].AdditionalAttributes["COMUNE"] + " (" + progetti[0].AdditionalAttributes["SIGLA"]
                                                        + ") - " + progetti[0].AdditionalAttributes["CAP"] + @"</div><div class='col-sm-12'>Stato attuale: " + progetti[0].AdditionalAttributes["STATO"] + @"</div><div class='col-sm-12'>Istruttore: " + progetti[0].Nominativo + " (" + progetti[0].Provincia + @")</div></div></div>";
...
//<tr><td style='width:89px'>&nbsp;<b>Numero:</b></td><td>progetti[0].IdProgetto</td></tr>
//<tr><td style='width:89px'>&nbsp;<b>Partita iva/Codice fiscale:</b></td><td></td></tr>
//<tr><td style='width:89px'><b>&nbsp;Rag.soc:</b></td><td></td></tr>
//<tr><td style='width:89px'><b>&nbsp;Sede:</b></td><td></td></tr>
//<tr><td style='width:89px'>&nbsp;<b>Stato attuale:</b></td><td></td></tr>
//<tr><td style='width:89px'><b>&nbsp;Istruttore:</b></td><td></td></tr>
...
<tr class='TESTA1'><td>Nr.</td><td>Descrizione</td><td>&nbsp;</td></tr>";
        ...
        public void getDocumentiBando()
        {
            try
            {
                return_object.Html = "<b> - Nessun elemento trovato.</b>";
                int id_bando;
                if (int.TryParse(Request.Form["idb"], out id_bando))
                {
                    ...
                    if (Organismi_intermedi)
                    {
                        ...
                        if(atti_col.Count >0)
                        {
                            return_object.Html = @"<b>Numero documenti trovati: " + atti_col.Count.ToString() + "</b><table class='table table-striped'><theader><tr><th>Nr. atto</th><th>Data</th><th>Descrizione</th></tr></theader><tbody>";
                            int counter = 1;
                            foreach (SiarLibrary.Atti a in atti_col)
                            {
                                ...
                                return_object.Html += "<tr class='selectable' onclick=\"window.open('" + a.LinkEsterno
                                    + "','_blank');\"><td>" + a.Numero
                                    + "</td><td>" + a.Data + "</td><td>" + a.Descrizione + "</td></tr>";
                                counter++;
                            }
                    ...
                    else
                    {
                        ...
                        {
                            return_object.Html = @"<b>Numero documenti trovati: " + doc_bando.Count.ToString() + "</b><table class='table table-striped'><theader><tr><th>Nr. atto</th><th>Data</th><th>Descrizione</th></tr></theader><tbody>";
                            int counter = 1;
                            foreach (SiarLibrary.BandoStorico s in doc_bando)
                            {
                                return_object.Html += "<tr class='selectable' onclick=\"visualizzaAtto(" + s.IdAtto
                                    + ");\"><td>" + s.NumeroAtto
                                    + "</td><td>" + s.DataAtto + "</td><td>" + s.Stato + "</td></tr>";
                                counter++;
                            }
                            return_object.Html += "</tbody></table>";
                        }
