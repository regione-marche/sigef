...
<div id="divVisualizzaProtocollo" runat="server" style="position: absolute; display: none;" class="modal it-dialog" tabindex="-1" role="dialog">
    ...
    <div id="divScelta" runat="server" class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 form-group">
                        <input id="inputSegnatura" runat="server" type="text" disabled="disabled"/>
                    </div>
                    <div class="col-sm-12">
                        <Siar:Button runat="server" ID="btnCopiaSegnatura" Text="Copia segnatura" OnClientClick="return copiaSegnaturaInRam();" />
                        <Siar:Button ID="btnChiudiValidazione" runat="server" OnClick="btnChiudi_Click" Text="Chiudi" />
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="tableTab" id="divVistaSemplice" runat="server">
                            ...
                            <div class="table-responsive">
                                <Siar:DataGridAgid CssClass="table table-striped" ID="dgVistaSemplice" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                        ...
                        <div class="tableTab" id="divVistaAvanzata" runat="server" style="display: none;">
                            <div style="display: inline-block; vertical-align: top">
                                ...
                                <div class="table-responsive">
                                    <Siar:DataGridAgid CssClass="table table-striped" ID="dgElencoSegnature" runat="server" AutoGenerateColumns="False">
                                        <Columns>
                            ...
                            <div style="display: inline-block;">
                                ...
                                <div class="table-responsive">
                                    <Siar:DataGridAgid CssClass="table table-striped" ID="dgVistaAvanzata" runat="server" AutoGenerateColumns="False">
                                        <Columns>
                                            <asp:BoundColumn HeaderText="Documento">
                                                <ItemStyle HorizontalAlign="center" />
                                            </asp:BoundColumn>
