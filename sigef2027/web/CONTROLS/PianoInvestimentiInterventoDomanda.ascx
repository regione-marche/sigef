...
<div class="accordion-item" id="dBoxIntervento" runat="server">
    ...
    <div id="collapsePianoInvestimentiIntervento" class="accordion-collapse collapse" role="region" aria-labelledby="pianoInvestimentiInterventoHeading">
        <div class="accordion-body">
            <Siar:DataGridAgid CssClass="table table-striped" ID="dgInterventi" runat="server" AutoGenerateColumns="False" ShowFooter="true">                
