<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PianoInvestimentiCodificaDomandaIstruttoria.ascx.cs"
    Inherits="web.CONTROLS.PianoInvestimentiCodificaDomandaIstruttoria" %>
    ...
    <div id="collapsePianoInvestimentiCodifica" class="accordion-collapse collapse" role="region" aria-labelledby="pianoInvestimentiCodificaHeading">
        <div class="accordion-body">
            <div class="table-responsive">
                <Siar:DataGridAgid ID="dgCodifica" runat="server" AutoGenerateColumns="False" ShowFooter="true" CssClass="table table-striped">
