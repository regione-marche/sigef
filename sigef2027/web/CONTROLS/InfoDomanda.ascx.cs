    ...
    public partial class InfoDomanda : System.Web.UI.UserControl
    {
        ...
        public void loadData()
        {
            if (_progetto != null)
            {
                ...
                lnkDocumentiBando.HRef = "javascript:mostraPopupDocumentiBando(" + _progetto.IdBando + ")";

                SiarLibrary.Bando b = new SiarBLL.BandoCollectionProvider().GetById(_progetto.IdBando);
