<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPagamentoInvestimentoRet.ascx.cs" Inherits="web.CONTROLS.ucPagamentoInvestimentoRet" %>
...
<div id="divPagInv" runat="server" style="width: 40%; height: 96%; position: absolute; display: none; box-shadow: none;">
    ...
    <script type="text/javascript">
        ...
        function btnCalcolaContributoAmmessoSoc_Click() {
            if ($('[id$=txtPBImportoAmmessoSoc]').val() == '') {
                alert('Attenzione! Inserire l`importo ammesso.');
            } else if ($('[id$=txtPBContributoAmmessoQuotaSoc]').val() == '') {
                alert('Attenzione! Inserire la percentuale ammessa.'); 
            } else {
                var importo = $('[id$=txtPBImportoAmmessoSoc]').val();
                importo = importo.replace(/\./g, '');
                importo = importo.replace(',', '.');
                var contributoperc = $('[id$=txtPBContributoAmmessoQuotaSoc_text]')[0].value;
...
//                contributo = contributo.toString().replace(".", ",");
                $('[id$=txtPBContributoAmmessoSoc]').val(FromNumberToCurrency(contributo));
    ...
    <div style="display: none">
        ...
        <asp:HiddenField ID="hdnIdPagamentoRichiesto" value="false" runat="server" />
    </div>
        ...
        <div style="float: left; overflow: auto; width: 100%; height: 95%;">
            ...
            <div style="padding: 10px;">
                <label for="txtPBImportoRichiesto" style="width: 140px; white-space: nowrap; float: left; padding-right: 10px;">
                    Importo €:<br />
                    <Siar:CurrencyBox ID="txtPBImportoRichiesto" runat="server" Width="100px"  ReadOnly="True" />
                </label>
            ...
            <div style="padding: 10px;">
                <label for="txtPBImportoAmmesso" style="width: 140px; white-space: nowrap; float: left; padding-right: 10px;">
                    Importo €:<br />
                    <Siar:CurrencyBox ID="txtPBImportoAmmesso" runat="server" Width="100px" ReadOnly="True"  />
                </label>
                ...
                <label for="txtPBContributoAmmessoQuota" style="white-space: nowrap; float: left; padding-right: 10px;">
                    Contributo %:<br />
                    <Siar:QuotaBox NrDecimali="12" ID="txtPBContributoAmmessoQuota" runat="server" Width="100px" ReadOnly="True"  />
                </label>
                <br style="clear: both;" />
                <br />
                ...
                <Siar:ComboBase ID="lstMotivoRiduzione" runat="server" NomeCampo="MotivoRiduzione" Enabled =" false"></Siar:ComboBase><br />
                <label for="txtPBNoteAggiuntive">
                    Note aggiuntive (max 500 caratteri):<br />
                    <Siar:TextArea ID="txtPBNoteAggiuntive" runat="server" Width="440px" Rows="2" MaxLength="500" ReadOnly="true"/>
                </label>
            </div>
           
            <div class="separatore_light">
                Pagamento ammesso ulteriori contributi:
            </div>
            <div style="padding: 10px;">
                
                <label  style=" white-space: nowrap; float: left; padding-right: 10px;">
                    Istruire nuovamente il pagamento richiesto iniziale:<br /></label><br />
                <br style="clear: both;" />
                <label for="txtPBImportoAmmessoSoc" style="width: 140px; white-space: nowrap; float: left; padding-right: 10px;">
                    Importo €:<br />
                    <Siar:CurrencyBox ID="txtPBImportoAmmessoSoc" runat="server" Width="100px" />
                </label>
                <label for="txtPBContributoAmmessoSoc" style="width: 140px; white-space: nowrap; float: left; padding-right: 10px;">
                    Contributo €:<br />
                    <Siar:CurrencyBox ID="txtPBContributoAmmessoSoc" runat="server" Width="100px" ReadOnly="True" />
                </label>
                <label for="txtPBContributoAmmessoQuotaSoc" style="white-space: nowrap; float: left; padding-right: 10px;">
                    Contributo %:<br />
                    <Siar:QuotaBox NrDecimali="12" ID="txtPBContributoAmmessoQuotaSoc" runat="server" Width="100px" />
                </label>
                <br style="clear: both;" />
                <br />
                <input id="btnCalcolaContributoAmmessoSoc" runat="server" class="ButtonGrid" style="width: 95px;" type="button" value="Calcola" onclick="btnCalcolaContributoAmmessoSoc_Click();" />
                <br style="clear: both;" />
                <br />
                <label for="txtPBNoteAggiuntiveSoc">
                    Note aggiuntive (max 500 caratteri):<br />
                    <Siar:TextArea ID="txtPBNoteAggiuntiveSoc" runat="server" Width="440px" Rows="4" MaxLength="500" />
                </label>
            </div>
        </div>
        <br style="clear: both;" />
        <div id="divButton" style="text-align: center; ">
            <Siar:Button ID="btnSalvaPag" runat="server" Text="Salva" Width="130px" OnClick="btnSalvaPag_Click" />
    ...
    <div id="divSpeseAssociate" class="dBox" style="float: right; width: 0%; height: 100%; display: none;">
        ...
        <div id="divDettaglioSpesa" runat="server" style="padding: 10px; display: none;">
            ...
            <br />
            <Siar:Button ID="btnSalvaImportiSpesa" runat="server" Text="Salva importi" Width="130px" OnClick="btnSalvaImportiSpesa_Click" />
        </div>
    </div>
    <br style="clear: both;" />
</div>