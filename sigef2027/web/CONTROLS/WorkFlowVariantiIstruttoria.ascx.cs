...
{
    public partial class WorkFlowVariantiIstruttoria : System.Web.UI.UserControl
    {
        private SiarLibrary.VworkflowVarianteCollection _workflow
        {
            get { return ((SiarLibrary.Web.IstruttoriaVariantePage)Page).WorkFlow; }
            set { ((SiarLibrary.Web.IstruttoriaVariantePage)Page).WorkFlow = value; }
        }
