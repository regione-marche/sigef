    ...
    public partial class ucCruscotto : SigefUserControl
    {
        ...
        void dgDomandeIstruttore_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dgi.Cells[col_visualizzaDomanda].Text = "<input type=button onclick=\"location='" + PATH_PPAGAMENTO + "DatiAnagrafici.aspx?idpag="
                        + cruscotto.IdDomandaPagamento + "'\" value='Visualizza la domanda'  class='btn btn-primary py-1'/>";
                ...
                if (permessi_operatore > 2)
                {
                    ...
                    dgi.Cells[col_istruttoria].Text = "<input type=button onclick=\"location='" + PATH_IPAGAMENTO + "CheckListPagamento.aspx?idpag="
                        + cruscotto.IdDomandaPagamento + "'\" value='" + testo + "'  class='btn btn-primary py-1'/>";
                }
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (cruscotto.IdProgetto != null)
                {
                    ...
                    else if (cruscotto.StatoProgetto.Equals("Rilasciato/Definitivo"))
                    {
                        ...
                        dgi.Cells[col_azione].Text = "<input type=button onclick=\"location='" + url + "'\"' value ='Assegna istruttore' style='width:100%' class='btn btn-primary py-1'/>";
                    }
                }
                else if (cruscotto.StatoBando.Equals("In lavorazione"))
                {
                    ...
                    dgi.Cells[col_azione].Text = "<input type=button onclick=\"location='" + url + "'\"' value ='Sezione dettaglio' style='width:100%' class='btn btn-primary py-1'/>";
                }
                else
                {
                    dgi.Cells[col_visualizzaDomanda].Text = "";
        ...
        void dgBandiDefinitiviSenzaDecreto_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dgi.Cells[col_azione].Text = "<input type=button onclick=\"location='" + url + "'\"' value ='Vai alla graduatoria' style='width:100%' class='btn btn-primary py-1'/>";
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (tipo_modifica > 0)
                {
                    ...
                    dgi.Cells[col_ButtonLink].Text = "<input type=button onclick=\"location='" + url + "'\" value='" + testo
                        + "' style='width:130px' class='btn btn-primary py-1'/>";
                }
                        ...
                        list_abilita_inserimento.Contains(domanda.Ordine)))
                    {
                        ...
                        list_abilita_inserimento.Contains(domanda.Ordine)))
                        {
                            if (variante_inserita_non_istruita)
                                ...
                                + "')\" value='Richiedi pagamento' style='width:130px' class='btn btn-primary py-1'/>";
                        }
                    }
                }
                else
                {
                    ...
                    if (permessi_operatore < 4 || ((PrivatePage)Page).Operatore.Utente.CodTipoEnte == "%")
                        dgi.Cells[col_InfoDomanda].Text = "<input type=button onclick=\"location='" + PATH_PPAGAMENTO + "DatiAnagrafici.aspx?idpag="
                            + domanda.IdDomandaPagamento + "'\" value='Visualizza la domanda'  class='btn btn-primary py-1'/>";
                    dgi.Cells[col_Istruita].Text = "<input type='checkbox' disabled=true />";
                    ...
                    if (domanda.Segnatura != null)
                    {
                        ...
                        if (!allegatiProtocollatiOk)
                        {
                            dgi.Cells[col_InfoDomanda].Text = "<input type=button onclick=\"location='" + PATH_PPAGAMENTO + "FirmaRichiesta.aspx?idpag="
                                + domanda.IdDomandaPagamento + "'\" value='Protocolla gli allegati'  class='btn btn-primary py-1'/>";
                        }
                        else
                        {
                            ...
                            if (permessi_operatore > 2)
                            {
                                ...
                                dgi.Cells[col_InfoDomandaIstruttore].Text = "<input type=button onclick=\"location='" + PATH_IPAGAMENTO + "CheckListPagamento.aspx?idpag="
                                    + domanda.IdDomandaPagamento + "'\" value='" + testo + "'  class='btn btn-primary py-1'/>";
                            }
                        }
                    }
                    else if (((PrivatePage)Page).AbilitaModifica && domanda.CfOperatore == ((PrivatePage)Page).Operatore.Utente.CfUtente)
                        dgi.Cells[col_InfoDomanda].Text = "<input type=button onclick=\"location='" + PATH_PPAGAMENTO + "DatiAnagrafici.aspx?idpag="
                            + domanda.IdDomandaPagamento + "'\" value='Modifica la richiesta'  class='btn btn-primary py-1'/>";
        ...
        void dgLottiRevisioneIstruttore_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string buttonValidazioneLotti = "<input type=button onclick=\"location='" + PATH_VALIDAZIONELOTTI + "ValidazioneLotti.aspx?idb=" + l.IdBando.ToString() + "'\" Value='Validazione Lotti' style='width:130px' class='btn btn-primary py-1'/>";
        ...
        void dgIstruttoriaDomandaAiuto_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (i.CodStato == "L")
                    stringbuttonValidazioneLotti = "<input type=button onclick=\"location='" + PATH_ISTRUTTORIA + "ChecklistRicevibilita.aspx?iddom=" + i.IdProgetto.ToString() + "&idb=" + i.IdBando.ToString() + "'\" Value='Checklist Ricevibilità'  class='btn btn-primary py-1'/>";
                else if (i.CodStato == "I")
                    stringbuttonValidazioneLotti = "<input type=button onclick=\"location='" + PATH_ISTRUTTORIA + "ChecklistAmmissibilita.aspx?iddom=" + i.IdProgetto.ToString() + "&idb=" + i.IdBando.ToString() + "'\" Value='Checklist Ammissibilità'  class='btn btn-primary py-1'/>";
                else
        ...
        void dgRichiesteConsulente_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dgi.Cells[col_Approva].Text = "<input type='Button' class='btn btn-primary py-1' value='Approva' onclick='ApprovaRichiestaConsulente(" + r.IdRichiestaConsulente + ");' />";
                dgi.Cells[col_Rifiuta].Text = "<input type='Button' class='btn btn-primary py-1' value='Rifiuta' onclick='RifiutaRichiesteConsulente(" + r.IdRichiestaConsulente + ");' />";
                ...
                dgi.Cells[col_ImgSegnatura].Text = "<svg alt='Visualizza Protocollo' onclick=\"javascript:sncAjaxCallVisualizzaProtocollo('" + r.Segnatura + "');\" class='icon pointer icon-breadcrumb icon-secondary me-1'><use href='/web/bootstrap-italia/svg/sprites.svg#it-search'></use></svg>";
            }
        }
        ...
        void dgRichiesteConsulenteProcura_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dgi.Cells[col_Approva].Text = "<input type='Button' class='btn btn-primary py-1' value='Approva' onclick='ApprovaRichiestaConsulenteProcura(" + r.AdditionalAttributes["ID"] + ", " + r.IdRichiestaConsulente + ", " + r.AdditionalAttributes["ID_BANDO"] + ");' />";
                dgi.Cells[col_Rifiuta].Text = "<input type='Button' class='btn btn-primary py-1' value='Rifiuta' onclick='RifiutaRichiesteConsulenteProcura(" + r.AdditionalAttributes["ID"] + ", " + r.IdRichiestaConsulente + ", " + r.AdditionalAttributes["ID_BANDO"] + ");' />";
        ...
        void dgRichiesteProfilazione_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dgi.Cells[col_Approva].Text = "<input type='Button' class='btn btn-primary py-1' value='Approva' onclick='ApprovaRichiestaProfilazione(" + r.IdRichiesta + ");' />";
                dgi.Cells[col_Rifiuta].Text = "<input type='Button' class='btn btn-primary py-1' value='Rifiuta' onclick='RifiutaRichiesteProfilazione(" + r.IdRichiesta + ");' />";
                ...
                dgi.Cells[col_documento].Text = "<svg alt='Visualizza Protocollo' onclick=\"javascript:SNCVisualizzaReport('rptRichiestaProfilazione',1,'IdRichiesta=" + r.IdRichiesta + "');\" class='icon pointer icon-breadcrumb icon-secondary me-1'><use href='/web/bootstrap-italia/svg/sprites.svg#it-search'></use></svg>";
