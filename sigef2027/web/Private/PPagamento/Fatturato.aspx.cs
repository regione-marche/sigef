...
namespace web.Private.PPagamento
{
    ...
    public partial class Fatturato : SiarLibrary.Web.DomandaPagamentoPage
    {
        ...
        void dgFatturato_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (AbilitaModifica)
                    e.Item.Cells[4].Text = "<input type='button' style='width:70px' class='ButtonGrid' value='Elimina'  onclick='eliminaFatt("
                      + fatturatoAzienda.IdFatturato + ")' />";
            }
