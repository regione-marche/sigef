<%@ Page Title="" Language="C#" MasterPageFile="~/SigefAgidPrivate.master" AutoEventWireup="true" CodeBehind="Localizzazione.aspx.cs" Inherits="web.Private.PPagamento.Variante.Localizzazione" %>
...
<%@ Register Src="../../../CONTROLS/CardVarianti.ascx" TagName="CardVarianti" TagPrefix="uc4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="server">
    ...
    <uc4:CardVarianti ID="ucCardVarianti" runat="server" />
    <div class="row pt-5">
        <div class="col-sm-12">
            <div class="steppers">
                ...
                <div class="steppers-content" aria-live="polite">
                    <div class="row bd-form pt-5 mx-2">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="button" value="Nuovo" class="btn btn-secondary py-1"
                                onclick="pulisciCampi();" />

                        </div>
                        <div class="col-sm-12">
                            <Siar:DataGridAgid ID="dgLocalizzazioni" runat="server" AllowPaging="True"
                                PageSize="30" AutoGenerateColumns="False" CssClass="table table-striped">
                                <Columns>
