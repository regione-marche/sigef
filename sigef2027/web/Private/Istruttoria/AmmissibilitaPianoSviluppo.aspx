<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.Istruttoria.AmmissibilitaPianoSviluppo" CodeBehind="AmmissibilitaPianoSviluppo.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <Siar:SiarTab ID="TAB1" runat="server" Tabs="Valutazione finanziaria del piano di sviluppo"
        ...
        <table class="tableTab" id="Table2" style="width: 100%;" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <br />
                    ...
                    <div style="text-align: center;">
                        &nbsp;
                        <Siar:Button ID="btnSalva" runat="server" Text="Ammetti" Modifica="True" Width="130px"
                            OnClick="btnSalva_Click" />
                        &nbsp;&nbsp;&nbsp;<Siar:Button ID="btnBack" runat="server" OnClick="btnBack_Click"
                            Text="Indietro" Width="130px" Modifica="False" />
                        &nbsp;
                        <br />
                        &nbsp;
                    </div>
