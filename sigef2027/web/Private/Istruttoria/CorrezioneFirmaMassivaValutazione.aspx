<%@ Page Language="C#" MasterPageFile="~/SigefAgidPrivate.master" AutoEventWireup="true" CodeBehind="CorrezioneFirmaMassivaValutazione.aspx.cs" Inherits="web.Private.Istruttoria.CorrezioneFirmaMassivaValutazione" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    <script type="text/javascript">
        ...
        function LogResult(esito, esitoDetail) {
            ...
            var tipoDocumento = 'CorrezioneFirmaMassivaValutazione';
    ...
    <div class="row py-5">
        <h2 class="pb-5">Correzione firma massiva valutazione</h2>
        <p>
            L'elenco contiene tutte le valutazioni delle domande per cui è necessaria una correzione dell'operatore .<br />
            <br />
            <br />
        ...
        <div class="col-sm-12">
            <Siar:DataGridAgid CssClass="table table-striped" ID="dgFirmeValutazione" runat="server" AutoGenerateColumns="false" OnItemDataBound="dgFirmeValutazione_ItemDataBound">
                <Columns>
                    ...
                    <asp:BoundColumn DataField="Id" HeaderText="Partita iva/Codice fiscale">
                        <ItemStyle HorizontalAlign="center" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="Id" HeaderText="Ragione sociale"></asp:BoundColumn>
        ...
        <div id="header" runat="server" class="row">
            <div class="col-sm-12 text-center mb-5">
                <input type="button" id="btnSwitchRs" onclick="switchSign('r')" class="btn btn-success py-1" value="Utilizza Firma Digitale Remota" />
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div class="row">
                    <div class="col-sm-12 mb-5 text-center">
                        <input type="button" id="btnFirma2" class="btn btn-primary py-1" disabled="disabled" name="btnFirma2" value="Firma e invia al protocollo" style="width: 180px;" onclick="btnFirmaMassivaClick(); return false;" />
                    </div>
                    <div class="col-sm-12 mb-5 text-center">
                        <input type="button" id="btnAnnullaFirma" name="btnAnnullaFirma" class="btn btn-secondary py-1" value="Annulla" onclick="annullaFirmaDocumento();" style="width: 130px" />
                    </div>
    ...
    <div id="header_remota" runat="server" class="row" style="display: none;">
        <div class="col-sm-12 text-center mb-5">
            <input type="button" id="btnSwitchCs" onclick="switchSign('c')" class="btn btn-success py-1" value="Utilizza Firma Digitale Smartcard/Token USB" />
        </div>
        ...
        <div class="row bd-form" id="header_remota_dati" runat="server">
            ...
            <div class="col-sm-12 text-center">
                <Siar:Button ID="btnFirmaMassivaRemotaValutazione" runat="server" Text="Firma e invia al protocollo" OnClick="btnFirmaMassivaRemotaValutazione_Click" />                
                <input type="button" id="btnAnnullaFirmaRemota" name="btnAnnullaFirma" value="Annulla" onclick="annullaFirmaDocumento();" class="btn btn-secondary py-1" />
            </div>
        </div>
    </div>
</asp:Content>
