    ...
    public partial class DownloadMassivo : SiarLibrary.Web.PrivatePage
    {
        ...
        void dgGestioneLavori_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    e.Item.Cells[8].Text = "<input type=button class='btn btn-primary py-1' value='Richiedi lo scarico' onclick=\"richiediScarico('" + c.IdDomandaPagamento + "')\" />";
                }
                ...
                if (c.AdditionalAttributes["ESEGUITO"] != null && bool.TryParse(c.AdditionalAttributes["ESEGUITO"], out eseguito))
                {
                    ...
                    {
                        eseguitoTxt = "Si";
                        e.Item.Cells[12].Text = "<input type=button class='btn btn-primary py-1' value='Scarica' onclick=\"scaricaFile('" + c.AdditionalAttributes["ID_TICKET"] + "')\" />";
                    }
                    else
                        eseguitoTxt = "No";
                }
        ...
        void dgGestioneLavoriIntegrazioni_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    e.Item.Cells[5].Text = "<input type=button class='btn btn-primary py-1' value='Richiedi lo scarico' onclick=\"richiediScaricoIntegrazione('" + c.IdIntegrazioneDomandaDiPagamento + "')\" />";
                }
                else if (c.IdDomandaPagamento != null)
                ...
                if (c.Eseguito != null)
                {
                    ...
                    {
                        eseguitoTxt = "Si";
                        e.Item.Cells[9].Text = "<input type=button class='btn btn-primary py-1' value='Scarica' onclick=\"scaricaFileIntegrazione('" + c.IdTicket + "')\" />";
                    }
                    else
                        eseguitoTxt = "No";
                }
        ...
        void dgGestioneLavoriAiuti_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    e.Item.Cells[4].Text = "<input type=button class='btn btn-primary py-1' value='Richiedi lo scarico'  onclick=\"richiediScaricoAiuto('" + c.IdProgetto + "')\" />";
                }
                ...
                if (c.Eseguito != null)
                {
                    ...
                    {
                        eseguitoTxt = "Si";
                        e.Item.Cells[8].Text = "<input type=button class='btn btn-primary py-1' value='Scarica' onclick=\"btnScaricaFileAiuto('" + c.IdTicket + "')\" />";
                    }
                    else
                        eseguitoTxt = "No";
                }
