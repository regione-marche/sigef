...
{
    public partial class AmmissibilitaPianoSviluppo : SiarLibrary.Web.IstruttoriaPage
    {
        ...
        private void InitializePianiSviluppo()
        {
            ...
            decimal A1 = 0,
                    B1 = 0, B2 = 0, B3 = 0, C1 = 0, C2 = 0, D1 = 0, D2 = 0, TotFabb = 0,
                    TotCop = 0,
                    TotSaldoNetto = 0;
            int i = 1;
        ...
        private void SavePianiSviluppo()
        {
            ...
            for (int i = 1; i <= _anni; i++)
            {
                ...
                if (!string.IsNullOrEmpty(((SiarLibrary.Web.TextBox)(TAB1.FindControl("txtanno" + i))).Text))
                {
                    ...
                    piano_sviluppo.IdImpresa = ucInfoDomanda.Impresa.IdImpresa;
