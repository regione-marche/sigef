<%@ Page Language="C#" MasterPageFile="~/SigefAgidPrivate.master" AutoEventWireup="true" CodeBehind="FirmaMassivaValutazione.aspx.cs" Inherits="web.Private.Istruttoria.FirmaMassivaValutazione" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <div class="row py-5">
        <h2 class="pb-5">Firma massiva valutazione</h2>
        <p>
