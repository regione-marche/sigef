...
namespace web.Private.Fem
{
    public partial class ContrattiArtigiancassa : SiarLibrary.Web.PrivatePage
    {
        ...
        SiarLibrary.Progetto progettoArtigiancassa_selezionato = null;
        SiarBLL.ProgettoCollectionProvider prog_prov = new SiarBLL.ProgettoCollectionProvider();
        SiarLibrary.ContrattiFem contratto_selezionato = null;
        SiarLibrary.ContrattiFem giustificativo_selezionato = null;
        SiarBLL.ContrattiFemCollectionProvider contratto_prov = new SiarBLL.ContrattiFemCollectionProvider();
        SiarBLL.ContrattiFemPagamentiCollectionProvider contratto_pagamento_prov = new SiarBLL.ContrattiFemPagamentiCollectionProvider();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SiarLibrary.ProgettoSoggettoGestoreCollection prog_sogg = prog_sog_gest_prov.FindProgettiSoggettoGestore((int)SiarBLL.SoggettoGestoreCollectionProvider.EnumSoggettiGestore.Artigiancassa, null, null, null, null, null, null);
            if (prog_sogg.Count != 1)
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    SiarLibrary.ContrattiFemCollection contratti_fem = new SiarLibrary.ContrattiFemCollection();
                    ...
                    if (contratto_selezionato != null)
                    {
                        ...
                        SiarLibrary.ContrattiFemPagamentiCollection pagamenti_coll = contratto_pagamento_prov.Find(null, contratto_selezionato.IdContrattoFem, contratto_selezionato.IdProgetto, null, null);
                        decimal ImportoFemPagamentoInserito = 0;
                        foreach (SiarLibrary.ContrattiFemPagamenti fem_pag in pagamenti_coll)
                        {
                            ImportoFemPagamentoInserito += fem_pag.Importo;
                        ...
                        contratti_fem = new SiarBLL.ContrattiFemCollectionProvider().Find(progetto_selezionato.IdBando, progetto_selezionato.IdProgetto, null, null, false, (int)SiarBLL.SoggettoGestoreCollectionProvider.EnumSoggettiGestore.Artigiancassa, null);
                    decimal ImportoFemInserito = 0;
                    SiarLibrary.ContrattiFemCollection contratti_fem_totali = new SiarBLL.ContrattiFemCollectionProvider().Find(progetto_selezionato.IdBando, progetto_selezionato.IdProgetto, null, null, null, (int)SiarBLL.SoggettoGestoreCollectionProvider.EnumSoggettiGestore.Artigiancassa, null);
                    foreach (SiarLibrary.ContrattiFem fem in contratti_fem_totali)
                    {
                    ...
                    dgContrattiFem.ItemDataBound += new System.Web.UI.WebControls.DataGridItemEventHandler(dgContrattiFem_ItemDataBound);
            ...
            dgBando.ItemDataBound += new System.Web.UI.WebControls.DataGridItemEventHandler(dgBando_ItemDataBound);
            dgBando.DataBind();
            base.OnPreRender(e);
        }
