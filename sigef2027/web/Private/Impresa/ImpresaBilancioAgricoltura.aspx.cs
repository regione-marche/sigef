...
namespace web.Private.Impresa
{
    ...
    public partial class ImpresaBilancioAgricoltura : SiarLibrary.Web.ImpresaPage
    {
       ...
       SiarBLL.BilancioAgricoloCollectionProvider bilancio_Agricolo_provider = new SiarBLL.BilancioAgricoloCollectionProvider();
        ...
        {
            bil_Agricolo_col = bilancio_Agricolo_provider.Find(null, Azienda.IdImpresa, null, null, null, false);
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            switch (ucSiarNewTab.TabSelected)
            {
                case 1:
                    ...
                    Nuovo_bilancio();
                    bil_Agricolo_col.Sort("Anno DESC");
        ...
        private bool controlloBilancio()
        {
            ...
            {
                SiarLibrary.BilancioAgricolo b = bilancio_Agricolo_provider.GetById(hdnId.Value);
        ...
        protected void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    bil_Agricolo.IdImpresa = Azienda.IdImpresa;
