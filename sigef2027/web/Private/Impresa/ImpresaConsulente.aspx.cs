    ...
    public partial class ImpresaConsulente : SiarLibrary.Web.ImpresaPage
    {
            ...
            switch (ucSiarNewTab.TabSelected)
            {
                case 3:
                    ...
                    else
                    {
                        ...
                        dgAllegatiProcura.Titolo = "Elementi trovati: " + all_proc_coll.Count;
                    ...
                    dgRichiesteProcuraNonInviate.Titolo = "Elementi trovati: " + rich_coll_proc_no_inv.Count;
                    ...
                    dgRichiesteProcuraInviate.Titolo = "Elementi trovati: " + rich_coll_proc_inv.Count;
                    ...
                    dgMandatiProcura.Titolo = "Elementi trovati: " + mandati_utente_procura.Count;
                ...
                case 2:
                    ...
                    dgRichiesteInviate.Titolo = "Elementi trovati: " + rich_coll_inv.Count;
                    ...
                    null, null, "PSR", null);
                    dgMandati.Titolo = "Elementi trovati: " + mandati_utente.Count;
                ...
                default:
                    ...
                    dgRichiesteNonInviate.Titolo = "Elementi trovati: " + rich_coll_non_inv.Count;
                    ...
                    else
                    {
                        ...
                        dgAllegati.Titolo = "Elementi trovati: " + all_coll.Count;
        ...
        protected void ProtocollaDocFirmatoEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!chkProcuraSpeciale.Checked)
                {
                    p.setTrasmissioneUtente("", "", "TDI", "RESPONSABILE_PO", "ASSEGNAZIONE");
                }
