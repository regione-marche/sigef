...
{
    public partial class ImpresaBilancioIndustriale : SiarLibrary.Web.ImpresaPage
    {
        ...
        {
            bil_Industriale_col = bilancio_Industriale_provider.Find(null, Azienda.IdImpresa, null, null, null, false);
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            switch (ucSiarNewTab.TabSelected)
            {
                ...
                default:
                    ...
                    lblRisultato.Text = bil_Industriale_col.Count.ToString();
        ...
        {//verifico se il bilancio è stato specificato per altre domande 
            ...
            {
                SiarLibrary.BilancioIndustriale bil_Industriale = bil_Industriale_col.CollectionGetById(hdnId.Value);
                SiarLibrary.ProgettoStoricoCollection progetto_storico = new SiarLibrary.ProgettoStoricoCollection();
                SiarLibrary.ProgettoCollection progettiazienda = new SiarBLL.ProgettoCollectionProvider().Find(null, Azienda.IdImpresa, null, null, null, false, true);
                foreach (SiarLibrary.Progetto p in progettiazienda)
                {
                    ...
                    if (progetto_storico != null && progetto_storico.Count > 0 && progetto_storico[0].Data >= bil_Industriale.DataModifica)
                    {
                        result = false;
        ...
        private void VisualizzaBilancio(int IdBilancio)
        {
            ...
            if (string.IsNullOrEmpty(bil_Industriale.NotaIntegrativa)) txtNotaIntegrativa.Text = string.Empty;
            else txtNotaIntegrativa.Text = bil_Industriale.NotaIntegrativa.Value; 
            ...
            decimal TotAttivoCirc = valore(bil_Industriale.TaAcRimanenze) + AcDispoLiquide + AcCreditoVerso;
        ...
        private void Nuovo_bilancio()
        {
            ...
            txtNotaIntegrativa.Text = string.Empty;
        ...
        protected void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(txtNotaIntegrativa.Text)) throw new Exception("Inserire la nota integrativa al bilancio."); 
                
                #region Salvo Bilancio Industriale
                ...
                if (!string.IsNullOrEmpty(hdnId.Value))
                {
                    ...
                    foreach (SiarLibrary.BilancioIndustriale b in bil_Industriale_col)
                        if (b.Anno == anno && b.IdBilancioIndustriale != idBilancio) throw new Exception("Attenzione! Il bilancio, per l'anno indicato, è già stato inserito.");
                ...
                else
                {
                    ...
                    bil_Industriale.IdImpresa = Azienda.IdImpresa;
                ...
                bil_Industriale.NotaIntegrativa = txtNotaIntegrativa.Text;
                ...
                if (!string.IsNullOrEmpty(lblTotPrimaImposte.Text))
                    bil_Industriale.TotPrimaImposte = lblTotPrimaImposte.Text.Trim().Replace("€", string.Empty);
            ...
            {
                bilancio_Industriale_provider.DbProviderObj.Rollback(); ShowError(ex);
            }
        }
