    ...
    public partial class RicercaErrori : ErrorePage
    {
        ...
        void dgErrori_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (dgi.ItemType == ListItemType.Header)
            {
                ...
                dgi.Cells[col_IdAsse].Text = "BANDO</td><td colspan=2 align=center><b>DOMANDA AIUTO</b></td><td colspan=9 align=center><b>ERRORE</b></td><td></td></tr><tr class='TESTA'><td>Asse";
            }
