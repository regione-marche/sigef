...
namespace web.Private.Controlli
{
    public partial class ChecklistControlliLoco : SiarLibrary.Web.PrivatePage
    {
        ...
        int col_IdProgetto = 0,
            col_Beneficiario = 1,
            col_Asse = 2,
            col_ObiettivoSpecifico = 3,
            col_Azione = 4,
            col_Intervento = 5,
            col_NOperazioniBenef = 6,
            col_CostoInvestimentoRichiesto = 7,
            col_CostoInvestimentoAmmesso = 8,
            col_ContributoConcesso = 9,
            col_ImportoRendicontatoAmmessoTotale = 10,
            col_ContributoRendicontatoConcessoTotale = 11,
            col_ImportoRendicontantoAmmessoDelta = 12,
            col_ContributoRendicontatoConcessoDelta = 13,
            col_ImportoRendicontatoAmmessoRegolareTotale = 14,
            col_ContributoRendicontatoConcessoRegolareTotale = 15,
            col_ImportoRendicontatoAmmessoRegolareDelta = 16,
            col_ContributoRendicontatoConcessoRegolareDelta = 17,
            col_Selezionata = 18,
            col_Esclusione = 19,
            col_RischioIR = 20,
            col_RischioCR = 21,
            col_RischioComplessivo = 22,
            col_EsitoChecklist = 23;
        ...
        {
            lstPsr.DataBind();
            txtOperatoreCompilatore.Attributes.Add("onkeydown", "tb_corrente='Compilatore';SNCVolatileZoom(this,event,'SNCVZCercaUtenti');");
            txtOperatoreValidatore.Attributes.Add("onkeydown", "tb_corrente='Validatore';SNCVolatileZoom(this,event,'SNCVZCercaUtenti');");
        ...
        protected void btnFirmaProtocolloPost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    string oggetto = "Checklist delle verifiche in loco " + domanda_pagamento.Descrizione.Value.ToUpper()
