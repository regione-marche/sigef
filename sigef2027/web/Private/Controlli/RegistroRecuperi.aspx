...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="server">
    ...
    <div class="row">
        <div class="row" id="tdDomanda" runat="server"></div>
        <h3 class="mt-5 pb-5">Ritiri e recuperi</h3>
        <div class="col-sm-12">
            <Siar:DataGridAgid CssClass="table table-striped" ID="dgRegistroRecuperi" runat="server" AutoGenerateColumns="false">
                <Columns>
    ...
    <div id="divTab" class="row" runat="server">
        ...
        <div id="divInformazioniGenerali" class="row bd-form pt-5" runat="server" visible="false">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6 form-group">
                <Siar:TextBox  ID="txtSegnaturaVerbale" runat="server" Label="Segnatura verbale" ReadOnly="True" />
            ...
            <div class="col-sm-6 form-group">
                <Siar:DateTextBox Label="Data di avvio recupero:" ID="txtDataAvvio" runat="server" />
            </div>
            <div class="col-sm-6 form-group">
                <Siar:DateTextBox Label="Probabile data di conclusione:" ID="txtDataProbabileConclusione" runat="server" />
            </div>
            <div class="col-sm-12 form-group">
                <Siar:TextBox  Label="Soggetto che ha revocato il finanziamento:" ID="txtSoggettoRevocaFinanziamento" runat="server" />
            </div>
            <div class="col-sm-6 form-group">
                <Siar:ComboBase Label="Tipo:" ID="lstTipoRecupero" runat="server" NomeCampo="TipoRecupero">
                </Siar:ComboBase>
                <script type="text/javascript">
                    $(function () {
            ...
            <div class="col-sm-6 form-group">
                <Siar:DateTextBox Label="Data certificazione recupero:" ID="txtDataCertificazioneRecupero" runat="server" Enabled="false" />
            </div>
            <div id="divRegistrazioneRitiro" runat="server">
                <div class="col-sm-6 form-group">
                    <Siar:DateTextBox Label="Data registrazione ritiro:" ID="txtDataRegistrazioneRitiro" runat="server" Width="120px" />
                </div>
                <div class="col-sm-6 form-group">
                    <Siar:DateTextBox Label="Data certificazione ritiro:" ID="txtDataCertificazioneRitiro" runat="server" Width="120px" Enabled="false" />
                </div>
            </div>
            <div class="col-sm-4 form-check">
                <asp:CheckBox ID="chkRecuperabile" Text="Recuperabile:" runat="server" Checked="true" />
            </div>
            <div class="col-sm-4 form-group">
                <Siar:DateTextBox Label="Data certificazione non recuperabilità:" ID="txtDataCertificazioneNonRecuperabilita" runat="server" Enabled="false" />
            </div>
            <div class="col-sm-4 form-group">
                <Siar:DateTextBox Label="Data conclusione:" ID="txtDataConclusione" runat="server" />
            </div>
            <div class="col-sm-12 form-group">                
                <Siar:ComboBase Label="Origine:" ID="lstOrigineRecupero" runat="server" NomeCampo="OrigineRecupero">
                        </Siar:ComboBase>
            ...
            <div id="divDettaglioIrregolarita" class="row">
                <h3 class="mt-5 pb-5">Dettaglio registro irregolarità:</h3>
                            ...
                            <div id="divDgIrregolarita" class="dContenuto" runat="server">
                                <Siar:DataGridAgid ID="dgIrregolarita" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" PageSize="20">
                                    <Columns>
                                        ...
                                        <Siar:CheckColumnAgid DataField="SegnalazioneOlaf" HeaderText="Segnalazione Olaf" ReadOnly="true">
                                        </Siar:CheckColumnAgid>
                                        <Siar:JsButtonColumnAgid Arguments="IdIrregolarita" ButtonType="TextButton" ButtonText="Escludi"
        ...
        <div id="divImpattoFinanziario" class="row" runat="server" visible="false">
            <div class="mrw-table">
                <div class="mrw-tr">
        ...
        <div id="divAttiAssociati" class="row" runat="server" visible="false">
        ...
        <div id="divSanzioni" class="row" runat="server" visible="false">
            <div class="mrw-table">
                <div class="mrw-tr">
                    <div class="mrw-width-100">
        ...
        <div id="divStorico" class="row" runat="server" visible="false">
            <div class="mrw-table">
                <div class="mrw-tr">
                    <div class="mrw-width-100">
        ...
        <div id="divButton" class="row" class="mrw-table">
            <div class="mrw-tr">
