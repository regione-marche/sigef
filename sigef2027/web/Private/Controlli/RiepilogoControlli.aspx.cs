...
{
    public partial class RiepilogoControlli : SiarLibrary.Web.ControlliLocoPage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            if (!IsPostBack)
            {
                lstAnno.SelectedValue = DateTime.Now.Year.ToString();
            }
            lstAnno.DataBind();
        ...
        {
            decimal lotti_creati = 0,
                    lotti_campionati = 0,
                    lotti_conclusi = 0,
                    totale_domande = 0,
                    totale_domande_lotti = 0,
                    totale_domande_controllate = 0,
                    contributo_richiesto_totale = 0,
                    contributo_richiesto_totale_lotti = 0,
                    contributo_richiesto_controllato = 0,
                    contributo_ammesso_totale = 0,
                    contributo_ammesso_totale_lotti = 0,
                    contributo_ammesso_controllato = 0,
                    contributo_pagato_totale = 0,
                    contributo_pagato_totale_lotti = 0,
                    contributo_pagato_controllato = 0,
                    contributo_pagato_anno_totale = 0,
                    contributo_pagato_anno_totale_lotti = 0,
                    contributo_pagato_anno_controllato = 0;
            try
            {
                SiarLibrary.DbProvider db = new SiarLibrary.DbProvider();
                IDbCommand cmd = db.GetCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SpPsrRiepilogoControlliLoco";
