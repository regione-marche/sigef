<%@ Page Language="C#" MasterPageFile="~/SigefAgidPrivate.master" AutoEventWireup="true"
    Inherits="web.Private.Controlli.LottidiControllo" CodeBehind="LottidiControllo.aspx.cs" %>

<%@ Register Src="~/CONTROLS/SiarNewTab.ascx" TagName="SiarNewTab" TagPrefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    <script type="text/javascript"><!--
    function chkClick(id, elem) {
        if (elem.checked) {
            $('[id$=hdnIdLotto]').val(id);
        } else {
            $('[id$=hdnIdLotto]').val('');
        }
        $('[id$=btnPost]').click();
    }
    function mostraParametriXDomanda(idDomandaPagamento) {
        $('[id$=hdnIdDomandaPagamento]').val(idDomandaPagamento);
        $('[id$=btnCaricaParametriDomanda]').click();
    }
    function chiudi() {
        $('[id$=hdnIdDomandaPagamento]').val('');
        $('[id$=lblParametriDomandaMessaggio]').text('');
        chiudiPopupTemplate();
    }
//--></script>
    <br />
    <table class="tableNoTab" width="900">
            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <table width="100%" style="border-left: solid 1px black; border-bottom: solid 1px black; padding-bottom: 10px">
                                <tr>
                                    <td class="separatore">
                                        Opzioni:
                                    </td>
        ...
        <tr>
            <td style="padding-bottom: 10px; padding-top: 10px">
                <Siar:DataGridAgid ID="dgLotti"  runat="server" AllowPaging="true" AutoGenerateColumns="False" CssClass="table table-striped" PageSize="10">
    ...
    <table width="1050px" class="tableTab" id="tableDomande" runat="server">
        ...
        <tr>
            <td style="height: 60px" align="center">
                ...
                <Siar:Button ID="btnEliminaLotto" runat="server" CausesValidation="False" Modifica="True"
                             OnClick="btnEliminaLotto_Click" Text="Elimina lotto" Width="147px" 
                             Conferma="Attenzione! Eliminare il lotto?" />
            </td>
        </tr>
        <tr>
            <td class="separatore">
        ...
        <tr>
            <td>
                &nbsp;<Siar:DataGrid ID="dgDomande" runat="server" AutoGenerateColumns="False" PageSize="20"
                    Width="100%">
                ...
                <div style="display: none">
                    <Siar:Hidden ID="hdnIdDomandaPagamento" runat="server"></Siar:Hidden>
                    <Siar:Button ID="btnCaricaParametriDomanda" runat="server" CausesValidation="false"
                                 OnClick="btnCaricaParametriDomanda_Click" />
                </div>
            </td>
        </tr>
        <tr>
            <td align="right">
                ...
                &nbsp; &nbsp;
                <br />
                <span style="color: #bc3333"><strong>R</strong></span> 
                = estrazione con calcolo dei valori di <strong>rischio<br />&nbsp;</strong>
            </td>
        </tr>
    </table>
    <table width="900px" class="tableTab" id="tableParametri" runat="server">
            ...
            <td>
                <Siar:DataGrid ID="dgParametri" runat="server" AutoGenerateColumns="False" Width="100%">
                    <Columns>
                        ...
                        <Siar:IntegerColumn DataField="IdParametro" Valore="Peso" Name="txtPesoBox" HeaderText="Peso" ReadOnly="true">
                            <ItemStyle Width="120px" HorizontalAlign="center" />
                        </Siar:IntegerColumn>
                        <Siar:IntegerColumn DataField="IdParametro" Valore="PesoReale" Name="txtPesoRealeBox"
                                            HeaderText="Peso normalizzato" ReadOnly="true">
                            <ItemStyle Width="120px" HorizontalAlign="center" />
                        </Siar:IntegerColumn>
                        <Siar:CheckColumn Name="chkParametro" DataField="IdParametro" HeaderSelectAll="true">
        ...
        <tr>
            <td style="height: 39px" align="right">
                <Siar:Button ID="btnSalvaParametri" runat="server" CausesValidation="False" Modifica="True" OnClick="btnSalvaParametri_Click" 
                             Text="Salva i valori" Width="189px" 
                             Conferma="Attenzione! Questa operazione cancellerà i valori di rischio già calcolati su tutte le domande del lotto. Continuare?" />
                &nbsp; &nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <div id='divParametriDomanda' style="width: 573px; position: absolute; display: none;">
        <table width="100%" class="tableNoTab">
            ...
            <tr>
                <td>
                    <br />
                    <Siar:DataGrid ID="dgParametriDomanda" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <Siar:IntegerColumn Name="txtPunteggioParametroDomanda" DataField="IdParametro" Valore="Punteggio"
            ...
            <tr>
                <td align="right" style="height: 50px">
                    <Siar:Button ID="btnCalcolaPunteggioDomanda" runat="server" CausesValidation="False"
                                 Modifica="True" OnClick="btnCalcolaPunteggioDomanda_Click" Text="Calcola" Width="140px" />
                    <input class="Button" style="width: 105px; margin-left: 20px; margin-right: 20px"
                           type="button" value="Chiudi" onclick="chiudi()" />
                </td>
            </tr>
        </table>
    </div>
