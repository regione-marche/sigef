                ...
                try
                {
                    ...
                    if (p.CodStato != "P" && Operatore.Utente.CodTipoEnte.FindValueIn("RM", "%", "AdC"))
                    {
                        if (allegatiProtocollatiOk)
                        {
                            ...
                            btnRiepilogoBando.Attributes.Add("class", "btn btn-primary py-1 mx-1");
                            ...
                            btnIstruttoriaBando.Attributes.Add("class", "btn btn-primary py-1 mx-1");
                            ...
                            btnIstruttoriaDomandePagamento.Attributes.Add("class", "btn btn-primary py-1 mx-1");
                        ...
                        Operatore.Utente.Profilo == "Membro del comitato di valutazione"))
                    {
                        ...
                        btnIValutazioneProgetto.Attributes.Add("class", "btn btn-primary py-1");
                    ...
                    if (((p.CodStato == "L") || (p.CodStato == "I")) && !allegatiProtocollatiOk)
                    {
                        ...
                        btnProtocollaAllegati.Attributes.Add("class", "btn btn-primary py-1");
