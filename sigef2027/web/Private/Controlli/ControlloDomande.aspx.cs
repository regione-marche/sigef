...
{
    public partial class ControlloDomande : SiarLibrary.Web.ControlliLocoPage
    {
        ...
        SiarLibrary.ControlliDomandePagamento cdomanda;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (int.TryParse(Request.QueryString["idlotto"], out id_lotto))
                    cdomanda = cdomande_provider.GetById(id_lotto, id_domanda_pagamento);
                ...
                AbilitaModifica = !cdomanda.ControlloConcluso && Operatore.Utente.CfUtente == cdomanda.OperatoreAssegnato;
            }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                SiarLibrary.UtentiCollection operatori = utenti_provider.Find(cdomanda.OperatoreAssegnato, null, null, null, null, null, null);
                if (operatori.Count > 0) txtOperatore.Text = operatori[0].Nominativo;
            }
            base.OnPreRender(e);
        }
        ...
        protected void btnChiudiVisita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cdomanda.Operatore = Operatore.Utente.CfUtente;
                ...
                if (cdomande_provider.Find(cdomanda.IdLotto, null, null).FiltroControlli(true, false).Count == 0)
                {
                    ...
                    SiarLibrary.ControlliLocoLotto lotto = lotto_provider.GetById(cdomanda.IdLotto);
