...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <div id="divElenco" runat="server">
        ...
        <tr>
            <td>
                <Siar:DataGridAgid ID="dgRecuperi" runat="server" AutoGenerateColumns="false" Width="100%">
                    <Columns>
    ...
    <div id="divDettaglio" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox CssClass="rounded" ID="txtIdRecupero" runat="server" width="150px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <table id="tblIdAtto" >
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="rounded" ID="txtIdAttoNr" runat="server" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox CssClass="rounded" ID="txtIdAttoDt" runat="server" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox CssClass="rounded" ID="txtIdAttoRe" runat="server" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
