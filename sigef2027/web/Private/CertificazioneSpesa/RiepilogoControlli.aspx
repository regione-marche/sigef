<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SigefAgidPrivate.master" CodeBehind="RiepilogoControlli.aspx.cs" 
Inherits="web.Private.CertificazioneSpesa.RiepilogoControlli" %>
            ...
            <td>
                <table id="tbRiepilogoLotti" runat="server" cellspacing="0" style="width: 100%; border-collapse: collapse"
                    ...
                    <tr class="DataGridRow">
                        <td style="width: 150px; font-size: 12px; font-weight: bold; height: 26px;">
                            &nbsp;Lotti di controllo
                        </td>
                        <td style="width: 150px; text-align: right; font-weight: bold; height: 26px;">
                        </td>
                        <td style="width: 150px; text-align: right; font-weight: bold; height: 26px;">
                        </td>
                        <td style="width: 150px; text-align: right; font-weight: bold; height: 26px;">
                        </td>
                        <td style="text-align: right; font-weight: bold; height: 26px; width: 135px;">
                        </td>
                ...
                <table id="tbRiepilogoContributo" runat="server" cellspacing="0" style="width: 100%;
                    ...
                    <tr class="TESTA1">
                        ...
                        <td>
                            &nbsp;Controllato /<br />
                            &nbsp;Contributo nei lotti (%)
                        </td>
                    </tr>
                    <tr class="DataGridRow">
                        <td class="coda" style="width: 150px; font-size: 12px; font-weight: bold; height: 26px;">
                    ...
                    <tr class="DataGridRow">
                        <td class="coda" style="width: 150px; font-size: 12px; height: 26px; padding-left: 10px">
                            &nbsp; - di cui durante l'anno
                        </td>
                        <td style="width: 150px; text-align: right; font-weight: bold; height: 26px;">
                            &nbsp;
                        </td>
