...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="server">
    ...
    <script type="text/javascript">
        ...
        function createUrlRendicontazione(id, filiera, cod_stato) {
            ...
            else if (filiera) aler30t('Attenzione! La sezione rendicontazione non è abilitata per le Manifestazioni di Interesse di Filiera.');
   ...
   <div class="container-fluid shadow bd-form rounded-3 py-4">
        <h2 class="py-1 align-items-center">Certificazione di rendicontazione</h2>

        <div class="row pt-5 bg-100 rounded-3">
   ...
   <div id="divDettaglio" class="row mx-0 rounded-3 bd-form mt-4" visible="false" runat="server">    
    <uc2:SiarNewTab ID="tabDettaglio" runat="server" TabNames="Elenco|Dati riassuntivi" Titolo="Certificazione di rendicontazione" />
        <div id="divDettaglioElenco" class="tableTab pt-5" runat="server" visible="false">
          <%-- <div class="d-flex justify-content-between mb-3">--%>
            ...
            <div class="d-flex justify-content-between align-items-end p-2">
                  <div class="p-1">
                       <asp:Label ID="lblNrRecord" class="active fw-semibold " runat="server" Text="" Font-Size="Smaller"></asp:Label>
                   </div>
                   <div class="p-2">
                       <input type="button" class="btn btn-primary" value="Estrai in xls" onclick="return estraiInXls();" />
                   </div>
            ...
            <div class="row mx-0 p-2">
                <div class="col-md-12 ">
                    <div class="table-responsive">                        
                        <Siar:DataGridAgid ID="dgDettaglio" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" AllowPaging="true" PageSize="25">
