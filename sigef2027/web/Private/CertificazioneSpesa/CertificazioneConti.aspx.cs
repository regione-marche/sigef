...
namespace web.Private.CertificazioneSpesa
{
    public partial class CertificazioneConti : SiarLibrary.Web.PrivatePage
    {
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice1.UniqueID)
                        {
                            ...
                            var appendice1_list = conti_provider.GrigliaAppendice1Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice2.UniqueID)
                        {
                            ...
                            var appendice2_list = conti_provider.GrigliaAppendice2Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice2.UniqueID)
                        {
                            ...
                            var dAppendice2_list = conti_provider.GrigliaAppendice2ContiDettaglio(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice3.UniqueID)
                        {
                            ...
                            var appendice3_list = conti_provider.GrigliaAppendice3Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice3.UniqueID)
                        {
                            ...
                            var dAppendice3_list = conti_provider.GrigliaAppendice3ContiDettaglio(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice4.UniqueID)
                        {
                            ...
                            var appendice4_list = conti_provider.GrigliaAppendice4Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice4.UniqueID)
                        {
                            ...
                            var dAppendice4_list = conti_provider.GrigliaAppendice4ContiDettaglio(contiSel.AnnoContabileA, contiSel.CodPsr);
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        if (CtrlID == btnAggiornaAppendice5.UniqueID)
                        {
                            ...
                            var appendice5_list = conti_provider.GrigliaAppendice5Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
        ...
        //        dgi.Cells[0].Text = "Priorità (Assi)</th><th colspan='3'style='text-align:center;'>IMPORTI IRRECUPERABILI</th></th><tr class='TESTA1'>";
        //    }
        //}
            ...
            if (contiSel != null)
            {
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        ...
                        {
                            var appendice6_list = conti_provider.GrigliaAppendice6Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
        ...
        private void dgAppendice6_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                dgi.Cells[0].RowSpan = 2;
                //dgi.Cells[1].ColumnSpan = 1;
                dgi.Cells[0].Text = "Priorità (Assi)</th><th colspan='2' style='text-align:center;'>Importi dei contributi per programma erogati agli strumenti finanziari e inclusi nelle domande di pagamento</th><th colspan='2' >Importi erogati a titolo di spesa ammissibile ai sensi dell'articolo 42, paragrafo 1, lettere a), b) e d), del regolamento (UE) n. 1303/2013</th></th><tr class='TESTA1' style='text-align:center;'>";
            }
        }
            ...
            if (contiSel != null)
            {
                ...
                if (IsPostBack)
                {
                    ...
                    if (CtrlID != null && CtrlID != string.Empty)
                    {
                        ...
                        {
                            var appendice7_list = conti_provider.GrigliaAppendice7Conti(contiSel.AnnoContabileA, contiSel.CodPsr);
        ...
        void dgAppendice8_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                dgi.Cells[0].RowSpan = 2;
                //dgi.Cells[1].ColumnSpan = 1;
                dgi.Cells[0].Text = "Priorità (Assi)</th><th colspan='2' style='text-align:center;'>Spesa totale ammissibile inclusa nelle domande di pagamento presentate alla Commissione</th><th colspan='2' style='text-align:center;'>Spesa dichiarata conformemente all'articolo 137, paragrafo 1, lettera a), del regolamento (UE) n. 1303/2013</th><th colspan='2' style='text-align:center;'>Differenza</th><th>&nbsp;</th><th>&nbsp;</th><th colspan='2' class='nascondi' style='text-align:center;'>Differenza AdA</th></tr><tr class='TESTA1' style='text-align:center;'>";
            }
        ...
        void dgDettaglioAppendice2_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                dgi.Cells[0].RowSpan = 2;
                //dgi.Cells[1].ColumnSpan = 1;
                dgi.Cells[0].Text = "</th><th colspan='2' style='text-align:center;'>RITIRI</th><th colspan='2' style='text-align:center;'>RECUPERI</th></th><tr class='TESTA' style='text-align:center;' >";
            }
        }
        ...
        void dgAppendice2_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                dgi.Cells[0].RowSpan = 2;
                //dgi.Cells[1].ColumnSpan = 1;
                dgi.Cells[0].Text = "Priorità (Assi)</th><th colspan='2' style='text-align:center;'>RITIRI</th><th colspan='2' style='text-align:center;'>RECUPERI</th></th><tr class='TESTA1' style='text-align:center;'>";
            }
        }
        ...
        private void dgAppendice4_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                dgi.Cells[0].RowSpan = 2;
                //dgi.Cells[1].ColumnSpan = 1;
                dgi.Cells[0].Text = "Priorità (Assi)</th><th colspan='2' style='text-align:center;'>RECUPERI</th><tr class='TESTA1'>";
            }
        }

        void dgAppendice5_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            DataGridItem dgi = (DataGridItem)e.Item;
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                e.Item.Cells[0].Text = "Priorità (Assi)</th><th colspan='2' style='text-align:center;'>IMPORTI IRRECUPERABILI</th><tr class='TESTA1' style='text-align:center;'>";
            }
        }
        ...
        private void LoadDecertificazioni()
        {
            if (contiSel != null)
            {
                ...
                var decertificazioneCollection = certDecertificazioneCollectionProvider.GetDecertificazioniPerCertificazioneConti(contiSel.IdCertificazioneConti, contiSel.FlagDefinitivo, contiSel.CodPsr);
        ...
        protected void btnNuovaCertificazione_Click(object sender, EventArgs e)
        {
            ...
            CreateNewInstance(annoDa, annoA, codPsr);
        }

        private void CreateNewInstance(string annoDa, string annoA, string codPsr)
        {
            try
            {
                ...
                var assi = progProv.Find(null, codPsr + "L1", codPsr, null, null, 0);
