...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <div id="divElenco" runat="server">
        ...
        <tr>
            <td>
                <Siar:DataGridAgid ID="dgDomande" runat="server" AutoGenerateColumns="false" Width="100%">
                    <Columns>
    ...
    <div id="divDettaglio" runat="server">
        ...
        <tr>
            ...
            <td valign="top">
                <asp:TextBox CssClass="rounded" ID="txtIdDomanda" runat="server" width="150px" Enabled="false">
                </asp:TextBox>
            </td>
        </tr>
        <%--
