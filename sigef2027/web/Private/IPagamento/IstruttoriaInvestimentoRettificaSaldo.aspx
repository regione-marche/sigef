<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.IPagamento.IstruttoriaInvestimentoRettificaSaldo" CodeBehind="IstruttoriaInvestimentoRettificaSaldo.aspx.cs" %>

<%@ Register Src="../../CONTROLS/IDomandaPagamento.ascx" TagName="IDomandaPagamento" TagPrefix="uc2" %>
<%@ Register Src="../../CONTROLS/ucPagamentoInvestimentoRet.ascx" TagName="ucPagamentoInvestimentoRet" TagPrefix="uc3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <script type="text/javascript"><!--
        ...
        function eliminaPagamentoBen(id) { if (confirm('Attenzione! Eliminare il pagamento selezionato?')) { $('[id$=hdnIdPagamentoBeneficiarioDel]').val(id); $('[id$=btnEliminaPag]').click(); } }        
...
//--></script>
        ...
        <tr>
            <td align="center" style="height: 50px">
                ...
                <input id="btnBack" runat="server" class="Button" style="width: 130px" type="button"
                    onclick="location ='IstruttoriaPianoInvestimentiRettificaSaldo.aspx'" value="Indietro" /><br />
                &nbsp;
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td>
                ...
                <div style="display: none">
                     <Siar:Hidden ID="hdnIdPagamentoBeneficiarioDel" runat="server">
                    </Siar:Hidden>
                    <Siar:Button ID="btnEliminaPag" runat="server" CausesValidation="False" OnClick="btnEliminaPag_Click" />
                </div>
            </td>
        </tr>
    </table>
    <table class="tableNoTab" style="width: 1100px">
        <tr class="TESTA1">
            <td>
                 Elenco giustificativi associati nelle domande di pagamento precedenti (<asp:Label ID="lblNumeroPagamentiPrec" runat="server"></asp:Label>)<br />
        ...
        <tr>
            <td style="padding-left:20px;">
                <br />
                Numero <br />
                <Siar:TextBox  ID="txtNumeroGiu" runat="server" Width="104px" />
                &nbsp; &nbsp; &nbsp; 
                <Siar:Button ID="btnFiltra" runat="server" OnClick="btnFiltra_Click" Text="Filtra"  Width="80px" />
            </td>
        </tr>
        <tr>
            <td>
                <br />
                <Siar:DataGrid ID="dgPagamentiPrecedenti" runat="server" AutoGenerateColumns="False" Width="100%"
                    NrColumnSearch="true"  ShowFooter="true">
                    <ItemStyle Height="40px" />
                    <FooterStyle CssClass="coda" HorizontalAlign="Right" />
                    <Columns>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td style="width: 130px">
                                            <br />
                                            Importo &euro;:<br />
                                            <Siar:CurrencyBox ID="txtIPImportoAmmesso" runat="server" Width="100px" 
                        ...
                        -                   value="Calcola" onclick="btnCalcolaContributoAmmesso_Click();" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 130px">
                                            <br />
                                            Contributo %:<br />
                                            <Siar:QuotaBox NrDecimali="12" ID="txtIPContributoQuota" runat="server" Width="50px"  />
                                        </td>
                                        <td style="width: 130px">
                                            <br />
    ...
    <uc3:ucPagamentoInvestimentoRet ID="modalePagamento" runat="server" />
    </div>
</asp:Content>
