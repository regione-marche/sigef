<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    CodeBehind="IstruttoriaPianoSviluppo.aspx.cs" Inherits="web.Private.IPagamento.IstruttoriaPianoSviluppo" %>
        ...
        <tr>
            <td>
                ...
                <div style="text-align: center;">
                    <br />
                    &nbsp; &nbsp;&nbsp;
                    <Siar:Button ID="btnSalva" runat="server" Text="Salva" Modifica="True" Width="130px"
                        OnClick="btnSalva_Click" OnClientClick="return annoinseriti(event)" />
                    &nbsp;&nbsp;
                    <input id="btnBack" runat="server" class="Button" style="width: 160px" type="button"
                        onclick="javascript:location='CheckListPagamento.aspx'" value="Indietro" /><br />
                    <br />
                </div>
            </td>
        </tr>
