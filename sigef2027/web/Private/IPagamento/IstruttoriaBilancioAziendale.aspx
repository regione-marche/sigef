<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.IPagamento.IstruttoriaBilancioAziendale" CodeBehind="IstruttoriaBilancioAziendale.aspx.cs" %>
    ...
    <table id="tbBilancio" width="991px" class="tableTab" runat="server" visible="false">
        ...
        <tr>
            <td colspan="2" align="right">
                <input class="Button" visible="false" onclick="javascript:nuovo()" type="button"
                    value="Nuovo" style="width: 180px; display: none" />&nbsp;
                ...
                <Siar:Button ID="btnElimina" Text="Elimina" runat="server" CausesValidation="false"
                    Width="180px" Modifica="true" OnClick="btnElimina_Click" Visible="false" />&nbsp;&nbsp;
                &nbsp;
            </td>
        </tr>
        <tr>
