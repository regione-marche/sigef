...
{
    public partial class ValidazioneDomandePagamento : SiarLibrary.Web.PrivatePage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            SiarLibrary.BandoValidatoriCollection operatori = validatori_provider.GetValidatoriRup(Operatore.Utente.IdUtente, null);
            ...
            if (isValidatore && !isRup)
            {
                domande = new SiarBLL.RevisioneDomandaPagamentoCollectionProvider().GetRevisioneDomandeValidatore(Operatore.Utente.CfUtente, null, idProg, idDom);
                if (Operatore.Utente.Profilo == "Amministratore" && (idProg != null || idDom != null))
                    domande = new SiarBLL.RevisioneDomandaPagamentoCollectionProvider().GetRevisioneDomandeGenerico(idProg, idDom);
            }
            else if (isRup && !isValidatore)
                domande = new SiarBLL.RevisioneDomandaPagamentoCollectionProvider().GetRevisioneDomandeRup(Operatore.Utente.IdUtente, null, idProg, idDom);
            else if (isRup && isValidatore)
            {
                domande = new SiarBLL.RevisioneDomandaPagamentoCollectionProvider().GetRevisioneDomandeValidatore(Operatore.Utente.CfUtente, null, idProg, idDom);
                SiarLibrary.RevisioneDomandaPagamentoCollection domandeRup = new SiarBLL.RevisioneDomandaPagamentoCollectionProvider().GetRevisioneDomandeRup(Operatore.Utente.IdUtente, null, idProg, idDom);
            ...
            if (!string.IsNullOrEmpty(lstBandiRupValidatore.SelectedValue))
            {
                ...
                SiarLibrary.DomandaDiPagamentoCollection domandeDaValidare = new SiarBLL.DomandaDiPagamentoCollectionProvider().GetDomandePerRevisione(Operatore.Utente.IdUtente, lstBandiRupValidatore.SelectedValue);
            ...
            else
            {
                ...
                SiarLibrary.DomandaDiPagamentoCollection domandeDaValidare = new SiarBLL.DomandaDiPagamentoCollectionProvider().GetDomandePerRevisione(Operatore.Utente.IdUtente, null);
                dgDomandeDaAssegnare.DataSource = domandeDaValidare;
                dgDomandeDaAssegnare.ItemDataBound += new System.Web.UI.WebControls.DataGridItemEventHandler(dgDomandeDaAssegnare_ItemDataBound);
                dgDomandeDaAssegnare.SetTitoloNrElementi();
                dgDomandeDaAssegnare.DataBind();
