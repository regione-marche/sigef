    ...
    public partial class IstruttoriaInvestimento : SiarLibrary.Web.IstruttoriaPagamentoPage
    {
        ...
        void dgPagamenti_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                dgi.Cells[1].Text += "GIUSTIFICATIVO</th><th colspan=3 align=center>PAGAMENTO RICHIESTO</th><th align=center colspan=2>PAGAMENTO AMMESSO</th><th></th></tr><tr class=TESTA><th>Riferimenti";
            }
            else if (e.Item.ItemType != ListItemType.Footer)
            {
                ...
                else
                {
                    ...
                    dgi.Cells[2].Text = "<svg class='icon pointer icon-breadcrumb icon-secondary me-1' alt='Visualizza documento' title='Visualizza documento'"
                ...
                string url_modifica = "$('[id$=hdnIdPagamentoBeneficiario]').val(" + pag.IdPagamentoBeneficiario
                    + ");$('[id$=btnPost]').click();";
                dgi.Cells[9].Text = "<input type='button' class='btn btn-secondary py-1' onclick=\"" + url_modifica + "\" value='"
