...
namespace web.Private.IPagamento
{
    public partial class IstruttoriaAllegati : SiarLibrary.Web.IstruttoriaPagamentoPage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                btnBack.Attributes["onclick"] = "javascript:location='Revisionedomande.aspx?&idpag="
+ DomandaPagamento.IdDomandaPagamento + "'";
                btnBackDown.Attributes["onclick"] = "javascript:location='Revisionedomande.aspx?&idpag="
+ DomandaPagamento.IdDomandaPagamento + "'";
            }
