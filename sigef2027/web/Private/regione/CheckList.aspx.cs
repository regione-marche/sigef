    ...
    public partial class CheckList : SiarLibrary.Web.PrivatePage
    {
            ...
            switch (ucSiarNewTab.TabSelected)
            {
                case 2:
                    ...
                    else
                    {
                        ...
                        ((SiarLibrary.Web.CheckColumnAgid)dgStep.Columns[6]).SetSelected(al_obbligatori);
                        ((SiarLibrary.Web.CheckColumnAgid)dgStep.Columns[7]).SetSelected(al_verbale);
                        ((SiarLibrary.Web.CheckColumnAgid)dgStep.Columns[9]).SetSelected(al_selezionati);
        ...
        protected void btnSalva_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                string[] step_obbligatori = ((SiarLibrary.Web.CheckColumnAgid)dgStep.Columns[6]).GetSelected();
                string[] step_verbale = ((SiarLibrary.Web.CheckColumnAgid)dgStep.Columns[7]).GetSelected();
                string[] step_selezionati = ((SiarLibrary.Web.CheckColumnAgid)dgStep.Columns[9]).GetSelected();
