    ...
    public partial class SchedaValutazione : SiarLibrary.Web.PrivatePage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            if (ucSiarNewTab.TabSelected == 2)
            {
                ...
                ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[7]).SetSelected(val_massimo);
                ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[8]).SetSelected(visibili);
                ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[10]).SetSelected(selezionate);
                ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[12]).SetSelected(val_massimo_speciale);
        ...
        void dgPriorita_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                e.Item.Cells[11].Text = "PRIORITA SPECIALE</th></tr><tr class='TESTA'><th>Priorita Selezionata (*)";
            }
        ...
        protected void btnSalva_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string[] priorita_selezionate = ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[10]).GetSelected();
                string[] priorita_visibili = ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[8]).GetSelected();
                string[] priorita_valore_massimo = ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[7]).GetSelected();
                string[] priorita_speciale_valore_massimo = ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[12]).GetSelected();
