...
{
    public partial class ImpresaBilancioIndustriale : SiarLibrary.Web.ProgettoPage
    {
        ...
        {
            bil_Industriale_col = bilancio_Industriale_provider.Find(null, Progetto.IdImpresa, null, null, null, false);
        ...
        private DateTime VisualizzaBilancio(int IdBilancio)
        {
            ...
            return bil_Industriale.DataModifica;
        }
        ...
        protected void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    bil_Industriale.IdImpresa = Progetto.IdImpresa;
