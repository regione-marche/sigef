<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.PDomanda.ImpresaBilancioIndustriale" CodeBehind="ImpresaBilancioIndustriale.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function nuovo() { $('#ctl00_cphContenuto_hdnId').val(''); $('#ctl00_cphContenuto_btnNuovo').click(); }
    ...
    <table id="tbBilancio" width="991px" class="tableTab" runat="server" visible="false">
        ...
        <tr>
            <td colspan ="2">
               ...
               <asp:TextBox  ID="txtNotaIntegrativa" CssClass="dtFrmCtrl8 dtFrmCtrlScroll rounded" runat="server" TextMode="MultiLine"></asp:TextBox> 
            </td>
        </tr>
        <tr>
            <td>
