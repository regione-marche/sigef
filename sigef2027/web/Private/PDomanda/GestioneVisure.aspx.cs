    ...
    public partial class GestioneVisure : ProgettoPage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (progettiColl.Count == 0 && visureCollection.Count == 0)
            {
                ...
                btnGoUp.Attributes.Add("onclick", "alert('Attenzione! Per proseguire occorre inserire almeno una visura.'); ");
                btnPrev.Attributes.Add("onclick", "alert('Attenzione! Per proseguire occorre inserire almeno una visura.'); ");
                btnPrevUp.Attributes.Add("onclick", "alert('Attenzione! Per proseguire occorre inserire almeno una visura.'); ");
