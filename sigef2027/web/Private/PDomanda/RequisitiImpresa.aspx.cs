    ...
    public partial class RequisitiImpresa : SiarLibrary.Web.ProgettoPage
    {
        ...
        public System.Collections.ArrayList PrioritaImpresa
        {
            get
            {
                ...
                foreach (string s in ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[2]).GetSelected())
                {
                ...
                if (NaturaSoggetto.TipoNaturaSoggetto == "Aggregata")
                {
                    ...
                    { 
                        ...
                        if (int.TryParse(hdnIdImpresaAggregazione.Value, out id_impresa_selezionata))
                        {
                            ...
                            ((SiarLibrary.Web.CheckColumnAgid)dgPriorita.Columns[2]).ClearSelected();
        ...
        void dgPriorita_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (dgi.ItemType != ListItemType.Header && dgi.ItemType != ListItemType.Footer)
            {
                ...
                if (sxp.PluriValore)
                {
                    ...
                    //}
                    e.Item.Cells[2].Text = "<svg class='icon m-1' style='cursor:pointer;' onclick=\"SNCZoomPlurivalore(" + sxp.IdPriorita
                        + ",'getPlurivaloriRequisitiDomanda',selezionaPlurivalore,0);\" alt='Apri il popup di selezione del valore'><use href='/web/bootstrap-italia/svg/sprites.svg#it-list'></use></svg>" +
                        "<svg class='icon m-1' style='cursor: pointer; ' onclick='deselezionaPlurivalore("
                          + sxp.IdPriorita + ");' alt='Deseleziona'><use href='/web/bootstrap-italia/svg/sprites.svg#it-close-big'></use></svg>";
                ...
                else if (sxp.PluriValoreSql)
                {
                    ...
                    e.Item.Cells[2].Text = "<svg class='icon m-1' style='cursor:pointer;' onclick=\"SNCZoomPlurivaloreSql(" + (Progetto.IdProgetto)
                ...
                else if (sxp.InputNumerico)
                {
                    ...
                    e.Item.Cells[2].Text = "";
                    e.Item.Cells[3].Text = "<span id=\"" + nome_casella + "\" class=\"CurrencyBox\" style=\"display:inline-block;\">"
                ...
                else if (sxp.Datetime)
                {
                    ...
                    e.Item.Cells[2].Text = "";
                    e.Item.Cells[3].Text = "<span id=\"" + nome_casella + "\" class=\"DataBox\" style=\"display:inline-block;\">"
                        + "<input name=\"" + nome_casella + "_text\" type=\"text\" id=\"" + nome_casella
                        + "_text\" style=\"text-align:right;\" value='" + valore + "'/></span>";
                }
                else if (sxp.TestoSemplice)
                {
                    ...
                    e.Item.Cells[2].Text = "";
                    e.Item.Cells[3].Text = "<span id=\"" + nome_casella + "\" class=\"TextBox\" style=\"display:inline-block;\">"
                        + "<input name=\"" + nome_casella + "_text\" type=\"text\" id=\"" + nome_casella
