...
{
    public partial class Cofirmatario : SiarLibrary.Web.ProgettoPage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            SiarLibrary.PersoneXImpreseCollection cofirmatari = new SiarBLL.PersoneXImpreseCollectionProvider().Find(null, null, Progetto.IdImpresa, "C", true, true);
        ...
        protected void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                amm_coll = pxp_provider.Find(null, null, Progetto.IdImpresa, "C", true, true);
                if (amm_coll.Count == 0)
                {
                    amministratore = new SiarLibrary.PersoneXImprese();
                    amministratore.CodRuolo = "C";
                    amministratore.IdPersona = id_persona;
                    amministratore.IdImpresa = Progetto.IdImpresa;
        ...
        protected void btnElimina_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                amm_coll = pxp_provider.Find(id_persona, null, Progetto.IdImpresa, "C", true, true);
