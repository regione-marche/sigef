...
//--></script>
    ...
    <div class="tableTab" id="tbElenco" runat="server" >
          <div class="table-responsive">      
                <Siar:DataGridAgid ID="dgDocumenti" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" PageSize="20">
    ...
    <div id="tbDettaglio" runat="server" class="tableTab" width="800px">
        <div class="row p-1">
            <div class="col-md-6">
                          <label class="active" for="txtTitolo" />
                            <Siar:TextArea ID="txtTitolo" runat="server" DataColumn="Titolo" NomeCampo="Titolo"
                                Rows="3" Obbligatorio="True" />
                        </div>
                        <td valign="bottom">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <br />
                            <uc2:SNCUploadFileControl ID="ucSNCUploadFileControl" runat="server" TipoFile="NonSpecificato" DimensioneMassima="NoLimit" />
                            <br />
                        </td>
                    </tr>
