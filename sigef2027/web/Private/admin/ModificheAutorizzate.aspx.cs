        ...
        void dgElencoModifiche_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (modificaAutorizzata.SegnaturaRichiesta != null)
                    dgi.Cells[col_SegnaturaRichiesta].Text = "<svg alt='Domanda'  onclick=\"sncAjaxCallVisualizzaProtocollo('" + modificaAutorizzata.SegnaturaRichiesta + "');\" style='cursor: pointer;'class='icon ms-1'><use href='/web/bootstrap-italia/svg/sprites.svg#it-print'></use></svg>";
                else
