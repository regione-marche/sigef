<%@ Page Async="true" Language="c#" MasterPageFile="~/SigefAgidPrivate.master" Inherits="web.Private.admin.MessaggiTelegram" CodeBehind="MessaggiTelegram.aspx.cs" %>
        ...
        <div style="margin: 15px;">
            ...
            <div id="divTesto" runat="server">
                <div class="first_elem_block">
                    ...
                    <div class="value">
                        <asp:TextBox CssClass="rounded" ID="txtTesto" runat="server" name="Messaggio Telegram" TextMode="MultiLine" Rows="4" Width="500" />
                    </div>
                </div>
            </div>
            ...
            <div id="divFile" runat="server">
                ...
                <div class="first_elem_block">
                    ...
                    <div class="value">
                        <asp:TextBox CssClass="rounded" ID="txtDidascalia" runat="server" name="Didascalia file Telegram" TextMode="MultiLine" Rows="4" Width="500" />
                    </div>
                </div>
            </div>
        ...
        <div style="margin: 15px;">
            ...
            <div id="divTestoModifica" runat="server">
                <div class="first_elem_block">
                    ...
                    <div class="value">
                        <asp:TextBox CssClass="rounded" ID="txtTestoModifica" runat="server" name="Messaggio Telegram Modificato" TextMode="MultiLine" Rows="4" Width="500" />
                    </div>
                </div>
            </div>
            ...
            <div id="divFileModifica" runat="server">
                ...
                <div class="first_elem_block">
                    ...
                    <div class="value">
                        <asp:TextBox CssClass="rounded" ID="txtDidascaliaModifica" runat="server" name="Didascalia file Telegram modificata" TextMode="MultiLine" Rows="4" Width="500" />
                    </div>
                </div>
            </div>
