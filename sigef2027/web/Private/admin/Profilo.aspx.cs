...
namespace web.Private.admin
{
    public partial class Profilo : SiarLibrary.Web.PrivatePage
    {
            ...
            switch (ucSiarNewTab.TabSelected)
            {
                ...
                case 2:
                    ...
                    if (id_profilo_da_caricare > 0)
                    {
                        ...
                        ((SiarLibrary.Web.CheckColumnAgid)dgFunzionalita.Columns[4]).SetSelected(selezionati);
                        ((SiarLibrary.Web.CheckColumnAgid)dgFunzionalita.Columns[3]).SetSelected(permodifica);
                    }
        ...
        private void pulisciDettaglio()
        {
            ...
            txtOrdine.Text = null;
            ((SiarLibrary.Web.CheckColumnAgid)dgFunzionalita.Columns[4]).ClearSelected();
            ((SiarLibrary.Web.CheckColumnAgid)dgFunzionalita.Columns[3]).ClearSelected();
        }
        ...
        protected void btnSalva_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                string[] selezionati = ((SiarLibrary.Web.CheckColumnAgid)dgFunzionalita.Columns[4]).GetSelected();
                string[] inmodifica = ((SiarLibrary.Web.CheckColumnAgid)dgFunzionalita.Columns[3]).GetSelected();
