            ...
            switch (ucSiarNewTab.TabSelected)
            {
                case 2:
                    ...
                    if (istituto_selezionato != null)
                    {
                        ...
                        txtDataInizio.Text = istituto_selezionato.DataInizioValidita.ToStringAgid();
                        if (istituto_selezionato.DataFineValidita != null) txtDataFine.Text = istituto_selezionato.DataFineValidita.ToStringAgid();
                ...
                case 3:
                    ...
                    if (filiale_selezionata != null)
                    {
                        ...
                        txtDataInizio3.Text = filiale_selezionata.DataInizioValidita.ToStringAgid();
                        if (filiale_selezionata.DataFineValidita != null) txtDataFine3.Text = filiale_selezionata.DataFineValidita.ToStringAgid();
