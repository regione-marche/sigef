...
namespace web.Private.Psr.Bandi
{
    public partial class ModelloDomanda : SiarLibrary.Web.BandoPage
    {
        ...
        {
            string[] selezionati = ((SiarLibrary.Web.CheckColumnAgid)dgQuadri.Columns[4]).GetSelected();
        ...
        {
            string[] selezionate = ((SiarLibrary.Web.CheckColumnAgid)dgDichiarazioni.Columns[6]).GetSelected();
            string[] obbligatorie = ((SiarLibrary.Web.CheckColumnAgid)dgDichiarazioni.Columns[4]).GetSelected();
        ...
        protected void btnSalvaAllegati_Click(object sender, EventArgs e)
        {
            try
            {
                string[] selezionati = ((SiarLibrary.Web.CheckColumnAgid)dgAllegati.Columns[4]).GetSelected();
