...
namespace SiarLibrary
{
	...
	// interfaccia provider per BilancioPrevisionale
	// Interfaccia Autogenerata
	// Inserire eventuali operazioni aggiuntive
	public interface IBilancioPrevisionaleProvider
	{
		int Save(BilancioPrevisionale BilancioPrevisionaleObj);
		int SaveCollection(BilancioPrevisionaleCollection collectionObj);
		int Delete(BilancioPrevisionale BilancioPrevisionaleObj);
		int DeleteCollection(BilancioPrevisionaleCollection collectionObj);
	}
	/// <summary>
	/// Summary description for BilancioPrevisionale
	/// Class Autogenerata
	/// Inserire eventuali operazioni aggiuntive
	/// </summary>
	...
	public class BilancioPrevisionale: BaseObject
	{

		//Definizione dei campi 'base'
		private NullTypes.IntNT _IdPrevisionale;
		...
		/// <summary>
		/// Corrisponde al campo:ID_PREVISIONALE
		/// Tipo sul db:INT
		/// </summary>
		public NullTypes.IntNT IdPrevisionale
		{
			get { return _IdPrevisionale; }
			set {
				if (IdPrevisionale != value)
				{
					_IdPrevisionale = value;
					SetDirtyFlag();
				}
			}
		}
