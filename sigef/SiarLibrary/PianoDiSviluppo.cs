...
namespace SiarLibrary
{
	...
	// interfaccia provider per PianoDiSviluppo
	// Interfaccia Autogenerata
	// Inserire eventuali operazioni aggiuntive
	public interface IPianoDiSviluppoProvider
	{
		int Save(PianoDiSviluppo PianoDiSviluppoObj);
		int SaveCollection(PianoDiSviluppoCollection collectionObj);
		int Delete(PianoDiSviluppo PianoDiSviluppoObj);
		int DeleteCollection(PianoDiSviluppoCollection collectionObj);
	}
	/// <summary>
	/// Summary description for PianoDiSviluppo
	/// Class Autogenerata
	/// Inserire eventuali operazioni aggiuntive
	/// </summary>
	...
	public class PianoDiSviluppo: BaseObject
	{
