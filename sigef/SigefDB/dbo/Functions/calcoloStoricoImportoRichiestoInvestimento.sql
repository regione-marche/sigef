...
CREATE FUNCTION [dbo].[calcoloStoricoImportoRichiestoInvestimento] 
(
	@ID_INVESTIMENTO INT, 
...
BEGIN
	...
	FROM PIANO_INVESTIMENTI I LEFT JOIN
	   (SELECT ID_INVESTIMENTO,SUM(IMPORTO_RICHIESTO) AS IMPORTO FROM PAGAMENTI_RICHIESTI P
	...
	IF (@ID_INVESTIMENTO_ORIGINALE IS NOT NULL) 
		SET @IMPORTO=ISNULL(@IMPORTO,0) + dbo.calcoloStoricoImportoRichiestoInvestimento(@ID_INVESTIMENTO_ORIGINALE,@ID_DOMANDA_PAGAMENTO)
