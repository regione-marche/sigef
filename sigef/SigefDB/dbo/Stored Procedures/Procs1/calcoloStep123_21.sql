CREATE  PROCEDURE [dbo].[calcoloStep123_21]
@IdProgetto int, 
@FASE_ISTRUTTORIA INT = 0
AS
BEGIN

--  123 - Totale inivestimenti per interventi  - MICROFILIERA IV SCADENZA
-- id priorita 1171
...
ELSE BEGIN
	SET @COSTO = DBO.calcoloCostoTotaleProgetto(@IdProgetto, @FASE_ISTRUTTORIA, NULL)
		IF(@TIPO_PROGETTO IN ('T','X'))BEGIN  IF( @COSTO > 50000) SET @RESULT=1 END
		ELSE BEGIN  IF( @COSTO > 10000) SET @RESULT=1 END		
END
