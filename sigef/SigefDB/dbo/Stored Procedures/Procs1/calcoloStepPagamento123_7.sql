--SALDO 123 microfiliera
CREATE  PROCEDURE [dbo].[calcoloStepPagamento123_7]
@IdProgetto int,
@IdDomandaPagamento int =NULL
AS
BEGIN
	-- microfiliera
	--	Verifica totale investimenti in domanda >=  50000
...
BEGIN 
	...
	IF((@IMPORTO_DOMANDA_ATTUALE + isnull(@IMPORTO_AMMESSO,0))>=50000 )SET @RESULT = 1
END 
ELSE SET @RESULT =1
