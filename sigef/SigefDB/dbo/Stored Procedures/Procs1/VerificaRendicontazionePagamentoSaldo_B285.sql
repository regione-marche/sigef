CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B285]
(
...
-- Costo totale del progetto non inferiore a 20.000 € e non superiore a 100.000 € al netto dell`iva.
IF (isnull(@COSTO_INVESTIMENTI,0)< 20000) or (isnull(@COSTO_INVESTIMENTI,0) > 100000) BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale del progetto inferiore a 20.000 € o superiore a 100.000 € al netto dell`iva.'
END
---------------------------------------------------------------------------------------------------
