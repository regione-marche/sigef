CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento111_12]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN
-- 111b) - Spese generali <= 5% totale domanda (Codifica investimento = 13)
...
IF @COSTO_INVESTIMENTI>0 BEGIN
	...
	IF @COSTO_INVESTIMENTI_GEN>(@COSTO_INVESTIMENTI*0.05)  SET @RESULT=0 
