CREATE PROCEDURE [dbo].[calcoloStepVariante121_2]
@ID_VARIANTE INT
AS
BEGIN
...
DECLARE @IdSchedaValutazione int ,  @PesoPrioritaA decimal(10,2), @ValoreMAXPrioritaA decimal(10,2)
DECLARE @PesoPrioritaB decimal(10,2),  @ValoreMAXPrioritaB decimal(10,2), @PesoPrioritaC decimal(10,2),
        @ValoreMAXPrioritaC decimal(10,2), @PunteggioPrioritaA decimal(10,4), @PunteggioPrioritaB decimal(10,4)
DECLARE @PunteggioPrioritaC decimal(10,4),  @IdProgetto INT
