...
CREATE PROCEDURE [dbo].[_zImportPagamentiProgettoSigfrido100Test]
...
INSERT INTO [DOMANDA_DI_PAGAMENTO]
     ...
     SELECT
       ...
       '20151011',					  --,<DATA_INSERIMENTO, datetime,>
       gs.CF_OPERATORE_IMPRESA,		  --,<CF_OPERATORE, varchar(16),>
       '20151011',						  --,<DATA_MODIFICA, datetime,>
...
INSERT INTO [GIUSTIFICATIVI]
     ...
     SELECT
        ...
        gs.IMPORTO_FATTURE_TOTALI,	  --,<IMPONIBILE, decimal(18,2),>
        0,						--,<IVA, decimal(18,2),>
...
gs.IMPORTO_PAGAMENTI_TOTALI_BENEFICIARIO,   --,<IMPORTO, decimal(18,2),>
gs.IMPORTO_PAGAMENTI_TOTALI_BENEFICIARIO,   --,<NETTO, decimal(18,2),>
0,--1,							--,<AMMESSO, bit,>
...
gs.INV_AMMESSO_2,			--,<IMPORTO_RICHIESTO, decimal(18,2),>
gs.IMPORTO_LIQUIDATO_TOT,   --,<CONTRIBUTO_RICHIESTO, decimal(18,2),>
...
gs.INV_AMMESSO_2,				--,<IMPORTO_AMMESSO, decimal(18,2),>
...
gs.IMPORTO_LIQUIDATO_TOT,       --,<IMPORTO_AMMISSIBILE, decimal(18,2),>
...
gs.IMPORTO_LIQUIDATO_TOT,       --,<IMPORTO_LIQUIDATO, decimal(18,2),>
...
gs.IMPORTO_LIQUIDATO_TOT,       --,<RICHIESTA_MANDATO_IMPORTO, decimal(18,2),>
...
gs.IMPORTO_LIQUIDATO_TOT,       --,<MANDATO_IMPORTO, decimal(18,2),>
NULL,							--,<MANDATO_ID_FILE, int,>
GETDATE(),						--,<QUIETANZA_DATA, datetime,>
gs.IMPORTO_LIQUIDATO_TOT,       --,<QUIETANZA_IMPORTO, decimal(18,2),>
0 --1								--,<LIQUIDATO, bit,>)
FROM _vGrad100 gs
WHERE 
gs.ID_DOMANDA = @id_prog_sigfrido
