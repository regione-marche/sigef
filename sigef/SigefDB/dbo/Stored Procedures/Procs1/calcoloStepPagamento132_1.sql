CREATE  PROCEDURE [dbo].[calcoloStepPagamento132_1]
@IdProgetto int,
@IdDomandaPagamento int =NULL
AS
BEGIN

	--SPESA AMMESSA domanda >=100 € 

	DECLARE @RESULT INT, @ID_PROGETTO INT, @SPESA_AMMESSA decimal(10,2)
