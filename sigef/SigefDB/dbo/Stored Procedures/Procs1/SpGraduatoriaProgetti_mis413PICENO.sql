/*************************************************************************************************************************************/
	...
	CREATE PROCEDURE [dbo].[SpGraduatoriaProgetti_mis413PICENO]
(
	@ID_BANDO INT,
...
AS
	...
	*/
	...
	DECLARE @ID_PROGETTO INT,@ORDINE INT,@CONTRIBUTO_PROGETTO DECIMAL(18,2),@FINANZIABILITA CHAR(1),@COD_STATO CHAR(1)
	SET @ORDINE=1
	-- IMPOSTO DI DEFAULT LA FINANZIABILITA TOTALE DELLA DOMANDA
	SET @FINANZIABILITA='S'
	
	DECLARE PROGETTI CURSOR FOR 
	SELECT G.ID_PROGETTO FROM @GRADUATORIA_PROGETTI_T G INNER JOIN PROGETTO P ON G.ID_PROGETTO=P.ID_PROGETTO	
	INNER JOIN IMPRESA I ON P.ID_IMPRESA =I.ID_IMPRESA 
	INNER JOIN VPERSONE_X_IMPRESE R ON I.ID_RAPPRLEGALE_ULTIMO=ID_PERSONE_X_IMPRESE
