CREATE  PROCEDURE [dbo].[calcoloRequisitoPagamento121_8]
...
SET @MINIMO_GRADUATORIA = ( SELECT TOP(1) PUNTEGGIO FROM  GRADUATORIA_PROGETTI WHERE ID_BANDO = 18 AND FINANZIABILITA ='N'
