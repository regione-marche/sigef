...
CREATE PROCEDURE [dbo].[_zImportProgettoSigfrido170Mobile_PI]
...
set @id_prog_sigef = (select ID_PROGETTO_SIGEF FROM _vGrad170Mobile WHERE ID_DOMANDA = @id_prog_sigfrido)
