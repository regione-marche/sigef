CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento311_B_2]
(
...
DECLARE CONTRIBUTO CURSOR FOR
			...
			SELECT      PIANO_INVESTIMENTI.ID_CODIFICA_INVESTIMENTO,  SUM(ISNULL(PR.CONTRIBUTO_RICHIESTO, PR.CONTRIBUTO_AMMESSO)) AS SPESA  
...
set @Punteggio= (SELECT  TOP (1)   VALORI_PRIORITA.PUNTEGGIO 
									...
									AND P.ID_CODIFICA_INVESTIMENTO =@ID_CODIFICA_INVESTIMENTO 
									 AND PRIORITA_X_INVESTIMENTI.ID_PRIORITA = 147  AND PR.ID_DOMANDA_PAGAMENTO = @ID_DOMANDA_PAGAMENTO  	  )
