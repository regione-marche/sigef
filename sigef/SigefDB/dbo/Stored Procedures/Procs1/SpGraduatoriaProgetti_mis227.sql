/*************************************************************************************************************************************/
	...
	CREATE PROCEDURE [dbo].[SpGraduatoriaProgetti_mis227]
	(
	@ID_BANDO INT,
...
IF @ID_BANDO IN (354, 476) BEGIN	 --- modificata per REI e VARIANTE -- AGGIORNA ANCHE Spesa totale ammessa (DA PRENDERE A MODELLO)
	DECLARE @ID_VARIANTE354 int = NULL
	...
	WHILE @@FETCH_STATUS=0 BEGIN
		...
		ELSE 		
		SET @ID_VARIANTE354 = (select MAX(ID_VARIANTE) from VARIANTI where ID_PROGETTO = @ID_PROGETTO AND APPROVATA = 1 AND ANNULLATA = 0 AND COD_TIPO IN ('AR','VA') )
		SET @CONTRIBUTO_PROGETTO=dbo.calcoloContributoTotaleProgetto(@ID_PROGETTO,1,@ID_VARIANTE354)
		SET @COSTO_PROGETTO = DBO.calcoloCostoTotaleProgetto(@ID_PROGETTO,1,@ID_VARIANTE354)
