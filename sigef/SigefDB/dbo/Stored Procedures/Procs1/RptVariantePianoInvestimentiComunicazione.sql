CREATE PROCEDURE [dbo].[RptVariantePianoInvestimentiComunicazione]
(
@IdVariante int,
...
BEGIN
	...
	SELECT I.ID_INVESTIMENTO, I.ID_INVESTIMENTO_ORIGINALE,  I.DESCRIZIONE,
				   ...
				   RATA_REINTEGRAZIONE = CASE MOBILE
					...
					I.COD_VARIAZIONE, I.TASSO_ABBUONO
	FROM VPIANO_INVESTIMENTI AS I 
	WHERE ID_VARIANTE=@IdVariante AND I.COD_TIPO_INVESTIMENTO = @COD_Tipo_Investimento AND ISNULL(COD_VARIAZIONE, 'X') != 'A' 
