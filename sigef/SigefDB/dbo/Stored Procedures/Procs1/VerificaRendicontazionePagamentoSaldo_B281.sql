CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B281]
(
...
-- Costo totale del progetto non inferiore a 15.000 € e non superiore a 150.000 € al netto dell`iva..
IF (isnull(@COSTO_INVESTIMENTI,0) < 15000) BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo investimento ammissibile all’aiuto < € 15.000,00 Euro.'
END
