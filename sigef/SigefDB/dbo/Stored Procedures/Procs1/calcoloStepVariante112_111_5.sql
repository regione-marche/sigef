CREATE  PROCEDURE [dbo].[calcoloStepVariante112_111_5]
@ID_VARIANTE  int
															...
															BEGIN IF (@CODICE IN ('40')) BEGIN IF(@COSTO<333.3  OR @COSTO >625.5 ) SET @Result =0 END
																...
																BEGIN IF (@CODICE IN ('46')) BEGIN IF(@COSTO<180  OR @COSTO >340 ) SET @Result =0 END
																	...
																	BEGIN IF (@CODICE IN ('47')) BEGIN IF(@COSTO<370  OR @COSTO >688 ) SET @Result =0 END
																		ELSE 
																			BEGIN IF (@CODICE IN ('61')) BEGIN IF(@COSTO<368  OR @COSTO >690 ) SET @Result =0 END
																				ELSE 
																					BEGIN IF (@CODICE IN ('62')) BEGIN IF(@COSTO<379  OR @COSTO >711 ) SET @Result =0 END
																				END
																		END
																	END
																END
