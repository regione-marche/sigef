CREATE  PROCEDURE [dbo].[calcoloRequisitoPagamento311_2]
...
DECLARE @RESULT INT
SET @RESULT =0 --- IMPONGO IL REQUISITO NON VERIFICATO
...
IF ( ISNULL(@PunteggioPrioritaB,0) + ISNULL(@PunteggioPrioritaI,0) + ISNULL(@PunteggioPrioritaJ,0) + ISNULL(@PunteggioPrioritaK,0) >= 0.08 )  
		SET @RESULT =1 
