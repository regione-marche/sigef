CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento_B238_1]
...
-- 294	Data inizio interventi programmati (90 gg. dalla data del ricevimento della comunicazione di finanziabilità  oltre eventuali proroghe)
