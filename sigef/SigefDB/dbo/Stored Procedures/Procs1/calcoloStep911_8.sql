CREATE PROCEDURE [dbo].[calcoloStep911_8]
(
	@IdProgetto int,
...
*/
	DECLARE @Risultato INT =1 , @C INT, @NUM_PROG INT
	...
	ELSE BEGIN
	     	...
	     	WHERE pi1.ID_PROGETTO!=@IdProgetto AND P.ID_IMPRESA  = (SELECT ID_IMPRESA FROM PROGETTO WHERE ID_PROGETTO = @IdProgetto) AND PXI.ID_PRIORITA = @C
