CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B312]
(
...
-- Costo totale investimenti >= 50.000,01 E <=150.000,00 al netto di IVA
IF (isnull(@COSTO_INVESTIMENTI,0) <= 50000) or (isnull(@COSTO_INVESTIMENTI,0) > 150000) BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale investimenti > 50.000 e <= 150.000,00 al netto di IVA.'
END
---------------------------------------------------------------------------------------------------
