/*************************************************************************************************************************************/
	...
	CREATE PROCEDURE [dbo].[SpGraduatoriaProgetti_mis311]
(
	@ID_BANDO INT,
...
AS
	...
	SET @ID_BANDO =102-- ,115
	SET @OPERATORE ='LPZLRD59M11D472Z' 
	*/
	...
	DECLARE PROGETTI CURSOR FOR SELECT P.ID_PROGETTO FROM @GRADUATORIA_PROGETTI_T P
	INNER JOIN PROGETTO A ON P.ID_PROGETTO=A.ID_PROGETTO
	INNER JOIN PERSONE_X_IMPRESE PI ON A.ID_IMPRESA=PI.ID_IMPRESA AND COD_RUOLO='R' AND PI.DATA_FINE IS NULL
	INNER JOIN PERSONA_FISICA PF ON PI.ID_PERSONA=PF.ID_PERSONA
