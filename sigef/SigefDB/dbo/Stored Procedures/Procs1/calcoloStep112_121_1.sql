CREATE PROCEDURE [dbo].[calcoloStep112_121_1]
@IdProgetto INT
AS
...
DECLARE @COSTO_INVESTIMENTO DECIMAL(18,2),@SPESE_TECNICHE DECIMAL(18,2),
		@CONTRIBUTO_RICHIESTO DECIMAL(18,2), @QUOTA_CONTRIBUTO DECIMAL(18,2)
...
(
	...
	FROM  VPIANO_INVESTIMENTI V 
	INNER JOIN VPROGETTO ON V.ID_PROGETTO=VPROGETTO.ID_PROGETTO
	WHERE V.ID_PROGETTO=@ID_PROG_CORRENTE_121 AND ((VPROGETTO.COD_STATO='P' AND ID_INVESTIMENTO_ORIGINALE IS NULL)OR
	(VPROGETTO.COD_STATO!='P'  AND ID_INVESTIMENTO_ORIGINALE IS NOT NULL AND ID_VARIANTE IS NULL)) AND COD_TIPO_INVESTIMENTO = 1 --AND MOBILE=0
)
OPEN INVESTIMENTO
