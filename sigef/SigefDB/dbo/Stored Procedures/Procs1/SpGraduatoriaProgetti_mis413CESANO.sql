CREATE PROCEDURE [dbo].[SpGraduatoriaProgetti_mis413CESANO]
(
	@ID_BANDO INT,
...
AS
	...
	*/
	...
	INNER JOIN vPROGETTO V ON P.ID_PROGETTO=V.ID_PROGETTO ORDER BY PUNTEGGIO DESC,COSTO_TOTALE DESC
	OPEN PROGETTI
