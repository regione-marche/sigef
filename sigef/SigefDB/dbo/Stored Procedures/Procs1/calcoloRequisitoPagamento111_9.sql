CREATE PROCEDURE [dbo].[calcoloRequisitoPagamento111_9]
@ID_DOMANDA_PAGAMENTO int
AS
BEGIN
-- 111b) - Spese per servizi esterni <= 10% del totale investimenti aventi la stessa codifica (dettaglio investimento = 5)
...
IF @COSTO_INVESTIMENTI>0 BEGIN
	...
	IF @COSTO_INVESTIMENTI_SERVEST>(@COSTO_INVESTIMENTI*0.10)  SET @RESULT=0 
