CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B488]
(
...
--Costo totale del progetto maggiore o uguale a 30.000€.
--Costo attività realizzate da personale interno nel limite massimo del 5% del costo totale progetto.
---------------------------------------------------------------------------------------------------
----====================================================================================================================-----
DECLARE @COSTO_A DECIMAL(18,2), @COSTO_DEG DECIMAL(18,2), @COSTO_INERNO DECIMAL(18,2)
...
--Costo totale del progetto maggiore o uguale a 30.000€.
IF (@COSTO_INVESTIMENTI < 30000)  BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale del progetto minore di 30.000€.'
END
----------------------------------------------------------------------------------------------------------------
...
IF ((isnull(@COSTO_INERNO,0)*100) / @COSTO_INVESTIMENTI) > 5 BEGIN
		SET @TIPO_RISULTATO='N'
		SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo attivita realizzate del personale interno NON nel limite massimo del 5% del costo totale. '
END
