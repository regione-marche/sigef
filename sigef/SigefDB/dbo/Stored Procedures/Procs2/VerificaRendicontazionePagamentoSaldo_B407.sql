CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B407]
(
...
-- Costo dell`investimento ammissibile all`aiuto > = € 50.000,00 euro.
IF (isnull(@COSTO_INVESTIMENTI,0) < 50000)BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo dell`investimento ammissibile all`aiuto > = € 50.000,00 Euro.'
END
