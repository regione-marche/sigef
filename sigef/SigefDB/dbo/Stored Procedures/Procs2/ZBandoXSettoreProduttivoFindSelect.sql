CREATE PROCEDURE [dbo].[ZBandoXSettoreProduttivoFindSelect]
(
...
GO
EXECUTE sp_addextendedproperty @name = N'backup', @value = N'CREATE PROCEDURE [dbo].[ZBandoXSettoreProduttivoFindSelect]
(
	@IdBandoXSettoreProduttivoequalthis INT, 
	@IdBandoequalthis INT, 
	@IdSettoreProduttivoequalthis INT, 
...
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'ZBandoXSettoreProduttivoFindSelect';
