CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B421]
(
...
ID_DETTAGLIO_INVESTIMENTO IN (SELECT ID_DETTAGLIO_INVESTIMENTO  FROM CODIFICA_INVESTIMENTO CI  INNER JOIN DETTAGLIO_INVESTIMENTI DI ON (CI.ID_CODIFICA_INVESTIMENTO = DI.ID_CODIFICA_INVESTIMENTO) WHERE  CI.ID_BANDO = 421 AND DI.COD_DETTAGLIO = 'a')
