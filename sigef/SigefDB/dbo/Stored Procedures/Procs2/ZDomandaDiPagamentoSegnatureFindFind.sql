CREATE PROCEDURE [dbo].[ZDomandaDiPagamentoSegnatureFindFind]
(
...
AS
	...
	if (@lensql<3000)
	exec sp_executesql @sql,N'@IdDomandaPagamentoequalthis INT, @CodTipoequalthis CHAR(3), @RiapriDomandaequalthis BIT',@IdDomandaPagamentoequalthis , @CodTipoequalthis , @RiapriDomandaequalthis ;
	else
...
GO
EXECUTE sp_addextendedproperty @name = N'backup', @value = NULL, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'ZDomandaDiPagamentoSegnatureFindFind';
