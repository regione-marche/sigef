CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B314]
(
...
-- Investimento ammissibile max € 10.000,00.
IF (isnull(@COSTO_INVESTIMENTI,0) > 10000)BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Investimento ammissibile max € 10.000,00.'
END
---------------------------------------------------------------------------------------------------
