CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_M123_B418]
(
...
-- IN QUESTA SCDENZA SOLO SE SONO O.P. -- ID PRIORITA:43
DECLARE @ORTOFRUTTA INT, @COSTO_ORTOFRUTTA DECIMAL(18,2), @IMPRESA_NO_OP INT
