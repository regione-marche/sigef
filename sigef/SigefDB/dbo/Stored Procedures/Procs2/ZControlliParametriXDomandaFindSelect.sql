CREATE PROCEDURE [dbo].[ZControlliParametriXDomandaFindSelect]
(
	@IdDomandaPagamentoequalthis INT, 
	@IdParametroequalthis INT, 
	@IdLottoequalthis INT, 
	@Punteggioequalthis INT, 
...
AS
	...
	if (@lensql<3000)
	exec sp_executesql @sql,N'@IdDomandaPagamentoequalthis INT, @IdParametroequalthis INT, @IdLottoequalthis INT, @Punteggioequalthis INT, @DataValutazioneequalthis DATETIME, @Operatoreequalthis VARCHAR(16)',@IdDomandaPagamentoequalthis , @IdParametroequalthis , @IdLottoequalthis , @Punteggioequalthis , @DataValutazioneequalthis , @Operatoreequalthis ;
	else
...
GO
EXECUTE sp_addextendedproperty @name = N'backup', @value = NULL, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'ZControlliParametriXDomandaFindSelect';
