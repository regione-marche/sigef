CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_B313]
(
...
-- Costo totale investimento 60.000 euro iva esclusa
IF (isnull(@COSTO_INVESTIMENTI,0) > 60000) BEGIN
	SET @TIPO_RISULTATO='N'
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - Costo totale investimento 60.000 euro iva esclusa'
END
---------------------------------------------------------------------------------------------------
