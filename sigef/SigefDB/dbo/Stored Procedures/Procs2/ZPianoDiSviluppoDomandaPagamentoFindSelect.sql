CREATE PROCEDURE [dbo].[ZPianoDiSviluppoDomandaPagamentoFindSelect]
(
...
AS
	...
	if (@lensql<3000)
	exec sp_executesql @sql,N'@IdPianoequalthis INT, @Annoequalthis INT, @IdDomandaPagamentoequalthis INT, @IdImpresaequalthis INT, @IdProgettoequalthis INT, @CostoInvestimentoequalthis DECIMAL(10,2), @MezziPropriequalthis DECIMAL(10,2), @RisorseTerziequalthis DECIMAL(10,2), @ContributiPubbliciequalthis DECIMAL(10,2), @SpeseGestioneequalthis DECIMAL(10,2), @RimborsoDebitoequalthis DECIMAL(10,2), @EntrataGestioneequalthis DECIMAL(10,2), @AltreCopertureequalthis DECIMAL(10,2)',@IdPianoequalthis , @Annoequalthis , @IdDomandaPagamentoequalthis , @IdImpresaequalthis , @IdProgettoequalthis , @CostoInvestimentoequalthis , @MezziPropriequalthis , @RisorseTerziequalthis , @ContributiPubbliciequalthis , @SpeseGestioneequalthis , @RimborsoDebitoequalthis , @EntrataGestioneequalthis , @AltreCopertureequalthis ;
	else
...
GO
EXECUTE sp_addextendedproperty @name = N'backup', @value = NULL, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'ZPianoDiSviluppoDomandaPagamentoFindSelect';
