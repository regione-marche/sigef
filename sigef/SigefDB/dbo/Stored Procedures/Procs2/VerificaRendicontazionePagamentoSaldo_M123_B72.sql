CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_M123_B72]
(
...
---------------------------------------------------------------------------------------------------
-- 123 a) totale inivestimenti in domanda > = 150.000,00 €
...
IF @COSTO_INVESTIMENTI<150000 BEGIN
	...
	SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> - L`ammontare rendicontato sulla misura 123 deve essere superiore a 150.000 €.'
END
