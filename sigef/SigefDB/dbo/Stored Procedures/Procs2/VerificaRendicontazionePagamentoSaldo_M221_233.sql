CREATE PROCEDURE [dbo].[VerificaRendicontazionePagamentoSaldo_M221_233]
(
	@ID_DOMANDA_PAGAMENTO INT
)
AS

--- UGUALE A STOREDPROCEDURE VerificaRendicontazionePagamentoSaldo_M221_203
...
DECLARE @IMPORTO_A1 DECIMAL (18,2) ,@IMPORTO_A2 DECIMAL (18,2) ,@IMPORTO_A3 DECIMAL (18,2) , @IMPORTO_TOTALE  DECIMAL (18,2)
...
IF(ISNULL(@IMPORTO_A1,0) > 10 OR ISNULL(@IMPORTO_A2,0) >10 OR ISNULL(@IMPORTO_A3,0) >10)BEGIN
			SET @TIPO_RISULTATO='N'
			SET @MESSAGGIO_RISULTATO=@MESSAGGIO_RISULTATO+'<BR /> -  Spese GENERALI di impianto maggiori del 10% del Costo di impianto'
	END
END
