			...
			FROM (
				...
				FROM vPROGETTO P 
					...
					LEFT JOIN (SELECT PRI.ID_INVESTIMENTO, 
									...
									IMP.COD_ATECO2007 AS COD_ATECO
								...
								WHERE 1 = 1
									AND ( PRIO.DESCRIZIONE LIKE '%Selezionare l`ente/l''impresa che ha in carico l`investimento%'
										OR PRIO.DESCRIZIONE LIKE '%Selezionare la startup o PMI innovativa che ha in carico l`investimento%' ) ) IMP ON I.ID_INVESTIMENTO = IMP.ID_INVESTIMENTO
