...
CREATE VIEW [dbo].[_vGrad95Filiere_1]
AS
...
gs170.TERMINE_PROGETTO AS DATA_FINE_PROGETTO,
IMPR.INVESTIMENTO_RICHIESTO,
gs170.INVESTIMENTO_AMMESSO_PROGETTO INVESTIMENTO_AMMESSO,
--ISNULL(INVESTIMENTO_TOTALE_AMMESSO, INVESTIMENTO_AMMESSO) AS INV_AMMESSO,
IMPR.CONTRIBUTO_RICHIESTO,
gs170.CONTRIBUTO_CONCESSO_PROGETTO AS CONTRIBUTO_CONCESSO,
--CONTRIBUTO_CONCESSO,
i.ID_IMPRESA,
U.ID_UTENTE,
...
gs170.[DATA_INVIO_PEC_1_SAL_(365_GG_DA_RICEZIONE)] DATA_RILASCIO_DOMANDA_PAGAMENTO,
...
_GraduatoriaSigfrido95Filiere_1 gs170
inner join 
...
FROM 
dbo._GraduatoriaSigfrido95Filiere_1 
GROUP BY 
ID_DOMANDA_SIGFRIDO
) IMPR ON
...
SUM(ISNULL(gs.[A)_ANTICIPAZIONE_LIQUIDATA_], 0)) IMPORTO_ANTICIPO, --coincide con l'importo liquidato dell'anticipo
