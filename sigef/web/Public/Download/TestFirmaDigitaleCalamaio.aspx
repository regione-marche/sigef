<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="TestFirmaDigitaleCalamaio.aspx.cs" Inherits="web.Public.Download.TestFirmaDigitaleCalamaio" %>
    ...
    <div class="dBox" style="width=100%">
        ...
        <div style="padding:10px;">
            <div>
                ...
                A questo punto sarà possibile aprirlo e prendere visione della sigla apposta in fondo ad esso che mostra le informazioni della firma.
                <br />
                <br />
            ...
            <div id="header" class="col-container" style="margin-top: 10px; margin-bottom: 10px;">
                <div class="col" style="float: left; border: height:stretch; width: 180px;">
                    <br />
                    <b>Stato App Calamaio:</b> <span id="serviceStatus" style="color: #FF8C00;">VERIFICA IN CORSO...</span>
                    <br />
                    <br />
                    <input id="btnStart" type="button" value="Scarica / avvia" onclick="StartCalamaio();" class="Button" /><br />
                </div>
                ...
                <div class="col" style="float: right;">
                    <input type="button" id="btnFirma" class="Button" disabled="disabled" name="btnFirma" value="Firma documento di test" onclick="btnFirmaClick(); return false;" />
                    <br />
                    <br />
            ...
            <div align="center" id="divBottoni" runat="server" style="display: none;">
                ...
                <br />
                <asp:Button ID="btnSALVA" OnClick="btnSALVA_Click" class="Button" Text="Visualizza" ToolTip="Visualizza la versione firmata del documento." runat="server" Width="150px" />
            </div>
