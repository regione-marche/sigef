<%@ Page Title="" Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true" CodeBehind="RicercaRecuperoBeneficiario.aspx.cs" Inherits="web.Private.Controlli.RicercaRecuperoBeneficiario" %>
    ...
    <div class="dBox">
        ...
        <div style="padding: 10px;">
            <div class="elem_block">
                <Siar:Button ID="btnNuovoRecupero" runat="server" Width="200px" Text="Nuovo Recupero"
            ...
            <Siar:DataGrid ID="dgRecuperi" runat="server" AutoGenerateColumns="false" Width="100%">
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="TotaleDaRecuperare" HeaderText="Contributo da revocare">
