<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.PDomanda.ImpresaBilancioAgricolo" CodeBehind="ImpresaBilancioAgricoltura.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <table id="tbBilancio" width="991px" class="tableTab" runat="server" visible="false">
        ...
        <tr>
            ...
            <td style="width: 50%">
                <Siar:IntegerTextBox runat="server" DataColumn="Anno" NoCurrency="true" ID="txtAnno"
                    Width="40px" NomeCampo="Anno di riferimento" Obbligatorio="true" />
            </td>
        </tr>
        <tr>
            <td style="text-align: right; width: 50%;">
