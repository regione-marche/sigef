        ...
        void dg_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType != ListItemType.Header && e.Item.ItemType != ListItemType.Footer)
            {
                ...
                if (!i.Attiva) e.Item.BackColor = System.Drawing.Color.FromArgb(204, 204, 185);
                    ...
                    e.Item.Cells[4].Text = "<input type='button' style='width:120px' class='ButtonGrid' value='Scarica anagrafica' onclick=\"scaricaAnagrafica('"
                        + i.Cuaa + "');\" />";
                else e.Item.Cells[4].Text = "<input type='button' style='width:120px' class='ButtonGrid' value='Seleziona' onclick=\"location='../impresa/nuovadomanda.aspx?idimp="
