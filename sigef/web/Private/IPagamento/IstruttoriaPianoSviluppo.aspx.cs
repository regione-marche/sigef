...
{
    public partial class IstruttoriaPianoSviluppo : SiarLibrary.Web.IstruttoriaPagamentoPage
    {
        ...
        private void InitializePianiSviluppo()
        {
            ...
            if (psdomanda.Count > 0)
            {
                decimal A1 = 0, B1 = 0, B2 = 0, B3 = 0, C1 = 0, C2 = 0, D1 = 0,
                D2 = 0, TotFabb = 0, TotCop = 0, TotSaldoNetto = 0;
                int i = 1;
                foreach (SiarLibrary.PianoDiSviluppoDomandaPagamento piano_sviluppo in psdomanda)
                {
                    ...
                    // E) Totale fabbisogno
                    decimal TotaleFabbisogno = piano_sviluppo.CostoInvestimento.Value + piano_sviluppo.SpeseGestione.Value + piano_sviluppo.RimborsoDebito.Value;
            ...
            else ShowMessage("Il Piano di Sviluppo non è stato inserito.");
        }
        /// <summary>
