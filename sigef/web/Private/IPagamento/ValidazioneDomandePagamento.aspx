<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true" CodeBehind="ValidazioneDomandePagamento.aspx.cs" Inherits="web.Private.IPagamento.ValidazioneDomandePagamento" %>
            ...
            <div>
                <Siar:DataGrid ID="dgDomandeDaAssegnare" runat="server" Width="100%" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CfIstruttore" HeaderText="Istruttore"></asp:BoundColumn>
            ...
            <div>
                <Siar:DataGrid ID="dgDomande" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CfOperatore" HeaderText="Validatore">
                            <ItemStyle HorizontalAlign="Center" Width="120px" />
                        </asp:BoundColumn>
