<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true" Inherits="web.Private.IPagamento.RevisioneDomandeNew" CodeBehind="RevisioneDomandeNew.aspx.cs" %>
        ...
        <div style="padding: 10px;">
            ...
            <div id="divSelezioneTestata" runat="server">
                ...
                <div class="elem_block">
                    <input id="btnBack" runat="server" class="Button" style="width: 120px" type="button" onclick="location='ValidazioneDomandePagamentoNew.aspx'" value="Indietro" />
                </div>
                <br />
                <br />
            ...
            <div id="divCambioValidatore" runat="server" visible="false">
                <div class="paragrafo">
                    Cambio validatore:
                </div>
                <br />
                ...
                <div style="padding: 15px;">
                    <label for="txtOperatoreValidatore" style="padding-right: 20px;">
                        Seleziona l'operatore: 
                        <Siar:TextBox ID="txtOperatoreValidatore" runat="server" Width="384px" />
                    </label>
                    <Siar:Button ID="btnValidatore" runat="server" OnClick="btnValidatore_Click" OnClientClick=" return checkValidatore();" Text="Assegna a validatore" Width="150px" />
            ...
            <div id="divCopiaEsitiAiuti" runat="server" visible="false">
                <div class="paragrafo">
                    Copia esiti e note:
                </div>
                <br />
                ...
                <p>
                    ...
                    rientri tra gli aiuti e sia già stata approvata e firmata.
                    <br />
                    Inoltre le checklist devono essere dello stesso tipo e non con le vecchie checklist (con nome "Revisione_Old").
                    <br />
                    Copiare gli esiti permette ancora la modifica della validazione in corso in tutte le sue informazioni.
                    <br />
                    Inserire nella textbox sottostante l'id della domanda di pagamento da cui copiare gli esiti e le note.
                </p>
                <br />

                <div style="padding: 15px;">
                    <label for="txtIdDomandaPagamentoDaCopiare" style="padding-right: 20px;">
                        Id domanda di pagamento: 
                        <Siar:TextBox ID="txtIdDomandaPagamentoDaCopiare" runat="server" Width="100px" />
                    </label>
                    <Siar:Button ID="btnCopiaEsiti" runat="server" OnClick="btnCopiaEsiti_Click" Enabled="false" Text="Copia esiti" Width="150px" />
                </div>
                <br />
            </div>
            ...
            <div id="divSelezioneIstanza" runat="server" visible="false">
                ...
                <div class="first_elem_block">
                    <Siar:Button ID="btnAggiungiChecklist" Modifica="true" runat="server" CausesValidation="false" Text="Aggiungi checklist" Style="width: 160px;" OnClick="btnAggiungiChecklist_Click" />
                </div>
                <br />
                <br />
                ...
                <div id="divDettaglioValidazione" runat="server" visible="false">
                    ...
                    <div class="first_elem_block">
                        <Siar:Button ID="btnSalvaChecklist" runat="server" OnClick="btnSalvaChecklist_Click" Text="Salva note checklist" Modifica="true" Style="width: 160px; margin-left: 20px" />
                    </div>
                    <br />
                </div>
                <br />
                ...
                <div class="first_elem_block">
                    <Siar:Button ID="btnSave" runat="server" Modifica="True" OnClick="btnSave_Click" Text="Salva validazione" Style="width: 160px; margin-left: 20px" />
                </div>
