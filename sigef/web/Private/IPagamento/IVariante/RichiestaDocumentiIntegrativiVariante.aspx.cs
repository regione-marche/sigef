...
{
    public partial class RichiestaDocumentiIntegrativiVariante : SiarLibrary.Web.IstruttoriaVariantePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (com_selezionata == null || com_selezionata.CodTipo != "DNT" || Variante == null) throw new Exception("La comunicazione selezionata non è valida.");
