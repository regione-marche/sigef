    ...
    public partial class IstruttoriaSpeseSostenute : SiarLibrary.Web.IstruttoriaPagamentoPage
    {
        ...
        void dgSpese_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                dgi.Cells[col_RiepilogoGius].Text = "Dati giustificativo</td><td colspan=3 align=center>Dati pagamento</td><td></td></tr><tr class='TESTA'><td>Riepilogo";
            }
            else if (e.Item.ItemType != ListItemType.Footer)
            {
                SiarLibrary.SpeseSostenute spesa = (SiarLibrary.SpeseSostenute)dgi.DataItem;
                if (spesa.Ammesso) dgi.Cells[0].Text = dgi.Cells[col_Numero].Text + "  <img src='" + Request.ApplicationPath + "/images/visto.gif' alt='Ammessa' />";
