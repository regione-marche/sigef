...
namespace web.Private.IPagamento
{
    ...
    public partial class IstruttoriaBilancioAziendale : SiarLibrary.Web.IstruttoriaPagamentoPage
    {
        ...
        protected void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (int.TryParse(hdnId.Value, out idBilancio)) bil_Agricolo = bilancio_Agricolo_provider.GetById(idBilancio);
                else
                {
