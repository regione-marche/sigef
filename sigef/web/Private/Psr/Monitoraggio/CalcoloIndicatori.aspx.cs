...
namespace web.Private.Psr.Monitoraggio
{
    public partial class CalcoloIndicatori : SiarLibrary.Web.PrivatePage
    {
        ...
        SiarBLL.ZdimensioniEstrazioniIoCollectionProvider dec_provider = new SiarBLL.ZdimensioniEstrazioniIoCollectionProvider();
        SiarLibrary.ZdimensioniEstrazioniIoCollection de_selezionata = null;

        SiarBLL.ZdimensioniEstrazioniTCollectionProvider deT_provider = new SiarBLL.ZdimensioniEstrazioniTCollectionProvider();
        ...
        private int SalvaIndicatori(string id_prs, int i_anno)
        {
            ...
            if (de_selezionata.Count > 0)
            {
                try
                {
                    SiarBLL.ZdimensioniEstrazioniTCollectionProvider dimTp = new SiarBLL.ZdimensioniEstrazioniTCollectionProvider();
                    SiarLibrary.ZdimensioniEstrazioniTCollection dimTc;
                    SiarLibrary.ZdimensioniEstrazioniT dimT;

                    SiarBLL.ZdimensioniEstrazioniIoCollectionProvider dimIOp = new SiarBLL.ZdimensioniEstrazioniIoCollectionProvider();
                    SiarLibrary.ZdimensioniEstrazioniIo dimIO;
                    int i = 0;
                    int id_estraz = 0;
                    foreach (SiarLibrary.ZdimensioniEstrazioniIo estraz in de_selezionata)
                    {
                        if (i == 0)
                        {
