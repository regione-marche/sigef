        ...
        private void sommaDettagli( string SelectedValue)
        {
            ...
            else
            {
             ...
             strTb = "<div class=\"dContenuto\">" +
                           " <strong> Spesa suddivisa per priorità e per categoria di regioni, come contabilizzata" +
                            "dall'autorità di certificazione</strong> " +
                "<table id=\"tblDettaglioDati\" width=\"100% \" runat=\"server\" clientidmode=\"Static\"><tr class=\"TESTA1\" >" +
                "<th>" +
                "</th>" +
                "<th>" +
                "Asse" +
                ...
                "</th></tr>";
                    ...
                    foreach (SiarLibrary.DatiRiassuntiviRendicontazione r in detSell)
                    {
                        ...
                        strRiga +=
                            " <tr class=\"DataGridRowAlt\"  style=\"text-align: right;\">" +
                            ...
                            " </td>" +
                            "<td class=\"asse\" style=\" text-align: center; min-width: 50px;\">" +
                            "Asse "+i+"" +
                            " </td>" +
