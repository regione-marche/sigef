    ...
    public partial class Riepilogo : SiarLibrary.Web.VariantePage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (Variante.CodTipo == "VA")
            {
                ...
                txtCuaaUscente.Text = ucWorkFlowVarianti.Impresa.Cuaa;
                txtRagSocUscente.Text = ucWorkFlowVarianti.Impresa.RagioneSociale;
            }
            base.OnPreRender(e);
        }
        ...
        protected void btnScarica_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (i.Cuaa == ucWorkFlowVarianti.Impresa.Cuaa) throw new Exception("L`impresa entrante è già beneficiaria dell`attuale domanda di aiuto.");
        ...
        protected void btnCambiaBeneficiario_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Variante.CuaaUscente = ucWorkFlowVarianti.Impresa.Cuaa;
                VarianteProvider.AggiornaVariante(Variante, Operatore);
