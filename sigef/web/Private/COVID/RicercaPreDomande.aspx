        ...
        <div id="divMostraRicercaPreDomande" style="padding: 15px;">
            <div id="divRicercaRicercaPreDomande" runat="server" class="box_ricerca">
                ...
                <div class="first_elem_block">
                    <b>Id Domanda:</b>
                    <br />
                    <asp:TextBox ID="txtIdPreDomanda" runat="server" Width="100%" onkeypress="return isNumberKey(event)" />
                </div>
                <br />
                ...
                <div class="first_elem_block">
                    ...
                    <br />
                    <asp:TextBox ID="txtRagioneSocialeImpresa" runat="server" Width="100%" />
                </div>

                <div class="elem_block">
                    <b>P.IVA:</b>
                    <br />
                    <asp:TextBox ID="txtPivaImpresa" runat="server" Width="100%" />
                </div>

                <div class="elem_block">
                    <b>Codice Fiscale:</b>
                    <br />
                    <asp:TextBox ID="txtCfImpresa" runat="server" Width="100%" />
                </div>
                <br />
                ...
                <div class="elem_block">
                    ...
                    <br />
                    <asp:TextBox ID="txtDescrizioneBando" runat="server" Width="100%" onkeypress="return isNumberKey(event)" />
                </div>
                <br />
