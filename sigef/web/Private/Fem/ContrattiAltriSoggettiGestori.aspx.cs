...
{
    public partial class ContrattiAltriSoggettiGestori : SiarLibrary.Web.PrivatePage
    {
        ...
        {
            FunzioneMenu = "contratti_altri_soggetti_gestori";
            base.OnPreInit(e);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (AbilitaModifica)
            {
                progetti_list = StrumentiFinanziariUtility.GetProgettiUtenteAltriSoggettiCompresoUnicoBandoVela(Operatore);
                ...
                if (progetti_list.Count > 0)
                {
                    ...
                    if (Operatore.Utente.Profilo != "Operatore FEM")
                    {
                        ...
                        lblTitolo.InnerText = "Fondo Covid l.r. 13/2020";
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            else
            {
                if (Operatore.Utente.Profilo != "Operatore FEM")
                {
                    contratti_coll = contratto_provider.GetContrattiAltriSoggettiFondoLeggeCovidNonPoc(
        ...
        protected void btnEstraiContratti_Click(object sender, EventArgs e)
        {
            ...
            if (id_soggetto == "X")
            {
                RegisterClientScriptBlock("SNCVisualizzaReport('rptEstrazioneContrattiFemFondoCovidXls', 2 ,'');");
            }
            else
            {
                if (id_progetto == "Y")
                    RegisterClientScriptBlock("SNCVisualizzaReport('rptEstrazioneContrattiFemFondoCovidXls', 2 ,'IdSoggettoGestore=" + id_soggetto + "');");
                else
                    RegisterClientScriptBlock("SNCVisualizzaReport('rptEstrazioneContrattiFemFondoCovidXls', 2 ,'IdProgetto=" + id_progetto + "|IdSoggettoGestore="+id_soggetto+"');");
            }
        }
