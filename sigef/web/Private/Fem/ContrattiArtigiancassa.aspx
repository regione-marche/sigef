...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="server">
    <script type="text/javascript">
        ...
        function selezionaPagamento(id, elem) {
            if (elem.checked == false) {
                $('[id$=hdnIdPagamentoFem]').val('');
            }
            else {
                $('[id$=hdnIdPagamentoFem]').val(id);
            }
        ...
        <div id="divMostraGiustificativi" style="padding: 25px">
            ...
            <div>
                <table visible="false" id="tbGiustificativiFemPagamento" runat="server" width="100%">
                    <tr>
                        <td class="paragrafo">Dati dei pagamenti:
                        </td>
                    </tr>
                    <tr>
                        <td>
                                                ...
                                                <td>
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 140px">Importo €:<br />
                ...
                <tr>
                    <td>
                        ...
                        <table id="tbProgetti" runat="server" width="100%">
                            <tr>
                                <td class="separatore">Elenco dei progetti:
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            <td style="padding-left: 10px; padding-top: 10px">Nr. Domanda:<br />
                            ...
                            <tr>
                                <td>
                                    <table id="tbContratto" runat="server" width="100%">
                                        <tr>
                                            <td class="paragrafo">Dati del contatto:
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table visible="false" id="tbContrattiFemPagamento" runat="server" width="100%">
                                                    <tr>
                                                        <td class="paragrafo">Modifica contratto:
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <table id="tableContrattoModifica" runat="server">
                                                                <tr>
                                                                    <td>
                                                                        <br />
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 180px">Numero contratto:<br />
                                                                        <Siar:TextBox ID="txtNumeroContrattoModifica" runat="server" Width="120px" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 180px">Data Stipula Contratto:<br />
                                                                        <Siar:DateTextBox ID="txtDataContrattoModifica" runat="server" Width="120px" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 180px">Importo FEM €:<br />
                                                                        <Siar:CurrencyBox ID="txtNewImportoModifica" runat="server" Width="160px" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 180px">File del contratto:<br />
                                                                        <uc4:SNCUploadFileControl ID="ufContrattoModifica" runat="server" TipoFile="Documento" AbilitaModifica="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <br />
                                                                        <Siar:Button ID="btnSalvaModificaContratto" runat="server" OnClick="btnSalvaModificaContratto_Click"
                                                                            Text="Salva dati" Width="160px" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                        ...
                                                        <td>
                                                            <Siar:DataGrid ID="dgContrattiFemPagamenti" runat="server" Width="100%" PageSize="20" AllowPaging="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <Siar:CheckColumn DataField="IdContrattoFemPagamenti" Name="chkIdPagamentoFem">
                                                                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                                                                    </Siar:CheckColumn>
                                                                </Columns>
                                                            </Siar:DataGrid>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table visible="false" id="tbModificaPagamento" runat="server">
                                                                <tr>
                                                                    <td class="paragrafo">Modifica pagamento:
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding: 10px">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td>Tipo pagamento:<br />
                                                                                    <Siar:ComboSql ID="lstPagamentoModifica" runat="server" CommandText="SELECT * FROM TIPO_GIUSTIFICATIVO WHERE DI_PAGAMENTO=1"
                                                                                        DataTextField="DESCRIZIONE" DataValueField="COD_TIPO" NomeCampo="Tipo pagamento">
                                                                                    </Siar:ComboSql>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="100%">
                                                                                        <tr>
                                                                                            <td style="width: 120px">Data:<br />
                                                                                                <Siar:DateTextBox ID="txtDataPagamentoModifica" runat="server" NomeCampo="Data pagamento"
                                                                                                    Width="90px" />
                                                                                            </td>
                                                                                            <td style="width: 140px">Importo €:<br />
                                                                                                <Siar:CurrencyBox ID="txtImportoLordoPagamentoModifica" runat="server" NomeCampo="Importo lordo del pagamento"
                                                                                                    Width="110px" />
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                            ...
                                                                            <tr>
                                                                                <td>Estremi:<br />
                                                                                    <Siar:TextBox ID="txtEstremiModifica" runat="server" Width="488px" NomeCampo="Estremi del pagamento" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <br />
                                                                                    Specificare il file digitale relativo al pagamento:<br />
                                                                                    <uc4:SNCUploadFileControl ID="ufPagamentoModifica" runat="server" TipoFile="Documento" AbilitaModifica="true" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <br />
                                                                        <Siar:Button ID="btnSalvaPagamentoModifica" runat="server" OnClick="btnSalvaPagamentoModifica_Click"
                                                                            Text="Salva dati" Width="160px" />
                                                                    </td>
                                                                </tr>
                                                            </table>
