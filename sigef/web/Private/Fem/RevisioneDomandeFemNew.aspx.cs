...
{
    public partial class RevisioneDomandeFemNew : SiarLibrary.Web.ControlliValidazionePagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (testata_selezionata != null)
            {
                ...
                if (testata_istanza_selezionata != null)
                {
                    ...
                    istanze_testate_collection.AddCollection(testata_x_istanza_provider.Find(null, testata_selezionata.IdTestata, null, null, false));
        ...
        {
            var vv = new BandoValidatoriCollectionProvider().Find(Bando.IdBando, Operatore.Utente.IdUtente, null, true);
        ...
        private void ControllaModifica()
        {
            ...
            AbilitaModifica = vv.Count > 0
                && (testata_selezionata.SegnaturaRevisione == null
                    || (DomandaPagamento.SegnaturaSecondaApprovazione != null && testata_selezionata.SegnaturaSecondaRevisione == null))
                && testata_selezionata.CfValidatore == Operatore.Utente.CfUtente;
        ...
        protected void btnAggiungiRevisione_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var testate_precedenti_coll = testata_validazione_provider.GetUltimaRevisioneDomandaValidaFem(DomandaPagamento.IdDomandaPagamento);
                if (testate_precedenti_coll.Count > 0)
                {
                    ...
                    Redirect(PATH_FEM + "RevisioneDomandeFemNew.aspx?idpag" + DomandaPagamento.IdDomandaPagamento, "Nuova revisione creata correttamente", false);
                }
                else
        ...
        protected void btnPostBackFirma_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                VerificaLotto();
                Redirect("RevisioneDomandeFemNew.aspx", messaggio, false);
            }
            catch (Exception ex)
            {
                testata_validazione_provider.DbProviderObj.Rollback();
        ...
        protected void btnPostEliminaIstanza_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Redirect("RevisioneDomandeFemNew.aspx", "Checklist eliminata correttamente.", false);
            }
            catch (Exception ex)
            {
                ShowError(ex.Message);
        ...
        protected void btnPostCopiaValidazione_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Redirect("RevisioneDomandeFemNew.aspx", "Validazione copiata correttamente.", false);
            }
            catch (Exception ex)
            {
                ShowError(ex.Message);
