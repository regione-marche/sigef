<%@ Page Title="" Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true" CodeBehind="ContrattiAltriSoggettiGestoriPoc.aspx.cs" Inherits="web.Private.Fem.ContrattiAltriSoggettiGestoriPoc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <div style="text-align: center;">
        <h1><label id="lblTitolo" runat="server">Fondo Covid l.r. 13/2020 POC</label></h1>
    </div>
