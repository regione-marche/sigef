<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.Impresa.ImpresaBilancioAgricoltura" CodeBehind="ImpresaBilancioAgricoltura.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <uc2:SiarNewTab ID="ucSiarNewTab" runat="server" TabNames="Bilanci Impresa |Nuovo"
        FullValidate="True" />
    <table id="tbRiepilogoBilanci" width="990px" runat="server" class="tableTab" visible="false">
        <tr>
            <td>
                <br />
    ...
    <table id="tbBilancio" width="991px" runat="server" class="tableTab" visible="false">
        <tr>
            <td colspan="2">
                &nbsp;
                <br />
        ...
        <tr>
            ...
            <td valign="top">
                <table id="tbContoEconomico" width="100%" runat="server" style="border: #3f6f3f 1px solid;">
                    ...
                    <tr valign="top">
                        <td style="width: 60%">
                            &nbsp;<em>anticipazioni colturali e rimanenze finali</em>
                        </td>
                        <td align="right" style="width: 200px">
