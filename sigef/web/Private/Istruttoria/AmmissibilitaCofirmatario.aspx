<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    CodeBehind="AmmissibilitaCofirmatario.aspx.cs" Inherits="web.Private.Istruttoria.AmmissibilitaCofirmatario" %>
        ...
        <tr>
            <td>
                <table style="padding-left: 15px" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td valign="bottom" style="width: 20px;" id="tdAmmesso" runat="server">
                        </td>
