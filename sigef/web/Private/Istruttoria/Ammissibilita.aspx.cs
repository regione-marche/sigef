...
{
    public partial class Ammissibilita : SiarLibrary.Web.IstruttoriaPage
    {
        private SiarBLL.VistruttoriaDomandeCollectionProvider istruttoria_provider = new SiarBLL.VistruttoriaDomandeCollectionProvider();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ucFiltroRicercaDomande.ValoriStato.Add(new ListItem("Finanziabile", "F"));
            ucFiltroRicercaDomande.ValoriStato.Add(new ListItem("Non finanziabile", "N"));
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (responsabili.Count > 0)
            {
                ...
                if (responsabili.Count == 1 && !string.IsNullOrEmpty(responsabili[0].Provincia))
                {
            ...
            SiarLibrary.VistruttoriaDomandeCollection progetti_istruttore = istruttoria_provider.Find(Bando.IdBando,
                ...
                (ucFiltroRicercaDomande.RagioneSociale != null ? "%" + ucFiltroRicercaDomande.RagioneSociale + "%" : null),
                 (ucFiltroRicercaDomande.StatoDomanda == null ? "I" : ucFiltroRicercaDomande.StatoDomanda.Value), null);
        ...
        protected void dg_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dgi.Cells[5].Text = "<a href='ChecklistAmmissibilita.aspx?iddom=" + progetto.IdProgetto + @"'><img src='../../images/domande.ico' 
alt='Vai alla ammissibilita della domanda' /></a>";
