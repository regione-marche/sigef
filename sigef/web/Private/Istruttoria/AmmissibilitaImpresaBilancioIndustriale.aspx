<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.Istruttoria.AmmissibilitaImpresaBilancioIndustriale" CodeBehind="AmmissibilitaImpresaBilancioIndustriale.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ContoEconomico() {
            ...
            else { ctl00$cphContenuto$lblTotPrimaImposte_text.innerHTML = '0'; }
        ...
        function ControlloAnno(ev) {
            ...
            if (annoInserito > anno) {
                alert("Attenzione l'anno inserito non è corretto.\nIl bilancio deve riferirsi ad un anno precedente.");
                return stopEvent(ev);
            }
        }
    ...
    <table width="600px" id="tbRiepilogoBilanci" class="tableTab" runat="server" visible="false">
        ...
        <tr>
            <td>
                <Siar:DataGrid ID="dgBilancio" runat="server" Width="100%" PageSize="15" AllowPaging="True"
        ...
        <tr>
            <td>
                <table id="tbStatoPatrimoniale" width="100%" runat="server" style="border: #3f6f3f 1px solid;">
                    ...
                    <tr>
                        <td style="width: 60%">
                            &nbsp; <strong>TRATTAMENTO FINE RAPPORTO <span style="font-size: 8pt">LAVORO SUBOR.</span></strong>
                        </td>
                        <td align="right">
