<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="FirmaMassivaAmmissibilita.aspx.cs" Inherits="web.Private.Istruttoria.FirmaMassivaAmmissibilita" %>
    ...
    <div class="dBox">
        ...
        <div style="margin: 15px;">
            ...
            <div style="margin-bottom: 15px;">
                ...
                Non vengono mostrate le domande per cui è presente un comitato di valutazione e quelle a cui sono stati aggiunti allegati in istruttoria. <br />
                I requisiti manuali dovranno essere compilati necessariamente prima di firmare. In caso contrario l'esito della checklist sarà negativo e le domande verranno escluse dalla firma massiva. <br /> <br />
            ...
            <Siar:DataGrid ID="dgFirmeAmmissibilita" runat="server" AutoGenerateColumns="false" Width="100%" OnItemDataBound="dgFirmeAmmissibilita_ItemDataBound">
                <Columns>
            ...
            <div id="header_remota" runat="server" class="col-container" style="margin-top: 10px; margin-bottom: 10px; display:none;">
                ...
                <div id="header_remota_dati" runat="server">
                    <div class="row">
                        ...
                        <div class="column" style="flex: 0.5;">
                            <Siar:Button ID="btnFirmaMassivaRemotaAmmissibilita" runat="server" Style="width: 180px;" Text="Firma e invia al protocollo" OnClick="btnFirmaMassivaRemotaAmmissibilita_Click" />
                            <br />
