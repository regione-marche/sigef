        ...
        void dgSegnature_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (s.CodTipo.FindValueIn("RID", "RIP", "RIV"))
                {
                    ...
                    e.Item.Cells[2].Text = "<input type=button class=ButtonGrid value='Vedi esito' onclick=\""
                        + url + "\" style='width:80px;margin-left:10px;margin-right:10px;' />";
                }
            }
        }
        ...
        void dg_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                else if (s.CodStato == "E")
                {
                    ...
                    if (decreto != null) e.Item.Cells[5].Text = "<input type=button class=ButtonGrid value='Visualizza decreto' onclick=\""
                        + SiarLibrary.DbStaticProvider.GetJsUrlDecreto(decreto) + "\" style='width:140px;margin-left:10px;margin-right:10px;' />";
                }
            }
        }
    }
