<%@ Page Language="C#" MasterPageFile="~/SiarPage.master" AutoEventWireup="true"
    Inherits="web.Private.Istruttoria.AmmissibilitaBilancioAgricolo" CodeBehind="AmmissibilitaBilancioAgricolo.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function ControlloAnno(ev) {
            ...
            if (annoInserito < anno) {
                alert("Attenzione l'anno inserito non è corretto.\nIl bilancio deve riferirsi ad un anno successivo");
        ...
        <tr>
            <td align="right">
                <Siar:Button ID="btnBack" Text="Indietro" runat="server" OnClick="btnBack_Click"
                    CausesValidation="false" Modifica="False" Width="150px" />
            </td>
        </tr>
        <tr>
            <td>
