    ...
    public partial class RequisitiMisuraPagamento : System.Web.UI.UserControl
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            if (_disposizioniAttuative != null)
            {
                ...
                hdnIdDisposizioniMisura.Text = _disposizioniAttuative.IdDisposizioniAttuative;
            }
            base.OnPreRender(e);
        }
        ...
        void dgRequisiti_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (dgi.ItemType != ListItemType.Header && dgi.ItemType != ListItemType.Footer)
            {
                ...
                else if (requisito.Numerico)
                {
                    ...
                    e.Item.Cells[4].Text = "<span id=\"" + nome_casella + "\" class=\"CurrencyBox\" style=\"display:inline-block;width:120px;\">"
                        + "<input name=\"" + nome_casella + "_text\" type=\"text\" id=\"" + nome_casella
                        + "_text\" style=\"text-align:right;width:120px;\" value='" + valore + "'/></span>";
                }
                else if (requisito.Datetime)
                {
                    ...
                    e.Item.Cells[4].Text = "<span id=\"" + nome_casella + "\" class=\"DataBox\" style=\"display:inline-block;width:120px;\">"
                        + "<input name=\"" + nome_casella + "_text\" type=\"text\" id=\"" + nome_casella
                        + "_text\" style=\"text-align:right;width:120px;\" value='" + valore + "'/></span>   (click con il destro per il calendario)";
                }
                else if (requisito.TestoSemplice)
                {
                    ...
                    e.Item.Cells[4].Text = "<span id=\"" + nome_casella + "\" class=\"TextBox\" style=\"display:inline-block;width:360px;\">"
                        + "<input name=\"" + nome_casella + "_text\" type=\"text\" id=\"" + nome_casella
                        + "_text\" style=\"text-align:left;width:360px;\" value='" + valore + "'/></span>";
                }
                else if (requisito.TestoArea)
                {
                    ...
                    e.Item.Cells[4].Text = "<span id='" + nome_casella + "' class='TextArea'><textarea id='" + nome_casella + "_text' name='"
                        + nome_casella + "_text' cols='20' rows='3' style='text-align:left;width:360px'>" + valore + "</textarea></span>";
                }
                else //checkbox
                {
