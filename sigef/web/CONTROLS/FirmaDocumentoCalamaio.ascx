...
<script type="text/javascript">
    ...
    function openFirmaDocumentoControl() { getDimensioniVisibili(); $('#frameDocumento').attr('src', getBaseUrl() + 'VisualizzaDocumento.aspx').height(clientHeight - 150); mostraPopupTemplate('divFrontFirmaDocumentoControl', 'divBKFirmaDocumentoControl'); if (jdati_firma.FirmaObbligatoria == false) { $('#btnFirma2').val('Invia documento al protocollo'); $('#div_status').css("visibility", "hidden"); $('#div_disclaimer').css("visibility", "hidden"); $('#switch_rs').hide(); $('#btnFirma2').removeAttr('disabled');} }
    ...
    <div id="header" class="wrapper">
        <div class="row">
            <div id="switch_rs" class="column" style="color: #808080; width: 100%; flex:3;  align-items:center;" >
                <input type="button" id="btnSwitchRs" onclick="switchSign('r')" class="Button" value="Utilizza Firma Digitale Remota" style="width:180px; height:30px; background:#3f6f3f;" />
            </div>
        </div>
        <div class="row">
        ...
        <div class="column" style="flex:0.5;">
            <br />
            <input type="button" id="btnFirma2" class="Button" disabled name="btnFirma2" style="width:180px;" value="Firma e invia al protocollo" onclick="btnFirmaClick(); return false;" />
            <br />
    ...
    <div id="header_rs" class="wrapper" style="display:none;">
        ...
        <div class="column" style="flex:0.5;">
            ...
            <div>
                ...
                <input type="text" id="txtDominio" name="txtDominio" runat="server" style="width: 120px;" />
            </div>
        </div>
         <div class="column">
             <div>
