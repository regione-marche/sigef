...
{
    public partial class SNCPlurivalore : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            imgSNCSelezionaPlurivalore.Attributes.Add("onclick", "SNCZoomPlurivalore(" + _idRequisito + ",'" + _searchFunction + "'," + _selectJsFunction + ",0);");
