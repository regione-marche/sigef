    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="border: 0">
        <tr>
            <td style="width: 360px">
                <Siar:TextBox ID="txtPercorsoFile" runat="server" Width="340px" ReadOnly="true" />
            </td>
            ...
            <td style="width: 100px" align="center">
                <asp:Button ID="btnSNCUFCarica" runat="server" class="Button" Text="Carica" Style="width: 90px"
