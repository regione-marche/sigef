            ...
            if (!_datiCaricati || ForzaCaricamentoDati)
            {
                    ...
                    (Progetto.CodStato == "I" || DomandaInRevisione || DomandaInRiesame || DomandaInRicorso))
                {
                    ...
                    tdLinks.InnerHtml = "<br /> "
                        + "<div style='width:80%;text-align:center;font-weight:bold;color:red;display:inline-block;'> "
                        +   "Attenzione! La domanda è non accessibile finchè è in corso l`istruttoria. "
                        + "</div> " 
                        + "<div align='right' style=padding-right:5px;display:inline-block;> "
                        +   "<b style=padding-right:10px;>vai alla pagina:</b> "
                        +   "<a href='" + PATH_PDOMANDA + "Comunicazioni.aspx'> "
                        +       "<img title='Comunicazioni con il beneficiario' src='" + PATH_IMAGES + "comunicazioni.gif'> "
                        +   "</a> "
                        + "</div><br/> ";
