    ...
    public partial class ucGestioneLavori : SigefUserControl
    {
        ...
        public List<int> IdDomandeSelezionate
        {
            get
            {
                ...
                string[] selezionati = ((CheckColumn)dgGestioneLavori.Columns[col_ColonnaCheck]).GetSelected();
        ...
        void dgGestioneLavori_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (dgi.ItemType == ListItemType.Header)
            {
                ...
                dgi.Cells[col_InfoBando].Text = "DOMANDE DI PAGAMENTO</td><td colspan=4 align=center>RIEPILOGO ISTRUTTORIA</td>";
                if (ColonnaCheck)
                    dgi.Cells[col_InfoBando].Text += "<td></td>";
                dgi.Cells[col_InfoBando].Text += "</tr><tr class='TESTA'><td>Richiesta";
            }
                    ...
                    if (domanda.Segnatura != null)
                    {
                        ...
                        if (!allegatiProtocollatiOk)
                        {
                            ...
                            dgi.Cells[col_InfoDomanda].Text = "<input type=button onclick=\"$('[id$=hdnIdDomandaPagamentoGestioneLavori]').val('" + domanda.IdDomandaPagamento + "'); "
                                ...
                                + "value='Protocolla gli allegati ' style='width:150px' class='ButtonGrid'/>";
                        }
                        else
                        {
                            ...
                            dgi.Cells[col_Segnatura].Text = "<img src='" + PATH_IMAGES + "print_ico.gif' alt='Domanda'  onclick=\"MostraProtocolloNew('" + domanda.Segnatura + "');\" style='cursor: pointer;'>";
