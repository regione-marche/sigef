...
<div class="dBox" id="dBoxPaino" runat="server">
    ...
    <div class="dSezione" id="divMostraPiano">
        <div class="dContenutoFloat" width="100%">
            <div >
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            <table id="tbMisura" runat="server" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="tdMisura" style="border-left: 1px solid #1380c4;" onclick="mostraMisura(0);">
                                        VISUALIZZA TUTTI<br />
                                        GLI INVESTIMENTI
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td id="tdButtons" runat="server" style="height: 60px; padding-right: 30px" align="right" visible="false">
                        </td>
                    </tr>
                    <tr>
                        <td>
