...
{
    public partial class PianoInvestimentiAggregazione : SiarLibrary.Web.SigefUserControl
    {
            ...
            if (Progetto != null)
            {
                ...
                if (nascodiDiv != "True")
                {
                    ...
                    if (CodiceFase == "PDOMANDA" || CodiceFase == "IDOMANDA")
                        aggr_coll = aggr_prov.GetPianoInvestimentiAggregazioneIntervento(Progetto.IdProgetto, CodiceFase, id_intervento);
                    else
                        aggr_coll = aggr_prov.GetPianoInvestimentiAggregazioneVarianteIntervento(Progetto.IdProgetto, CodiceFase, Variante.IdVariante, id_intervento);
