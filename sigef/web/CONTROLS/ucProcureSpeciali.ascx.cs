...
namespace web.CONTROLS
{
    public partial class ucProcureSpeciali : System.Web.UI.UserControl
    {
        ...
        {
            imgMostraProcure.Attributes.Add("src", VirtualPathUtility.ToAbsolute("~/Images/") + "ArrowUpSolid.png");
        }
        ...
        private void caricaDgProcure()
        {
            ...
            if (rich_coll_proc_inv.Count == 0) dgMandatiProcura.Titolo = "&nbsp;&nbsp;&nbsp;<em><b>Nessuna procura presente.</b></em>";
