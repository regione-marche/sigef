...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenuto" runat="Server">
    <table width="1040" class="tableNoTab" style="border-radius: 10px">
        <tr>
            <td class="separatore_big">SIGEF - SISTEMA INTEGRATO GESTIONE FONDI
            </td>
        </tr>
        <tr>
            <td style="height: 75px;padding-left:20px;padding-right:20px">
                <br />
				<br />
				<p style="font-size: 18px; font-weight: bold;">Il nuovo sistema SIGEF2027 dedicato alla programmazione comunitaria 2021-2027 è raggiungibile al seguente link</p>
				<br />
				<p style="font-size: 18px; font-weight: bold; text-align:center;"><a style="color: #1079BE;" href="https://sigef2027.regione.marche.it/" target="_blank">https://sigef2027.regione.marche.it/</a></p>				
				<br />
                <br />
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="height: 75px; padding-left: 20px; padding-right: 20px">
                            <b>Nuova modalità per l'abilitazioni dei consulenti:</b>
                            <br />
                            La richiesta per l'abilitazione di nuovi consulenti può essere fatta direttamente online in via telematica all'interno del sito dal rappresentante legale nella 
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="height: 75px; padding-left: 20px; padding-right: 20px">
                            ...
                            <br />
                            Si consiglia pertanto di<b> non usare </b>il browser<b> Internet explorer v10 e v11.</b>
                        </td>
                    </tr>
                </table>
                <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="separatore_light" style="border-radius: 5px"></td>
                    </tr>
                    <tr class="DataGridRowAlt">
                        <td class="selectable" style="text-align: center; font-size: 14px; font-weight: bold; height: 30px; line-height: 30px"
                            onclick="location='private/welcome.aspx'">ACCEDI ALL'AREA RISERVATA
                        </td>
                    </tr>
                    <tr>
                        <td class="separatore_light" style="border-radius: 5px"></td>
