...
namespace SiarBLL
{
    public partial class ContrattiFemCollectionProvider : IContrattiFemProvider
    {
        ...
        //Con questo metodo è possibile estrarre i contratti di tutti i soggetti gestori tranne di Artigiancassa e del fondo POC
        //e dei progetti di Confidi in base al parametro
        //@BANDI_VELA = NULL -> TUTTI I RECORD
        //@BANDI_VELA = 0 -> NON ESTRAE CONTRATTI DEI PROGETTI BANDI VELA
        //@BANDI_VELA = 1 -> ESTRAE CONTRATTI DEI PROGETTI BANDI VELA
        public ContrattiFemCollection GetContrattiAltriSoggettiFondoLeggeCovidNonPoc(IntNT id_soggetto, IntNT id_progetto, bool? bandi_Vela)
        {
            ContrattiFemCollection contratti = new ContrattiFemCollection();
            System.Data.IDbCommand cmd = DbProviderObj.GetCommand();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.CommandText = "SpGetContrattiAltriSoggettiFondoLeggeCovidNonPoc";
        ...
        //Con questo metodo è possibile estrarre i contratti di tutti i soggetti gestori del fondo POC in base al parametro
        public ContrattiFemCollection GetContrattiAltriSoggettiFondoLeggeCovidPoc(IntNT id_soggetto, IntNT id_progetto)
        {
            ContrattiFemCollection contratti = new ContrattiFemCollection();
            System.Data.IDbCommand cmd = DbProviderObj.GetCommand();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.CommandText = "SpGetContrattiAltriSoggettiFondoLeggeCovidPoc";
