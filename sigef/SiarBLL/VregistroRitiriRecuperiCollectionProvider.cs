...
namespace SiarLibrary
{
    ...
    public partial class VregistroRitiriRecuperiCollection : CustomCollection, System.Runtime.Serialization.ISerializable
    {
        ...
        public VregistroRitiriRecuperiCollection SubSelect(NullTypes.IntNT IdAsseEqualThis, NullTypes.StringNT CodAsseEqualThis, NullTypes.IntNT IdAzioneEqualThis,
NullTypes.StringNT CodAzioneEqualThis, NullTypes.IntNT IdInterventoEqualThis, NullTypes.StringNT CodInterventoEqualThis,
NullTypes.IntNT IdProgettoEqualThis, NullTypes.IntNT IdRitiroEqualThis, NullTypes.StringNT TipoRitiroEqualThis,
NullTypes.StringNT TipoEqualThis, NullTypes.StringNT BeneficiarioPivaEqualThis, NullTypes.StringNT BeneficiarioEqualThis,
NullTypes.StringNT SoggettoRilevatoreEqualThis, NullTypes.StringNT TipoDetrazioneEqualThis, NullTypes.IntNT IdLottoEqualThis,
NullTypes.DatetimeNT DataLottoEqualThis, NullTypes.StringNT PeriodoContabileEqualThis, NullTypes.DecimalNT ImportoTotaleEqualThis,
NullTypes.DecimalNT FesrEqualThis, NullTypes.DecimalNT StatoEqualThis, NullTypes.DecimalNT RegioneEqualThis,
NullTypes.IntNT IdLottoSpesaEqualThis, NullTypes.DatetimeNT DataLottoSpesaEqualThis, NullTypes.StringNT PeriodoContabileSpesaEqualThis)
        {
            ...
            {
                if (((IdAsseEqualThis == null) || ((VregistroRitiriRecuperiItem.IdAsse != null) && (VregistroRitiriRecuperiItem.IdAsse.Value == IdAsseEqualThis.Value))) && ((CodAsseEqualThis == null) || ((VregistroRitiriRecuperiItem.CodAsse != null) && (VregistroRitiriRecuperiItem.CodAsse.Value == CodAsseEqualThis.Value))) && ((IdAzioneEqualThis == null) || ((VregistroRitiriRecuperiItem.IdAzione != null) && (VregistroRitiriRecuperiItem.IdAzione.Value == IdAzioneEqualThis.Value))) &&
((CodAzioneEqualThis == null) || ((VregistroRitiriRecuperiItem.CodAzione != null) && (VregistroRitiriRecuperiItem.CodAzione.Value == CodAzioneEqualThis.Value))) && ((IdInterventoEqualThis == null) || ((VregistroRitiriRecuperiItem.IdIntervento != null) && (VregistroRitiriRecuperiItem.IdIntervento.Value == IdInterventoEqualThis.Value))) && ((CodInterventoEqualThis == null) || ((VregistroRitiriRecuperiItem.CodIntervento != null) && (VregistroRitiriRecuperiItem.CodIntervento.Value == CodInterventoEqualThis.Value))) &&
((IdProgettoEqualThis == null) || ((VregistroRitiriRecuperiItem.IdProgetto != null) && (VregistroRitiriRecuperiItem.IdProgetto.Value == IdProgettoEqualThis.Value))) && ((IdRitiroEqualThis == null) || ((VregistroRitiriRecuperiItem.IdRitiro != null) && (VregistroRitiriRecuperiItem.IdRitiro.Value == IdRitiroEqualThis.Value))) && ((TipoRitiroEqualThis == null) || ((VregistroRitiriRecuperiItem.TipoRitiro != null) && (VregistroRitiriRecuperiItem.TipoRitiro.Value == TipoRitiroEqualThis.Value))) &&
((TipoEqualThis == null) || ((VregistroRitiriRecuperiItem.Tipo != null) && (VregistroRitiriRecuperiItem.Tipo.Value == TipoEqualThis.Value))) && ((BeneficiarioPivaEqualThis == null) || ((VregistroRitiriRecuperiItem.BeneficiarioPiva != null) && (VregistroRitiriRecuperiItem.BeneficiarioPiva.Value == BeneficiarioPivaEqualThis.Value))) && ((BeneficiarioEqualThis == null) || ((VregistroRitiriRecuperiItem.Beneficiario != null) && (VregistroRitiriRecuperiItem.Beneficiario.Value == BeneficiarioEqualThis.Value))) &&
((SoggettoRilevatoreEqualThis == null) || ((VregistroRitiriRecuperiItem.SoggettoRilevatore != null) && (VregistroRitiriRecuperiItem.SoggettoRilevatore.Value == SoggettoRilevatoreEqualThis.Value))) && ((TipoDetrazioneEqualThis == null) || ((VregistroRitiriRecuperiItem.TipoDetrazione != null) && (VregistroRitiriRecuperiItem.TipoDetrazione.Value == TipoDetrazioneEqualThis.Value))) && ((IdLottoEqualThis == null) || ((VregistroRitiriRecuperiItem.IdLotto != null) && (VregistroRitiriRecuperiItem.IdLotto.Value == IdLottoEqualThis.Value))) &&
((DataLottoEqualThis == null) || ((VregistroRitiriRecuperiItem.DataLotto != null) && (VregistroRitiriRecuperiItem.DataLotto.Value == DataLottoEqualThis.Value))) && ((PeriodoContabileEqualThis == null) || ((VregistroRitiriRecuperiItem.PeriodoContabile != null) && (VregistroRitiriRecuperiItem.PeriodoContabile.Value == PeriodoContabileEqualThis.Value))) && ((ImportoTotaleEqualThis == null) || ((VregistroRitiriRecuperiItem.ImportoTotale != null) && (VregistroRitiriRecuperiItem.ImportoTotale.Value == ImportoTotaleEqualThis.Value))) &&
((FesrEqualThis == null) || ((VregistroRitiriRecuperiItem.Fesr != null) && (VregistroRitiriRecuperiItem.Fesr.Value == FesrEqualThis.Value))) && ((StatoEqualThis == null) || ((VregistroRitiriRecuperiItem.Stato != null) && (VregistroRitiriRecuperiItem.Stato.Value == StatoEqualThis.Value))) && ((RegioneEqualThis == null) || ((VregistroRitiriRecuperiItem.Regione != null) && (VregistroRitiriRecuperiItem.Regione.Value == RegioneEqualThis.Value))) &&
((IdLottoSpesaEqualThis == null) || ((VregistroRitiriRecuperiItem.IdLottoSpesa != null) && (VregistroRitiriRecuperiItem.IdLottoSpesa.Value == IdLottoSpesaEqualThis.Value))) && ((DataLottoSpesaEqualThis == null) || ((VregistroRitiriRecuperiItem.DataLottoSpesa != null) && (VregistroRitiriRecuperiItem.DataLottoSpesa.Value == DataLottoSpesaEqualThis.Value))) && ((PeriodoContabileSpesaEqualThis == null) || ((VregistroRitiriRecuperiItem.PeriodoContabileSpesa != null) && (VregistroRitiriRecuperiItem.PeriodoContabileSpesa.Value == PeriodoContabileSpesaEqualThis.Value))))
                {
...
namespace SiarDAL
{
    ...
    internal class VregistroRitiriRecuperiDAL
    {
        ...
        public static VregistroRitiriRecuperiCollection Select(DbProvider db, SiarLibrary.NullTypes.IntNT IdAsseEqualThis, SiarLibrary.NullTypes.StringNT CodAsseEqualThis, SiarLibrary.NullTypes.IntNT IdAzioneEqualThis,
SiarLibrary.NullTypes.StringNT CodAzioneEqualThis, SiarLibrary.NullTypes.IntNT IdInterventoEqualThis, SiarLibrary.NullTypes.StringNT CodInterventoEqualThis,
SiarLibrary.NullTypes.IntNT IdProgettoEqualThis, SiarLibrary.NullTypes.IntNT IdRitiroEqualThis, SiarLibrary.NullTypes.StringNT TipoRitiroEqualThis,
SiarLibrary.NullTypes.StringNT TipoEqualThis, SiarLibrary.NullTypes.StringNT BeneficiarioPivaEqualThis, SiarLibrary.NullTypes.StringNT BeneficiarioEqualThis,
SiarLibrary.NullTypes.StringNT SoggettoRilevatoreEqualThis, SiarLibrary.NullTypes.StringNT TipoDetrazioneEqualThis, SiarLibrary.NullTypes.IntNT IdLottoEqualThis,
SiarLibrary.NullTypes.DatetimeNT DataLottoEqualThis, SiarLibrary.NullTypes.StringNT PeriodoContabileEqualThis, SiarLibrary.NullTypes.DecimalNT ImportoTotaleEqualThis,
SiarLibrary.NullTypes.DecimalNT FesrEqualThis, SiarLibrary.NullTypes.DecimalNT StatoEqualThis, SiarLibrary.NullTypes.DecimalNT RegioneEqualThis,
SiarLibrary.NullTypes.IntNT IdLottoSpesaEqualThis, SiarLibrary.NullTypes.DatetimeNT DataLottoSpesaEqualThis, SiarLibrary.NullTypes.StringNT PeriodoContabileSpesaEqualThis)

        {

            VregistroRitiriRecuperiCollection VregistroRitiriRecuperiCollectionObj = new VregistroRitiriRecuperiCollection();

            IDbCommand findCmd = db.InitCmd("Zvregistroritirirecuperifindselect", new string[] {"IdAsseequalthis", "CodAsseequalthis", "IdAzioneequalthis",
"CodAzioneequalthis", "IdInterventoequalthis", "CodInterventoequalthis",
"IdProgettoequalthis", "IdRitiroequalthis", "TipoRitiroequalthis",
"Tipoequalthis", "BeneficiarioPivaequalthis", "Beneficiarioequalthis",
"SoggettoRilevatoreequalthis", "TipoDetrazioneequalthis", "IdLottoequalthis",
"DataLottoequalthis", "PeriodoContabileequalthis", "ImportoTotaleequalthis",
"Fesrequalthis", "Statoequalthis", "Regioneequalthis",
"IdLottoSpesaequalthis", "DataLottoSpesaequalthis", "PeriodoContabileSpesaequalthis"}, new string[] {"int", "string", "int",
"string", "int", "string",
"int", "int", "string",
...
PeriodocontabileEqualThis);
        ...
        public VregistroRitiriRecuperiCollection Select(IntNT IdasseEqualThis, StringNT CodasseEqualThis, IntNT IdazioneEqualThis,
StringNT CodazioneEqualThis, IntNT IdinterventoEqualThis, StringNT CodinterventoEqualThis,
IntNT IdprogettoEqualThis, IntNT IdritiroEqualThis, StringNT TiporitiroEqualThis,
StringNT TipoEqualThis, StringNT BeneficiariopivaEqualThis, StringNT BeneficiarioEqualThis,
StringNT SoggettorilevatoreEqualThis, StringNT TipodetrazioneEqualThis, IntNT IdlottoEqualThis,
DatetimeNT DatalottoEqualThis, StringNT PeriodocontabileEqualThis, DecimalNT ImportototaleEqualThis,
DecimalNT FesrEqualThis, DecimalNT StatoEqualThis, DecimalNT RegioneEqualThis,
IntNT IdlottospesaEqualThis, DatetimeNT DatalottospesaEqualThis, StringNT PeriodocontabilespesaEqualThis)
        {
            VregistroRitiriRecuperiCollection VregistroRitiriRecuperiCollectionTemp = VregistroRitiriRecuperiDAL.Select(_dbProviderObj, IdasseEqualThis, CodasseEqualThis, IdazioneEqualThis,
CodazioneEqualThis, IdinterventoEqualThis, CodinterventoEqualThis,
IdprogettoEqualThis, IdritiroEqualThis, TiporitiroEqualThis,
TipoEqualThis, BeneficiariopivaEqualThis, BeneficiarioEqualThis,
SoggettorilevatoreEqualThis, TipodetrazioneEqualThis, IdlottoEqualThis,
DatalottoEqualThis, PeriodocontabileEqualThis, ImportototaleEqualThis,
FesrEqualThis, StatoEqualThis, RegioneEqualThis,
IdlottospesaEqualThis, DatalottospesaEqualThis, PeriodocontabilespesaEqualThis);
            return VregistroRitiriRecuperiCollectionTemp;
        }
