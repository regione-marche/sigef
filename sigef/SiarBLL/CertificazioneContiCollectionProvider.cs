...
namespace SiarLibrary
{
    ...
    public partial class CertificazioneConti : BaseObject
    {
        ...
        public ICertificazioneContiProvider Provider
        {
...
((DataInserimentoEqualThis == null) || ((CertificazioneContiItem.DataInserimento != null) && (CertificazioneContiItem.DataInserimento.Value == DataInserimentoEqualThis.Value))) && ((DataModificaEqualThis == null) || ((CertificazioneContiItem.DataModifica != null) && (CertificazioneContiItem.DataModifica.Value == DataModificaEqualThis.Value))))
                {
...
"FlagDefinitivo", "DataInserimento", "DataModifica"}, new string[] {"DateTime", "DateTime",
...
"DataPresentazioneConti", "IstanzaCertificazioneConti", "CfOperatore",
"FlagDefinitivo", "DataInserimento", "DataModifica"}, new string[] {"int", "DateTime", "DateTime",
"DateTime", "string", "string",
"bool", "DateTime", "DateTime"}, "");
...
"DataInserimentoequalthis", "DataModificaequalthis"}, new string[] {"int", "DateTime", "DateTime",
