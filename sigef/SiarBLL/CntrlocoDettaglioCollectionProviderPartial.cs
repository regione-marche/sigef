...
namespace SiarBLL
{
    public partial class RigaGrigliaImporti : BaseObject
    {
        ...
        private decimal _tutte;
        private decimal _incluse;
        private decimal _escluse;
        private decimal _alto;
        private decimal _medio;
        private decimal _basso;

        public string Descrizione { get => _descrizione; set => _descrizione = value; }
        public decimal Tutte { get => _tutte; set => _tutte = value; }
        public decimal Incluse { get => _incluse; set => _incluse = value; }
        public decimal Alto { get => _alto; set => _alto = value; }
        public decimal Escluse { get => _escluse; set => _escluse = value; }
        public decimal Medio { get => _medio; set => _medio = value; }
        public decimal Basso { get => _basso; set => _basso = value; }
    }

    public partial class RigaGrigliaPercentuali : BaseObject
    {
        private string _descrizione;
        private decimal _teorico;
        private decimal _selezionato;
        private decimal _definitivo;

        public decimal Definitivo { get => _definitivo; set => _definitivo = value; }
        public decimal Selezionato { get => _selezionato; set => _selezionato = value; }
        public decimal Teorico { get => _teorico; set => _teorico = value; }
        public string Descrizione { get => _descrizione; set => _descrizione = value; }
    }
        ...
        public List<RigaGrigliaImporti> Get_Totale_Importi_griglia(int idLoco)
        {
            ...
            while (dbPro.DataReader.Read())
            {
                ret.Add(new RigaGrigliaImporti
                {
                    ...
                    Tutte = (decimal)dbPro.DataReader["Tutte"],
                    Incluse = (decimal)dbPro.DataReader["Incluse"],
                    Escluse = (decimal)dbPro.DataReader["Escluse"],
                    Alto = (decimal)dbPro.DataReader["Alta"],
                    Medio = (decimal)dbPro.DataReader["Media"],
                    Basso = (decimal)dbPro.DataReader["Bassa"]
                });
            }
            dbPro.Close();
            return ret;
